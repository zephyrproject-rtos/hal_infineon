# MTB PSC3M6 Peripheral Driver Library

### Overview
The ModusToolbox PDL simplifies software development for the PSC3M6 family of devices.
...
easy-to-use APIs. These are fully documented in the [PDL API Reference Manual](https://infineon.github.io/mtb-dsl-psc3m6/html/group__group__pdl__top.html).
...
PSC3M6 series.
See the [PDL API Reference Manual](https://infineon.github.io/mtb-dsl-psc3m6/html/group__group__pdl__top.html) for more detailed information.
...
See [PDL API Reference](https://infineon.github.io/mtb-dsl-psc3m6/html/group__group__pdl__top.html) for the list of drivers.

### Quick Start
See the [PDL API Reference Manual Getting Started section](https://infineon.github.io/mtb-dsl-psc3m6/html/page_getting_started.html) for quick start instructions.

### More information
* [Peripheral Driver Library Release Notes](./RELEASE.md)
* [Peripheral Driver Library API Reference Manual](https://infineon.github.io/mtb-dsl-psc3m6/html/group__group__pdl__top.html)

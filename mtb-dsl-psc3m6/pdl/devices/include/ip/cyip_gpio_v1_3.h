...
#ifndef _CYIP_GPIO_V1_3_H_
#define _CYIP_GPIO_V1_3_H_
...
/* GPIO.VDD_PWRSW_STATUS */
#define GPIO_VDD_PWRSW_STATUS_PWROK_Pos         0UL
#define GPIO_VDD_PWRSW_STATUS_PWROK_Msk         0x1UL
/* GPIO.VDD_PWRSW_CTL */
#define GPIO_VDD_PWRSW_CTL_ILIM_Pos             0UL
#define GPIO_VDD_PWRSW_CTL_ILIM_Msk             0x3UL
#define GPIO_VDD_PWRSW_CTL_THRES_SEL_Pos        4UL
#define GPIO_VDD_PWRSW_CTL_THRES_SEL_Msk        0x30UL
#define GPIO_VDD_PWRSW_CTL_SW_ON_Pos            8UL
#define GPIO_VDD_PWRSW_CTL_SW_ON_Msk            0x100UL
#define GPIO_VDD_PWRSW_CTL_PWROK_BYPASS_Pos     9UL
#define GPIO_VDD_PWRSW_CTL_PWROK_BYPASS_Msk     0x200UL
#define GPIO_VDD_PWRSW_CTL_MODEHV_LOCK_Pos      16UL

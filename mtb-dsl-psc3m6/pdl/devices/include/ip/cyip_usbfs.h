...
/**
  * \brief USB dev lpm (USBFS_USBLPM)
  */
typedef struct {
  ...
  __IOM uint32_t DDFT0_SEL;                     /*!< 0x00000074 DDFT Select register */
  __IOM uint32_t DDFT1_SEL;                     /*!< 0x00000078 DDFT Select register */
  __IOM uint32_t DDFT2_SEL;                     /*!< 0x0000007C DDFT Select register */
   __IM uint32_t RESERVED3[992];
} USBFS_USBLPM_Type;                            /*!< Size = 4096 (0x1000) */

/**
  * \brief USB host (USBFS_USBHOST)
  */
typedef struct {
...
/**
  ...
  */
typedef struct {
        USBFS_USBDEV_Type USBDEV;               /*!< 0x00000000 USB dev */
        USBFS_USBLPM_Type USBLPM;               /*!< 0x00002000 USB dev lpm */
   __IM uint32_t RESERVED[1024];
        USBFS_USBHOST_Type USBHOST;             /*!< 0x00004000 USB host */
...
/* USBFS_USBLPM.DDFT0_SEL */
#define USBFS_USBLPM_DDFT0_SEL_DDFT0_MUX_SEL_Pos 0UL
#define USBFS_USBLPM_DDFT0_SEL_DDFT0_MUX_SEL_Msk 0x3FFUL
#define USBFS_USBLPM_DDFT0_SEL_DDFT1_MUX_SEL_Pos 16UL
#define USBFS_USBLPM_DDFT0_SEL_DDFT1_MUX_SEL_Msk 0x3FF0000UL
/* USBFS_USBLPM.DDFT1_SEL */
#define USBFS_USBLPM_DDFT1_SEL_DDFT0_MUX_SEL_Pos 0UL
#define USBFS_USBLPM_DDFT1_SEL_DDFT0_MUX_SEL_Msk 0x3FFUL
#define USBFS_USBLPM_DDFT1_SEL_DDFT1_MUX_SEL_Pos 16UL
#define USBFS_USBLPM_DDFT1_SEL_DDFT1_MUX_SEL_Msk 0x3FF0000UL
/* USBFS_USBLPM.DDFT2_SEL */
#define USBFS_USBLPM_DDFT2_SEL_DDFT0_MUX_SEL_Pos 0UL
#define USBFS_USBLPM_DDFT2_SEL_DDFT0_MUX_SEL_Msk 0x3FFUL
#define USBFS_USBLPM_DDFT2_SEL_DDFT1_MUX_SEL_Pos 16UL
#define USBFS_USBLPM_DDFT2_SEL_DDFT1_MUX_SEL_Msk 0x3FF0000UL

...
#define CY_CORDIC_ID               CY_PDL_DRV_ID(CY_PDL_RSLT_MODULE_CORDIC)
...
*  - The full range of [-pi, pi] is supported in circular rotation mode
*
* \note
...
*  - The input angle should be mapped to the integer value using:
*    angle_in_radians = ((angle * ((2^23)/pi)) << 8)
*  - |angle_in_radians| must be less than pi/2 (tangent is undefined at +/- pi/2)
*
* \note
* This is a non-blocking function.
...
*  - The input angle should be mapped to the integer value using:
*    angle_in_radians = ((angle * ((2^23)/pi)) << 8)
*  - In circular function, |angle_in_radians| must be less than pi/2 (tangent is undefined at +/- pi/2)
...
/*******************************************************************************
* Function Name: Cy_CORDIC_ArcSin
****************************************************************************//**
*
* Computes the Arc Sine for the given value.
* Uses the identity: asin(w) = atan(w / sqrt(1 - w^2))
*
* \param base
* The pointer to the CORDIC instance.
*
* \param w
* The input value in Q31 format.
*
* \return
* The computed Arc Sine value in Q31 angle format.
* \ref CY_CORDIC_Q31_t
*
* \note
*  - This is a blocking function.
*  - The input parameter w should be a Q31 value representing a number in [-1, 1]:
*    w = (float_value * 0x80000000) + 0.5F
*  - The result should be scaled as: ((result >> 8) * (pi / (2^23)))
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: Cy_CORDIC_ArcCos
****************************************************************************//**
*
* Computes the Arc Cosine for the given value.
* Uses the identity: acos(w) = atan(sqrt(1 - w^2) / w)
*
* \param base
* The pointer to the CORDIC instance.
*
...
*
* \return
* The computed Arc Cosine value in Q31 angle format.
* \ref CY_CORDIC_Q31_t
*
* \note
*  - This is a blocking function.

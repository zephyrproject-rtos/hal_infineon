...
#define CY_CRYPTOLITE_ID                        CY_PDL_DRV_ID(CY_PDL_RSLT_MODULE_CRYPTOLITE)
...
/** message schedule size for the SHA256(in bytes)    */
#define CY_CRYPTOLITE_SHA256_MESSAGE_SCHEDULE_SIZE (64UL)

/** message schedule size for the SHA384 & SHA512(in bytes)    */
#define CY_CRYPTOLITE_512_MESSAGE_SCHEDULE_SIZE (160UL)
...
/** Block size for the SHA384 & SHA512(in bytes)  */
#define CY_CRYPTOLITE_SHA512_BLOCK_SIZE         (128UL)

/** HASH size for the SHA512(in bytes)   */
#define CY_CRYPTOLITE_SHA512_HASH_SIZE          (64UL)

/** HASH size for the SHA384(in bytes)   */
#define CY_CRYPTOLITE_SHA384_HASH_SIZE          (48UL)
...
/** \cond INTERNAL */
    ...
    #define CY_CRYPTOLITE_SHA_MAX_MESSAGE_SCHEDULE_SIZE CY_CRYPTOLITE_512_MESSAGE_SCHEDULE_SIZE
#elif defined(CY_CRYPTOLITE_CFG_SHA2_384_ENABLED)
    #define CY_CRYPTOLITE_SHA_MAX_HASH_SIZE CY_CRYPTOLITE_SHA384_HASH_SIZE
    #define CY_CRYPTOLITE_SHA_MAX_BLOCK_SIZE CY_CRYPTOLITE_SHA512_BLOCK_SIZE
    #define CY_CRYPTOLITE_SHA_MAX_MESSAGE_SCHEDULE_SIZE CY_CRYPTOLITE_512_MESSAGE_SCHEDULE_SIZE
#elif defined(CY_CRYPTOLITE_CFG_SHA2_256_ENABLED)
    ...
    #define CY_CRYPTOLITE_SHA_MAX_MESSAGE_SCHEDULE_SIZE CY_CRYPTOLITE_SHA256_BLOCK_SIZE
#else
    #define CY_CRYPTOLITE_SHA_MAX_HASH_SIZE (0u)
    #define CY_CRYPTOLITE_SHA_MAX_BLOCK_SIZE (0u)
    #define CY_CRYPTOLITE_SHA_MAX_MESSAGE_SCHEDULE_SIZE (0u)
#endif

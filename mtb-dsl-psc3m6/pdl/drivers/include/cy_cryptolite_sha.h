...
{
    /** \cond INTERNAL */
    uint32_t msgblock[(CY_CRYPTOLITE_SHA_MAX_BLOCK_SIZE / 4u) + 1u]; //Allocating extra buffer for 4byte aligned Copy from OTP region.
    uint32_t hash[CY_CRYPTOLITE_SHA_MAX_HASH_SIZE / 4u];
    uint32_t message_schedule[CY_CRYPTOLITE_SHA_MAX_MESSAGE_SCHEDULE_SIZE];
    uint8_t *message;
...
*
* \funcusage
* \snippet cryptolite/snippet/main.c snippet_Cy_Cryptolite_Sha_init_start_update_finish_free
*******************************************************************************/
...
* a four byte aligned buffer with size in multiple of \ref CY_CRYPTOLITE_Sha_BLOCK_SIZE,
...
/*******************************************************************************
* Function Name: Cy_Cryptolite_Sha_Run
****************************************************************************//**
*
...
*
* \funcusage
* \snippet cryptolite/snippet/main.c snippet_Cy_Cryptolite_Sha_Run
*
* \note There is no alignment or size restriction for message buffer, However providing
* a four byte aligned buffer with size in multiple of \ref CY_CRYPTOLITE_Sha_BLOCK_SIZE,
* will result in best execution time.

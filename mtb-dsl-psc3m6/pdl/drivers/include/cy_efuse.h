...
* - PSOC devices does not support writing to eFuse memory. Writing an
...
*   (https://www.infineon.com/products/microcontroller/32-bit-psoc-arm-cortex/psoc-6-m4-mcu)
* - PSC devices support writing to eFuse memory.
...
* - XMC devices does not support writing to eFuse memory.
*
...
*     <td>Added a note for PSC family of devices.</td>
*   </tr>
*   <tr>
*     <td>2.30</td>
...
*   <tr>
*     <td>2.20</td>
*     <td>Updated driver to support the XMC family of devices.</td>
*     <td>Added new family of devices.</td>
*   </tr>
*   <tr>
*     <td>2.10</td>
*     <td>Implementation for newly introduced APIs for PSC devices has been updated.</td>
*     <td>Updated driver APIs support for PSC devices.</td>
*   </tr>
*   <tr>
*     <td>2.0</td>
...
*     <td>New driver APIs support for PSC devices.</td>
*   </tr>
*   <tr>
*     <td>1.10.4</td>
*     <td>Minor documentation updates.</td>
...
#define CY_EFUSE_ID                         (CY_PDL_DRV_ID(CY_PDL_RSLT_MODULE_EFUSE))
...
* 
* \note
* Supported in PSOC and XMC devices.
*
* \funcusage

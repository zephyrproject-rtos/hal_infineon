...
*     <td>Added \ref cy_hppass_hwfilt3p3z.h "cy_hppass_hwfilt3p3z.h" include.</td>
*     <td>Defect fixing: HWFILT3P3Z API was not accessible via cy_pdl.h alone.</td>
*   </tr>
*   <tr>
...
* \defgroup group_hppass_afe    AFE (Analog Front End)
* \defgroup group_hppass_dac    DAC (Digital-to-Analog Converter)
* \defgroup group_hppass_hwfilt3p3z   HW Filter 3P3Z
*/
...
#include "cy_hppass_afe.h"
#include "cy_hppass_dac.h"
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define CY_HPPASS_TRIG_NUM                (16U) /**< The number of triggers */
#else
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define CY_HPPASS_TRIG_8_IDX  (8U)  /**< Trigger #8 index */
#define CY_HPPASS_TRIG_9_IDX  (9U)  /**< Trigger #9 index */
#define CY_HPPASS_TRIG_10_IDX (10U) /**< Trigger #10 index */
#define CY_HPPASS_TRIG_11_IDX (11U) /**< Trigger #11 index */
#define CY_HPPASS_TRIG_12_IDX (12U) /**< Trigger #12 index */
#define CY_HPPASS_TRIG_13_IDX (13U) /**< Trigger #13 index */
#define CY_HPPASS_TRIG_14_IDX (14U) /**< Trigger #14 index */
#define CY_HPPASS_TRIG_15_IDX (15U) /**< Trigger #15 index */
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define CY_HPPASS_TRIG_CMP_5         (0x20) /**< CSG comparator #5 output mask */
#define CY_HPPASS_TRIG_CMP_6         (0x40) /**< CSG comparator #6 output mask */
#define CY_HPPASS_TRIG_CMP_7         (0x80) /**< CSG comparator #7 output mask */
#define CY_HPPASS_TRIG_CMP_8         (0x100) /**< CSG comparator #8 output mask */

#define CY_HPPASS_TRIG_CMP_REMAP_0   (0x01) /**< CSG group #0 comparator remap output mask */
#define CY_HPPASS_TRIG_CMP_REMAP_1   (0x02) /**< CSG group #1 comparator remap output mask */
#define CY_HPPASS_TRIG_CMP_REMAP_2   (0x04) /**< CSG group #2 comparator remap output mask */

#define CY_HPPASS_TRIG_DAC_FIFO_0    (0x01) /**< DAC FIFO #0 below threshold output mask */
#define CY_HPPASS_TRIG_DAC_FIFO_1    (0x02) /**< DAC FIFO #1 below threshold output mask */
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define CY_HPPASS_TRIG_8_MSK  (1U << CY_HPPASS_TRIG_8_IDX)  /**< Trigger #8 mask */
#define CY_HPPASS_TRIG_9_MSK  (1U << CY_HPPASS_TRIG_9_IDX)  /**< Trigger #9 mask */
#define CY_HPPASS_TRIG_10_MSK (1U << CY_HPPASS_TRIG_10_IDX) /**< Trigger #10 mask */
#define CY_HPPASS_TRIG_11_MSK (1U << CY_HPPASS_TRIG_11_IDX) /**< Trigger #11 mask */
#define CY_HPPASS_TRIG_12_MSK (1U << CY_HPPASS_TRIG_12_IDX) /**< Trigger #12 mask */
#define CY_HPPASS_TRIG_13_MSK (1U << CY_HPPASS_TRIG_13_IDX) /**< Trigger #13 mask */
#define CY_HPPASS_TRIG_14_MSK (1U << CY_HPPASS_TRIG_14_IDX) /**< Trigger #14 mask */
#define CY_HPPASS_TRIG_15_MSK (1U << CY_HPPASS_TRIG_15_IDX) /**< Trigger #15 mask */
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
#define CY_HPPASS_TRIGPULSE_VALID(trigPulse)          ((CY_HPPASS_DISABLED     == (trigPulse)) || \
                                                       ...
                                                       (CY_HPPASS_HWFILT3P3Z_0 == (trigPulse)) || \
                                                       (CY_HPPASS_HWFILT3P3Z_1 == (trigPulse)) || \
                                                       (CY_HPPASS_HWFILT3P3Z_2 == (trigPulse)))
#else
#define CY_HPPASS_TRIGPULSE_VALID(trigPulse)          ((CY_HPPASS_DISABLED     == (trigPulse)) || \
                                                       (CY_HPPASS_SAR_GROUP_0  == (trigPulse)) || \
                                                       (CY_HPPASS_SAR_GROUP_1  == (trigPulse)) || \
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define CY_HPPASS_COMPMASK_VALID(compEn)          ((compEn) == ((compEn) & (CY_HPPASS_INTR_CSG_0_CMP | \
                                                                            CY_HPPASS_INTR_CSG_1_CMP | \
                                                                            CY_HPPASS_INTR_CSG_2_CMP | \
                                                                            CY_HPPASS_INTR_CSG_3_CMP | \
                                                                            CY_HPPASS_INTR_CSG_4_CMP | \
                                                                            CY_HPPASS_INTR_CSG_5_CMP | \
                                                                            CY_HPPASS_INTR_CSG_6_CMP | \
                                                                            CY_HPPASS_INTR_CSG_7_CMP | \
                                                                            CY_HPPASS_INTR_CSG_8_CMP)))
#else
#define CY_HPPASS_COMPMASK_VALID(compEn)          ((compEn) == ((compEn) & (CY_HPPASS_INTR_CSG_0_CMP | \
                                                                            CY_HPPASS_INTR_CSG_1_CMP | \
                                                                            CY_HPPASS_INTR_CSG_2_CMP | \
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
    CY_HPPASS_HWFILT3P3Z_0 = 12U, /**< Enable the 3P3Z Filter 0 Strobe trigger output */
    CY_HPPASS_HWFILT3P3Z_1 = 13U, /**< Enable the 3P3Z Filter 1 Strobe trigger output */
    CY_HPPASS_HWFILT3P3Z_2 = 14U, /**< Enable the 3P3Z Filter 2 Strobe trigger output */
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
    uint16_t compMsk; /**< Comparator mask, each bit represents separate CSG comparator output,
                       *   all selected outputs are then combined (ORed) together and
                       *   routed to associated trigger output
                       */
    uint8_t compRemapMsk; /**< Comparator logic remap output mask (3 bits, one per CSG group) */
    uint8_t dacFifoBelowThresholdMsk; /**< DAC FIFO below threshold mask (2 bits) */
#else
...
typedef struct
{
    ...
    uint8_t                                              vrefSel; /**< AREF voltage reference source selection:
                                                                   *   - 0: Internal bandgap (backward compatible default for zero-initialized structs)
                                                                   *   - 1: Internal bandgap reference (~2.5V)
                                                                   *   - 2: External VREFH pad
                                                                   *   - 3: Reserved
                                                                   *   Note: values 0 and 1 both select the internal bandgap.
                                                                   */
} cy_stc_hppass_cfg_t;
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define CY_HPPASS_TRIG_IDX_VALID(trigIdx)      (CY_HPPASS_TRIG_15_IDX >= (trigIdx))
#else
#define CY_HPPASS_TRIG_IDX_VALID(trigIdx)      (CY_HPPASS_TRIG_7_IDX >= (trigIdx))
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
#define CY_HPPASS_TRIG_IN_BIT_POS(trigIdx)  (4UL * ((uint32_t)(trigIdx) & 7UL)) /**< 4 is a width of TRIG_IN_SEL bitfield, wraps at 8 for second register */
...
__STATIC_INLINE cy_en_hppass_status_t Cy_HPPASS_TriggerInConfig(uint8_t trigIdx, const cy_stc_hppass_trig_in_t * trig)
{
    ...
    if ((NULL != trig) && (CY_HPPASS_TRIG_IDX_VALID(trigIdx)))
    {
        ...
        if (trigIdx >= 8U)
        {
            CY_REG32_CLR_SET(HPPASS_INFRA_TR_IN_SEL_2(HPPASS_BASE), trInSel, trig->type);
            CY_REG32_CLR_SET(HPPASS_INFRA_HW_TR_MODE_2(HPPASS_BASE), trInMode, trig->hwMode);
        }
        else
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
        {
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
                                                         _VAL2FLD(HPPASS_MMIO_TR_LEVEL_OUT_CMP_LOGIC_REMAP_TR, trig->compRemapMsk) |
                                                         _VAL2FLD(HPPASS_MMIO_TR_LEVEL_OUT_DAC_FIFO_BELOW_THRESHOLD, trig->dacFifoBelowThresholdMsk) |
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
*******************************************************************************/
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
__STATIC_INLINE void Cy_HPPASS_SetFwTriggerPulse(uint16_t mask)
#else
...
*******************************************************************************/
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
__STATIC_INLINE void Cy_HPPASS_SetFwTriggerLevel(uint16_t mask)
#else
...
*******************************************************************************/
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
__STATIC_INLINE void Cy_HPPASS_ClearFwTriggerLevel(uint16_t mask)
#else
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
/*******************************************************************************
* Function Name: Cy_HPPASS_SetGpioIsolation
****************************************************************************//**
*
* Configures the HPPASS GPIO isolation control.
* Each bit in the masks corresponds to one of the 8 GPIO isolation switches.
*
* \param forceOnMask
* Bitmask [7:0] to force isolation switches closed (connected).
* Bit = 1: output is connected to input.
*
* \param forceOffMask
* Bitmask [7:0] to force isolation switches open (disconnected).
* Bit = 1: output is NOT connected to input.
*
* \note If both forceOn and forceOff bits are set for the same GPIO,
*       forceOff takes priority per hardware specification.
*
*******************************************************************************/
__STATIC_INLINE void Cy_HPPASS_SetGpioIsolation(uint8_t forceOnMask, uint8_t forceOffMask)
{
    HPPASS_INFRA_GPIO_ISO_CTRL(HPPASS_BASE) =
        _VAL2FLD(HPPASS_INFRA_GPIO_ISO_CTRL_GPIO_FORCE_ISOLATION_ON, forceOnMask) |
        _VAL2FLD(HPPASS_INFRA_GPIO_ISO_CTRL_GPIO_FORCE_ISOLATION_OFF, forceOffMask);
}


/*******************************************************************************
* Function Name: Cy_HPPASS_GetGpioIsolation
****************************************************************************//**
*
* Returns the current value of the HPPASS GPIO isolation control register.
*
* \return
* The GPIO_ISO_CTRL register value. Use
* \ref HPPASS_INFRA_GPIO_ISO_CTRL_GPIO_FORCE_ISOLATION_ON_Msk and
* \ref HPPASS_INFRA_GPIO_ISO_CTRL_GPIO_FORCE_ISOLATION_OFF_Msk
* to extract individual fields.
*
*******************************************************************************/
__STATIC_INLINE uint32_t Cy_HPPASS_GetGpioIsolation(void)
{
    return HPPASS_INFRA_GPIO_ISO_CTRL(HPPASS_BASE);
}
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */

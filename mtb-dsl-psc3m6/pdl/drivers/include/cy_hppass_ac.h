...
#define CY_HPPASS_ID                CY_PDL_DRV_ID(CY_PDL_RSLT_MODULE_HPPASS)
...
/* Helper macro for version-dependent validation */
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define IF_CY_IP_MXS40MCPASS_VERSION_3(x) x
#else
#define IF_CY_IP_MXS40MCPASS_VERSION_3(x)
...
#define CY_HPPASS_AC_CONDITION_VALID(condition)     ((CY_HPPASS_CONDITION_FALSE               == (condition)) || \
                                                     ...
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_TRIG_8 == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_TRIG_9 == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_TRIG_10 == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_TRIG_11 == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_TRIG_12 == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_TRIG_13 == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_TRIG_14 == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_TRIG_15 == (condition)) ||) \
                                                     ...
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_CSG_5_DAC_DONE == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_CSG_6_DAC_DONE == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_CSG_7_DAC_DONE == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_CSG_8_DAC_DONE == (condition)) ||) \
                                                     ...
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_CSG_5_COMP == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_CSG_6_COMP == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_CSG_7_COMP == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_CSG_8_COMP == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_REMAP_0 == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_REMAP_1 == (condition)) ||) \
                                                     IF_CY_IP_MXS40MCPASS_VERSION_3((CY_HPPASS_CONDITION_REMAP_2 == (condition)) ||) \
                                                     0)
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
    CY_HPPASS_CONDITION_TRIG_0             = 26U, /**< HW/FW Trigger 0. */
    CY_HPPASS_CONDITION_TRIG_1             = 27U, /**< HW/FW Trigger 1. */
    CY_HPPASS_CONDITION_TRIG_2             = 28U, /**< HW/FW Trigger 2. */
    CY_HPPASS_CONDITION_TRIG_3             = 29U, /**< HW/FW Trigger 3. */
    CY_HPPASS_CONDITION_TRIG_4             = 30U, /**< HW/FW Trigger 4. */
    CY_HPPASS_CONDITION_TRIG_5             = 31U, /**< HW/FW Trigger 5. */
    CY_HPPASS_CONDITION_TRIG_6             = 32U, /**< HW/FW Trigger 6. */
    CY_HPPASS_CONDITION_TRIG_7             = 33U, /**< HW/FW Trigger 7. */
    CY_HPPASS_CONDITION_TRIG_8             = 34U, /**< HW/FW Trigger 8. */
    CY_HPPASS_CONDITION_TRIG_9             = 35U, /**< HW/FW Trigger 9. */
    CY_HPPASS_CONDITION_TRIG_10            = 36U, /**< HW/FW Trigger 10. */
    CY_HPPASS_CONDITION_TRIG_11            = 37U, /**< HW/FW Trigger 11. */
    CY_HPPASS_CONDITION_TRIG_12            = 38U, /**< HW/FW Trigger 12. */
    CY_HPPASS_CONDITION_TRIG_13            = 39U, /**< HW/FW Trigger 13. */
    CY_HPPASS_CONDITION_TRIG_14            = 40U, /**< HW/FW Trigger 14. */
    CY_HPPASS_CONDITION_TRIG_15            = 41U, /**< HW/FW Trigger 15. */
#else
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
    CY_HPPASS_CONDITION_CSG_5_DAC_DONE     = 53U, /**< CSG5 Slope/LUT waveform Done. */
    CY_HPPASS_CONDITION_CSG_6_DAC_DONE     = 54U, /**< CSG6 Slope/LUT waveform Done. */
    CY_HPPASS_CONDITION_CSG_7_DAC_DONE     = 55U, /**< CSG7 Slope/LUT waveform Done. */
    CY_HPPASS_CONDITION_CSG_8_DAC_DONE     = 56U, /**< CSG8 Slope/LUT waveform Done. */
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
    CY_HPPASS_CONDITION_CSG_0_COMP         = 57U, /**< CSG0 Comparator Trip. */
    CY_HPPASS_CONDITION_CSG_1_COMP         = 58U, /**< CSG1 Comparator Trip. */
    CY_HPPASS_CONDITION_CSG_2_COMP         = 59U, /**< CSG2 Comparator Trip. */
    CY_HPPASS_CONDITION_CSG_3_COMP         = 60U, /**< CSG3 Comparator Trip. */
    CY_HPPASS_CONDITION_CSG_4_COMP         = 61U, /**< CSG4 Comparator Trip. */
    CY_HPPASS_CONDITION_CSG_5_COMP         = 62U, /**< CSG5 Comparator Trip. */
    CY_HPPASS_CONDITION_CSG_6_COMP         = 63U, /**< CSG6 Comparator Trip. */
    CY_HPPASS_CONDITION_CSG_7_COMP         = 64U, /**< CSG7 Comparator Trip. */
    CY_HPPASS_CONDITION_CSG_8_COMP         = 65U, /**< CSG8 Comparator Trip. */
    CY_HPPASS_CONDITION_REMAP_0            = 66U, /**< Comparator Remap 0. */
    CY_HPPASS_CONDITION_REMAP_1            = 67U, /**< Comparator Remap 1. */
    CY_HPPASS_CONDITION_REMAP_2            = 68U, /**< Comparator Remap 2. */
#else

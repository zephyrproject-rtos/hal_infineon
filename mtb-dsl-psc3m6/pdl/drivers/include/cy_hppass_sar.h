...
#define CY_HPPASS_SAR_SAMP_NUM_VALID(sampIdx)   ((CY_HPPASS_SAR_DIR_SAMP_NUM + CY_HPPASS_SAR_MUX_SAMP_NUM) > (sampIdx))

/** \endcond */

#define CY_HPPASS_SAR_GRP_NUM           (8U)  /**< The number of Sequencer Groups */
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define CY_HPPASS_SAR_CHAN_NUM          (36U) /**< The number of channels */
#else
...
#define CY_HPPASS_SAMP_GAIN_WIDTH       (2U)  /**< The width in bits of each sampler gain field in the SAMP_GAIN register */
...
/** \addtogroup group_hppass_sar_aroute_switches
 *  To be used with \ref Cy_HPPASS_SAR_SetSwitch,
 *                  \ref Cy_HPPASS_SAR_ClearSwitch,
 *                  \ref Cy_HPPASS_SAR_GetSwitchStatus
 *  \{
 */
/** v1 layout: 4 switches per mux, 4 muxes = 16 bits total */
#define CY_HPPASS_SAR_MUX0_SW0      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX0_SW0_Msk) /**< MUX0 switch 0 */
#define CY_HPPASS_SAR_MUX0_SW1      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX0_SW1_Msk) /**< MUX0 switch 1 */
#define CY_HPPASS_SAR_MUX0_SW2      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX0_SW2_Msk) /**< MUX0 switch 2 */
#define CY_HPPASS_SAR_MUX0_SW3      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX0_SW3_Msk) /**< MUX0 switch 3 */
#define CY_HPPASS_SAR_MUX1_SW0      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX1_SW0_Msk) /**< MUX1 switch 0 */
#define CY_HPPASS_SAR_MUX1_SW1      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX1_SW1_Msk) /**< MUX1 switch 1 */
#define CY_HPPASS_SAR_MUX1_SW2      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX1_SW2_Msk) /**< MUX1 switch 2 */
#define CY_HPPASS_SAR_MUX1_SW3      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX1_SW3_Msk) /**< MUX1 switch 3 */
#define CY_HPPASS_SAR_MUX2_SW0      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX2_SW0_Msk) /**< MUX2 switch 0 */
#define CY_HPPASS_SAR_MUX2_SW1      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX2_SW1_Msk) /**< MUX2 switch 1 */
#define CY_HPPASS_SAR_MUX2_SW2      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX2_SW2_Msk) /**< MUX2 switch 2 */
#define CY_HPPASS_SAR_MUX2_SW3      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX2_SW3_Msk) /**< MUX2 switch 3 */
#define CY_HPPASS_SAR_MUX3_SW0      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX3_SW0_Msk) /**< MUX3 switch 0 */
#define CY_HPPASS_SAR_MUX3_SW1      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX3_SW1_Msk) /**< MUX3 switch 1 */
#define CY_HPPASS_SAR_MUX3_SW2      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX3_SW2_Msk) /**< MUX3 switch 2 */
#define CY_HPPASS_SAR_MUX3_SW3      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX3_SW3_Msk) /**< MUX3 switch 3 */
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define CY_HPPASS_SAR_MUX0_SW4      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX0_SW4_Msk) /**< MUX0 switch 4 (v3: AFE/DAC input) */
#define CY_HPPASS_SAR_MUX0_SW5      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX0_SW5_Msk) /**< MUX0 switch 5 (v3: AFE/DAC input) */
#define CY_HPPASS_SAR_MUX1_SW4      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX1_SW4_Msk) /**< MUX1 switch 4 (v3: AFE/DAC input) */
#define CY_HPPASS_SAR_MUX1_SW5      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX1_SW5_Msk) /**< MUX1 switch 5 (v3: AFE/DAC input) */
#define CY_HPPASS_SAR_MUX2_SW4      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX2_SW4_Msk) /**< MUX2 switch 4 (v3: AFE/DAC input) */
#define CY_HPPASS_SAR_MUX2_SW5      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX2_SW5_Msk) /**< MUX2 switch 5 (v3: AFE/DAC input) */
#define CY_HPPASS_SAR_MUX3_SW4      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX3_SW4_Msk) /**< MUX3 switch 4 (v3: AFE/DAC input) */
#define CY_HPPASS_SAR_MUX3_SW5      (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX3_SW5_Msk) /**< MUX3 switch 5 (v3: AFE/DAC input) */
#define CY_HPPASS_SAR_MUX0_SW6_DFT  (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX0_SW6_DFT_Msk) /**< MUX0 DFT switch 6 (v3) */
#define CY_HPPASS_SAR_MUX0_SW7_DFT  (HPPASS_SAR_CFG_AROUTE_FW_CTRL_MUX0_SW7_DFT_Msk) /**< MUX0 DFT switch 7 (v3) */
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
/** \} group_hppass_sar_aroute_switches */
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define CY_HPPASS_INTR_SAR_RESULT_HWFILT3P3Z_0  (0x40000UL)  /**< Result interrupt mask for the HWFILT3P3Z #0 */
#define CY_HPPASS_INTR_SAR_RESULT_HWFILT3P3Z_1  (0x80000UL)  /**< Result interrupt mask for the HWFILT3P3Z #1 */
#define CY_HPPASS_INTR_SAR_RESULT_HWFILT3P3Z_2  (0x100000UL) /**< Result interrupt mask for the HWFILT3P3Z #2 */
#define CY_HPPASS_INTR_SAR_RESULT_HWFILT3P3Z    (HPPASS_SAR_CFG_SAR_RESULT_INTR_HWFILT3P3Z_DONE_Msk) /**< Combined HWFILT3P3Z result interrupt mask */
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
#define CY_HPPASS_INTR_SAR_RESULT           (HPPASS_SAR_CFG_SAR_RESULT_INTR_ENTRY_DONE_Msk | \
                                             ...
                                             HPPASS_SAR_CFG_SAR_RESULT_INTR_HWFILT3P3Z_DONE_Msk)
#else
#define CY_HPPASS_INTR_SAR_RESULT           (HPPASS_SAR_CFG_SAR_RESULT_INTR_ENTRY_DONE_Msk | \
                                             HPPASS_SAR_CFG_SAR_RESULT_INTR_FIR_DONE_Msk)
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define CY_HPPASS_SAR_CHAN_28_IDX (28U) /**< The Index of the SAR Channel #28 */
#define CY_HPPASS_SAR_CHAN_29_IDX (29U) /**< The Index of the SAR Channel #29 */
#define CY_HPPASS_SAR_CHAN_30_IDX (30U) /**< The Index of the SAR Channel #30 */
#define CY_HPPASS_SAR_CHAN_31_IDX (31U) /**< The Index of the SAR Channel #31 */
#define CY_HPPASS_SAR_CHAN_32_IDX (32U) /**< The Index of the SAR Channel #32 */
#define CY_HPPASS_SAR_CHAN_33_IDX (33U) /**< The Index of the SAR Channel #33 */
#define CY_HPPASS_SAR_CHAN_34_IDX (34U) /**< The Index of the SAR Channel #34 */
#define CY_HPPASS_SAR_CHAN_35_IDX (35U) /**< The Index of the SAR Channel #35 */
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define CY_HPPASS_SAR_CHAN_28_MSK (1UL << CY_HPPASS_SAR_CHAN_28_IDX) /**< The Status mask for the SAR Channel #28 */
#define CY_HPPASS_SAR_CHAN_29_MSK (1UL << CY_HPPASS_SAR_CHAN_29_IDX) /**< The Status mask for the SAR Channel #29 */
#define CY_HPPASS_SAR_CHAN_30_MSK (1UL << CY_HPPASS_SAR_CHAN_30_IDX) /**< The Status mask for the SAR Channel #30 */
#define CY_HPPASS_SAR_CHAN_31_MSK (1UL << CY_HPPASS_SAR_CHAN_31_IDX) /**< The Status mask for the SAR Channel #31 */
/** \note Channels 32-35 and FIR status are in the RESULT_STATUS_2/LIMIT_STATUS_2 register.
 * Use the _2 suffix macros and functions below for those. */
#define CY_HPPASS_SAR_CHAN_32_MSK_2 (1UL << 0U) /**< The Status_2 mask for the SAR Channel #32 */
#define CY_HPPASS_SAR_CHAN_33_MSK_2 (1UL << 1U) /**< The Status_2 mask for the SAR Channel #33 */
#define CY_HPPASS_SAR_CHAN_34_MSK_2 (1UL << 2U) /**< The Status_2 mask for the SAR Channel #34 */
#define CY_HPPASS_SAR_CHAN_35_MSK_2 (1UL << 3U) /**< The Status_2 mask for the SAR Channel #35 */
#define CY_HPPASS_SAR_FIR_0_MSK_2  (1UL << 30U) /**< The Status_2 mask for the FIR Channel #0 (v3) */
#define CY_HPPASS_SAR_FIR_1_MSK_2  (1UL << 31U) /**< The Status_2 mask for the FIR Channel #1 (v3) */
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
/** The Common Status mask for all the ADC and FIR channels (RESULT_STATUS/LIMIT_STATUS register) */
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define CY_HPPASS_SAR_CHAN_MSK (CY_HPPASS_SAR_CHAN_0_MSK | \
                                ...
                                CY_HPPASS_SAR_CHAN_28_MSK | \
                                CY_HPPASS_SAR_CHAN_29_MSK | \
                                CY_HPPASS_SAR_CHAN_30_MSK | \
                                CY_HPPASS_SAR_CHAN_31_MSK)

/** The Status_2 mask for channels 32-35 and FIR (RESULT_STATUS_2/LIMIT_STATUS_2 register) */
#define CY_HPPASS_SAR_CHAN_MSK_2 (CY_HPPASS_SAR_CHAN_32_MSK_2 | \
                                  CY_HPPASS_SAR_CHAN_33_MSK_2 | \
                                  CY_HPPASS_SAR_CHAN_34_MSK_2 | \
                                  CY_HPPASS_SAR_CHAN_35_MSK_2 | \
                                  CY_HPPASS_SAR_FIR_0_MSK_2 | \
                                  CY_HPPASS_SAR_FIR_1_MSK_2)
#else
#define CY_HPPASS_SAR_CHAN_MSK (CY_HPPASS_SAR_CHAN_0_MSK | \
                                CY_HPPASS_SAR_CHAN_1_MSK | \
                                CY_HPPASS_SAR_CHAN_2_MSK | \
...
#define CY_HPPASS_CHAN_VALID(chan)          ((CY_HPPASS_FIR_DISABLED == (chan)) || \
                                            ...
                                            CY_HPPASS_FIR_CHAN_V3_VALID(chan))

#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
#define CY_HPPASS_FIR_CHAN_V3_VALID(chan)   ((CY_HPPASS_FIR_CHAN_28   == (chan)) || \
                                            (CY_HPPASS_FIR_CHAN_29   == (chan)) || \
                                            (CY_HPPASS_FIR_CHAN_30   == (chan)) || \
                                            (CY_HPPASS_FIR_CHAN_31   == (chan)) || \
                                            (CY_HPPASS_FIR_CHAN_32   == (chan)) || \
                                            (CY_HPPASS_FIR_CHAN_33   == (chan)) || \
                                            (CY_HPPASS_FIR_CHAN_34   == (chan)) || \
                                            (CY_HPPASS_FIR_CHAN_35   == (chan)))
#else
#define CY_HPPASS_FIR_CHAN_V3_VALID(chan)   (false)
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
    CY_HPPASS_SAR_TRIG_8        = 9U,  /**< Trigger 8 */
    CY_HPPASS_SAR_TRIG_9        = 10U, /**< Trigger 9 */
    CY_HPPASS_SAR_TRIG_10       = 11U, /**< Trigger 10 */
    CY_HPPASS_SAR_TRIG_11       = 12U, /**< Trigger 11 */
    CY_HPPASS_SAR_TRIG_12       = 13U, /**< Trigger 12 */
    CY_HPPASS_SAR_TRIG_13       = 14U, /**< Trigger 13 */
    CY_HPPASS_SAR_TRIG_14       = 15U, /**< Trigger 14 */
    CY_HPPASS_SAR_TRIG_15       = 16U, /**< Trigger 15 */
    CY_HPPASS_SAR_TRIG_AC       = 17U, /**< Trigger from the Autonomous Controller */
#else
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
    CY_HPPASS_FIR_CHAN_28    = 29U,  /**< Channel 28 */
    CY_HPPASS_FIR_CHAN_29    = 30U,  /**< Channel 29 */
    CY_HPPASS_FIR_CHAN_30    = 31U,  /**< Channel 30 */
    CY_HPPASS_FIR_CHAN_31    = 32U,  /**< Channel 31 */
    CY_HPPASS_FIR_CHAN_32    = 33U,  /**< Channel 32 */
    CY_HPPASS_FIR_CHAN_33    = 34U,  /**< Channel 33 */
    CY_HPPASS_FIR_CHAN_34    = 35U,  /**< Channel 34 */
    CY_HPPASS_FIR_CHAN_35    = 36U,  /**< Channel 35 */
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
    CY_HPPASS_SAR_AVG_32       = 5U, /**< Averaging 32. Note: the accumulated result is right-shifted by 1
                                      *   to fit in the 16-bit RESULT register, so the effective
                                      *   multiplier in the result is 16 (same as \ref CY_HPPASS_SAR_AVG_16). */
    CY_HPPASS_SAR_AVG_64       = 6U, /**< Averaging 64. Note: the accumulated result is right-shifted by 2
                                      *   to fit in the 16-bit RESULT register, so the effective
                                      *   multiplier in the result is 16 (same as \ref CY_HPPASS_SAR_AVG_16). */
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
    bool resultAlign;                       /**< Result alignment: false - left-aligned, true - right-aligned */
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
} cy_stc_hppass_fir_t;
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
    bool rightAlign;                /**< Result alignment: false - left-aligned, true - right-aligned */
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
                                                        ;
            HPPASS_SAR_SEQ_GROUP_2(HPPASS_BASE, grpIdx) = _VAL2FLD(HPPASS_SAR_SEQ_ENTRY_2_TR_SEL, grpCfg->trig)             |
                                                          _VAL2FLD(HPPASS_SAR_SEQ_ENTRY_2_SAMP_TIME_SEL, grpCfg->sampTime)  |
                                                          _VAL2FLD(HPPASS_SAR_SEQ_ENTRY_2_PRIORITY, grpCfg->priority)       |
                                                          _VAL2FLD(HPPASS_SAR_SEQ_ENTRY_2_CONT, grpCfg->continuous);
#else
...
__STATIC_INLINE cy_en_hppass_status_t Cy_HPPASS_SAR_DisableGroupContConvert(uint8_t grpIdx)
{
    ...
    if (CY_HPPASS_SUCCESS == result)
    {
        ...
        {
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
            HPPASS_SAR_SEQ_GROUP_2(HPPASS_BASE, grpIdx) &= ~HPPASS_SAR_SEQ_ENTRY_2_CONT_Msk;
#else
...
/*******************************************************************************
* Function Name: Cy_HPPASS_SAR_SetSampGain
****************************************************************************//**
*
* Sets the sampler gain for a single sampler in the SAMP_GAIN register.
* This is a runtime API to update individual sampler gain without
* reinitializing the full SAR configuration.
*
* \param sampIdx
* The sampler index. Valid range: 0..11 for direct samplers,
* 12..15 for muxed samplers (CY_HPPASS_SAR_DIR_SAMP_NUM +
* CY_HPPASS_SAR_MUX_SAMP_NUM - 1).
* \note For pseudo-differential pairs, the even and odd sampler gains
* must be configured identically.
*
* \param gain
* The sampler gain setting. \ref cy_en_hppass_sar_samp_gain_t.
*
*******************************************************************************/
__STATIC_INLINE void Cy_HPPASS_SAR_SetSampGain(uint8_t sampIdx, cy_en_hppass_sar_samp_gain_t gain)
{
    CY_ASSERT_L2(CY_HPPASS_SAR_SAMP_NUM_VALID(sampIdx));
    uint32_t reg = HPPASS_SAR_SAMP_GAIN(HPPASS_BASE);
    reg &= ~(3UL << (sampIdx * CY_HPPASS_SAMP_GAIN_WIDTH));
    reg |= (uint32_t)gain << (sampIdx * CY_HPPASS_SAMP_GAIN_WIDTH);
    HPPASS_SAR_SAMP_GAIN(HPPASS_BASE) = reg;
}
...
*******************************************************************************/
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
__STATIC_INLINE int32_t Cy_HPPASS_TEMP_Calc(int32_t tempHi, int32_t tempLo)
{
...
*******************************************************************************/
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
void Cy_HPPASS_SAR_TempAdjust(int32_t temp, uint16_t vRef);
#else
    ...
    if (CY_HPPASS_SUCCESS == result)
    {
        if ((NULL != firCfg) && (CY_HPPASS_FIR_NUM_VALID(firIdx)))
        {
            ...
            HPPASS_SAR_FIR_CFG(HPPASS_BASE, firIdx) = _VAL2FLD(HPPASS_SAR_CFG_FIR_CFG_CHANNEL_SEL, firCfg->chan) |
                                              ...
                                              #if (CY_IP_MXS40MCPASS_VERSION >= 3u)
                                                      _VAL2FLD(HPPASS_SAR_CFG_FIR_CFG_FIR_RESULT_ALIGN, firCfg->resultAlign);
                                              #else
                                                      0U;
                                              #endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */

        #if (CY_IP_MXS40MCPASS_VERSION >= 3u)
            /* In v3, FIR result mask bits are in RESULT_MASK_2 at positions 30-31 */
            CY_REG32_CLR_SET(HPPASS_SAR_RESULT_MASK_2(HPPASS_BASE), resultMask, CY_HPPASS_BOOL_TO_UINT(firCfg->result));
        #else
...
*******************************************************************************/
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
__STATIC_INLINE int32_t Cy_HPPASS_SAR_Result_FirRead(uint8_t firIdx)
{
    CY_ASSERT_L1(CY_HPPASS_FIR_NUM_VALID(firIdx));

    return (int32_t)*CY_HPPASS_SAR_FIR_RSLT_PTR(firIdx);
}
#else
...
*
* \param chanIdx
* The index of the channel. Valid range 0..\ref CY_HPPASS_SAR_CHAN_NUM - 1.
*
* \param chanCfg
    ...
    if (CY_HPPASS_SUCCESS == result)
    {
            ...
            (!chanCfg->diff || (CY_HPPASS_SAR_AVG_DISABLED == chanCfg->avg)))
        {
            ...
            HPPASS_SAR_CHAN_CFG(HPPASS_BASE, chanIdx) = _VAL2FLD(HPPASS_SAR_CFG_CHAN_CFG_DIFFERENTIAL_EN, chanCfg->diff) |
                                                    ...
                                                    #if (CY_IP_MXS40MCPASS_VERSION >= 3u)
                                                        _VAL2FLD(HPPASS_SAR_CFG_CHAN_CFG_LEFT_RIGHT_ALIGNED, chanCfg->rightAlign) |
                                                    #endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
            ...
            if (chanIdx >= 32U)
            {
                uint32_t resultMask_Pos = (uint32_t)chanIdx - 32U;
                uint32_t resultMask_Msk = CY_HPPASS_SAR_CHAN_0_MSK << resultMask_Pos;
                CY_REG32_CLR_SET(HPPASS_SAR_RESULT_MASK_2(HPPASS_BASE), resultMask, CY_HPPASS_BOOL_TO_UINT(chanCfg->result));
            }
            else
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
            {
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
/*******************************************************************************
* Function Name: Cy_HPPASS_SAR_Result_GetStatus_2
****************************************************************************//**
*
* Returns the combined status of ADC channels 32-35 and FIR results
* from the RESULT_STATUS_2 register (v3 only).
*
* \return The ADC channels 32-35 and FIR results status \ref group_hppass_sar_status.
*
*******************************************************************************/
__STATIC_INLINE uint32_t Cy_HPPASS_SAR_Result_GetStatus_2(void)
{
    return HPPASS_SAR_RESULT_STATUS_2(HPPASS_BASE);
}


/*******************************************************************************
* Function Name: Cy_HPPASS_SAR_Result_ClearStatus_2
****************************************************************************//**
*
* Clears the ADC channels 32-35 and FIR results status
* in the RESULT_STATUS_2 register (v3 only).
*
* \param mask
* The channels 32-35 and FIR status mask, use CY_HPPASS_SAR_CHAN_MSK_2.
*
*******************************************************************************/
__STATIC_INLINE void Cy_HPPASS_SAR_Result_ClearStatus_2(uint32_t mask)
{
    CY_ASSERT_L2(CY_HPPASS_MASK_VALID(mask, CY_HPPASS_SAR_CHAN_MSK_2));

    HPPASS_SAR_RESULT_STATUS_2(HPPASS_BASE) = CY_HPPASS_SAR_CHAN_MSK_2 & mask;
}
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
*
* \param chanIdx
* The index of the channel instance. Valid range 0..CY_HPPASS_SAR_CHAN_NUM - 1.
...
*******************************************************************************/
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
__STATIC_INLINE int32_t Cy_HPPASS_SAR_Result_ChannelRead(uint8_t chanIdx)
{
    CY_ASSERT_L1(CY_HPPASS_SAR_CHAN_NUM_VALID(chanIdx));

    return (int32_t)*CY_HPPASS_SAR_CHAN_RSLT_PTR(chanIdx);
}
#else
...
*
* \param pairIdx
* The index of the adjacent even/odd channels pair instance. Valid range 0..(CY_HPPASS_SAR_CHAN_NUM/2 - 1).
*
...
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
/*******************************************************************************
* Function Name: Cy_HPPASS_SAR_Limit_GetStatus_2
****************************************************************************//**
*
* Returns the combined limit crossing detection status of ADC channels 32-35
* and FIR channels from the LIMIT_STATUS_2 register (v3 only).
*
* \return The limit crossing detection status \ref group_hppass_sar_status
*
*******************************************************************************/
__STATIC_INLINE uint32_t Cy_HPPASS_SAR_Limit_GetStatus_2(void)
{
    return HPPASS_SAR_LIMIT_STATUS_2(HPPASS_BASE);
}


/*******************************************************************************
* Function Name: Cy_HPPASS_SAR_Limit_ClearStatus_2
****************************************************************************//**
*
* Clears the limit crossing detection status for ADC channels 32-35
* and FIR channels in the LIMIT_STATUS_2 register (v3 only).
*
* \param mask
* The limit crossing detection status mask, use CY_HPPASS_SAR_CHAN_MSK_2.
*
*******************************************************************************/
__STATIC_INLINE void Cy_HPPASS_SAR_Limit_ClearStatus_2(uint32_t mask)
{
    CY_ASSERT_L2(CY_HPPASS_MASK_VALID(mask, CY_HPPASS_SAR_CHAN_MSK_2));

    HPPASS_SAR_LIMIT_STATUS_2(HPPASS_BASE) = CY_HPPASS_SAR_CHAN_MSK_2 & mask;
}
#endif /* CY_IP_MXS40MCPASS_VERSION >= 3u */
...
*
*******************************************************************************/
__STATIC_INLINE void Cy_HPPASS_SAR_SetSwitch(uint32_t muxMask)
{
    HPPASS_SAR_AROUTE_FW_CTRL(HPPASS_BASE) = muxMask;
}
...
*
*******************************************************************************/
__STATIC_INLINE void Cy_HPPASS_SAR_ClearSwitch(uint32_t muxMask)
{
    HPPASS_SAR_AROUTE_FW_CTRL_CLR(HPPASS_BASE) = muxMask;
}
...
*
*******************************************************************************/
__STATIC_INLINE uint32_t Cy_HPPASS_SAR_GetSwitchStatus(void)
{
    return HPPASS_SAR_AROUTE_STATUS(HPPASS_BASE);
}
...
*
* \param chanIdx
* The channel index . Valid range - 0..CY_HPPASS_SAR_CHAN_NUM - 1.
*
* \param vRef
...
*******************************************************************************/
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
float32_t Cy_HPPASS_SAR_CountsTo_Volts(uint8_t chanIdx, uint16_t vRef, int32_t chanCounts);
#else
...
*******************************************************************************/
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
int32_t Cy_HPPASS_SAR_CountsTo_mVolts(uint8_t chanIdx, uint16_t vRef, int32_t chanCounts);
#else
...
*******************************************************************************/
#if (CY_IP_MXS40MCPASS_VERSION >= 3u)
int32_t Cy_HPPASS_SAR_CountsTo_uVolts(uint8_t chanIdx, uint16_t vRef, int32_t chanCounts);
#else

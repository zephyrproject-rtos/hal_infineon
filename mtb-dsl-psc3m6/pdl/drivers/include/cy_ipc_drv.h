...
*       between MCU and the BTSS. These APIs are supported in PSC devices.
 *
...
* PIPE, SEMA and BTSS layers of the API
...
#define CY_IPC_ID CY_PDL_DRV_ID(CY_PDL_RSLT_MODULE_IPC)  /**< Software PDL driver ID for IPC */

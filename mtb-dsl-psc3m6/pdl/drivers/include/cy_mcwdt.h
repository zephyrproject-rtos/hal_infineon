...
#define CY_MCWDT_ID       CY_PDL_DRV_ID(CY_PDL_RSLT_MODULE_MCWDT)                      /**< MCWDT PDL ID */
...
#if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2)) /* ADDED MANUALLY */
/** For compatibility with PSE8X7 and PSB MCWDT driver */
#define MCWDT_STRUCT_Type MCWDT_MAIN_Type
#endif
...
__STATIC_INLINE void Cy_MCWDT_Enable(MCWDT_STRUCT_Type *base, uint32_t counters, uint16_t waitUs)
{
    ...
    #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2)) /*PSE8X7: ADDED MANUALLY */
    enableCounters = ((0UL != (counters & CY_MCWDT_CTR0)) ? MCWDT_MAIN_MCWDT_CTL_WDT_ENABLE0_Msk : 0UL) |
                     ((0UL != (counters & CY_MCWDT_CTR1)) ? MCWDT_MAIN_MCWDT_CTL_WDT_ENABLE1_Msk : 0UL) |
                     ((0UL != (counters & CY_MCWDT_CTR2)) ? MCWDT_MAIN_MCWDT_CTL_WDT_ENABLE2_Msk : 0UL);
    #else
...
__STATIC_INLINE void Cy_MCWDT_Disable(MCWDT_STRUCT_Type *base, uint32_t counters, uint16_t waitUs)
{
    ...
    #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2)) /* ADDED MANUALLY */
    disableCounters = ((0UL != (counters & CY_MCWDT_CTR0)) ? MCWDT_MAIN_MCWDT_CTL_WDT_ENABLE0_Msk : 0UL) |
                      ((0UL != (counters & CY_MCWDT_CTR1)) ? MCWDT_MAIN_MCWDT_CTL_WDT_ENABLE1_Msk : 0UL) |
                      ((0UL != (counters & CY_MCWDT_CTR2)) ? MCWDT_MAIN_MCWDT_CTL_WDT_ENABLE2_Msk : 0UL);
    #else
...
__STATIC_INLINE uint32_t Cy_MCWDT_GetEnabledStatus(MCWDT_STRUCT_Type const *base, cy_en_mcwdtctr_t counter)
{
    ...
    switch (counter)
    {
        case CY_MCWDT_COUNTER0:
            #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2)) /*PSE8X7: ADDED MANUALLY */
            status = _FLD2VAL(MCWDT_MAIN_MCWDT_CTL_WDT_ENABLED0, MCWDT_CTL(base));
            #else
        ...
        case CY_MCWDT_COUNTER1:
            #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2)) /*PSE8X7: ADDED MANUALLY */
            status = _FLD2VAL(MCWDT_MAIN_MCWDT_CTL_WDT_ENABLED1, MCWDT_CTL(base));
            #else
        ...
        case CY_MCWDT_COUNTER2:
            #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2)) /*PSE8X7: ADDED MANUALLY */
            status = _FLD2VAL(MCWDT_MAIN_MCWDT_CTL_WDT_ENABLED2, MCWDT_CTL(base));
            #else
...
#if !defined(CY_IP_MXS40SRSS) || (CY_IP_MXS40SRSS_VERSION < 2)
#if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2)) /*PSE8X7: ADDED MANUALLY */
    MCWDT_LOCK(base) = _CLR_SET_FLD32U(MCWDT_LOCK(base), MCWDT_MAIN_MCWDT_LOCK_MCWDT_LOCK, (uint32_t)CY_MCWDT_LOCK_SET01);
#else
...
#if !defined(CY_IP_MXS40SRSS) || (CY_IP_MXS40SRSS_VERSION < 2)
#if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2)) /*PSE8X7: ADDED MANUALLY */
    MCWDT_LOCK(base) = _CLR_SET_FLD32U(MCWDT_LOCK(base), MCWDT_MAIN_MCWDT_LOCK_MCWDT_LOCK, (uint32_t)CY_MCWDT_LOCK_CLR0);
    MCWDT_LOCK(base) = _CLR_SET_FLD32U(MCWDT_LOCK(base), MCWDT_MAIN_MCWDT_LOCK_MCWDT_LOCK, (uint32_t)CY_MCWDT_LOCK_CLR1);
#else
...
__STATIC_INLINE uint32_t Cy_MCWDT_GetLockedStatus(MCWDT_STRUCT_Type const *base)
{
    ...
    return ((0UL != (MCWDT_LOCK(base) & MCWDT_MAIN_MCWDT_LOCK_MCWDT_LOCK_Msk)) ? 1UL : 0UL);
#else
...
__STATIC_INLINE void Cy_MCWDT_SetClearOnMatch(MCWDT_STRUCT_Type *base, cy_en_mcwdtctr_t counter, uint32_t enable)
{
    ...
    {
        #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
        MCWDT_CONFIG(base) = _CLR_SET_FLD32U(MCWDT_CONFIG(base), MCWDT_MAIN_MCWDT_CONFIG_WDT_CLEAR0, enable);
        #else
    ...
    {
        #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
        MCWDT_CONFIG(base) = _CLR_SET_FLD32U(MCWDT_CONFIG(base), MCWDT_MAIN_MCWDT_CONFIG_WDT_CLEAR1, enable);
        #else
...
__STATIC_INLINE uint32_t Cy_MCWDT_GetClearOnMatch(MCWDT_STRUCT_Type const *base, cy_en_mcwdtctr_t counter)
{
    ...
    {
        #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
        getClear = _FLD2VAL(MCWDT_MAIN_MCWDT_CONFIG_WDT_CLEAR0, MCWDT_CONFIG(base));
        #else
    ...
    {
        #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
        getClear = _FLD2VAL(MCWDT_MAIN_MCWDT_CONFIG_WDT_CLEAR1, MCWDT_CONFIG(base));
        #else
...
__STATIC_INLINE void Cy_MCWDT_SetCascade(MCWDT_STRUCT_Type *base, cy_en_mcwdtcascade_t cascade)
{
    ...
    #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
    MCWDT_CONFIG(base) = _CLR_SET_FLD32U(MCWDT_CONFIG(base), MCWDT_MAIN_MCWDT_CONFIG_WDT_CASCADE0_1,
                                             (uint32_t) cascade);
    MCWDT_CONFIG(base) = _CLR_SET_FLD32U(MCWDT_CONFIG(base), MCWDT_MAIN_MCWDT_CONFIG_WDT_CASCADE1_2,
                                             ((uint32_t) cascade >> 1u));
    #else
...
__STATIC_INLINE cy_en_mcwdtcascade_t Cy_MCWDT_GetCascade(MCWDT_STRUCT_Type const *base)
{
    ...
    #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
    cascade = (_FLD2VAL(MCWDT_MAIN_MCWDT_CONFIG_WDT_CASCADE1_2, MCWDT_CONFIG(base)) << 1u) |
               _FLD2VAL(MCWDT_MAIN_MCWDT_CONFIG_WDT_CASCADE0_1, MCWDT_CONFIG(base));
    #else
...
__STATIC_INLINE void Cy_MCWDT_SetMatch(MCWDT_STRUCT_Type *base, cy_en_mcwdtctr_t counter, uint32_t match, uint16_t waitUs)
{
    ...
    CY_ASSERT_L2(CY_MCWDT_IS_MATCH_VALID((CY_MCWDT_COUNTER0 == counter) ?                                        \
                                         ((MCWDT_CONFIG(base) & MCWDT_MAIN_MCWDT_CONFIG_WDT_CLEAR0_Msk) > 0U) :  \
                                         ((MCWDT_CONFIG(base) & MCWDT_MAIN_MCWDT_CONFIG_WDT_CLEAR1_Msk) > 0U),   \
                                         match));
    ...
    #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
        _CLR_SET_FLD32U(MCWDT_MATCH(base), MCWDT_MAIN_MCWDT_MATCH_WDT_MATCH0,
                       (match & MCWDT_MAIN_MCWDT_MATCH_WDT_MATCH0_Msk)) :
        _CLR_SET_FLD32U(MCWDT_MATCH(base), MCWDT_MAIN_MCWDT_MATCH_WDT_MATCH1,
                       (match & MCWDT_MAIN_MCWDT_MATCH_WDT_MATCH0_Msk));
    #else
...
__STATIC_INLINE uint32_t Cy_MCWDT_GetMatch(MCWDT_STRUCT_Type const *base, cy_en_mcwdtctr_t counter)
{
    ...
    #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
    match = (counter == CY_MCWDT_COUNTER0) ? _FLD2VAL(MCWDT_MAIN_MCWDT_MATCH_WDT_MATCH0, MCWDT_MATCH(base)) :
                                          _FLD2VAL(MCWDT_MAIN_MCWDT_MATCH_WDT_MATCH1, MCWDT_MATCH(base));
    #else
...
#if !defined(CY_IP_MXS40SRSS) || (CY_IP_MXS40SRSS_VERSION < 2)
#if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
    MCWDT_CONFIG(base) = _CLR_SET_FLD32U(MCWDT_CONFIG(base), MCWDT_MAIN_MCWDT_CONFIG_WDT_BITS2, bit);
#else
...
#if !defined(CY_IP_MXS40SRSS) || (CY_IP_MXS40SRSS_VERSION < 2)
#if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
    return (_FLD2VAL(MCWDT_MAIN_MCWDT_CONFIG_WDT_BITS2, MCWDT_CONFIG(base)));
#else
...
__STATIC_INLINE uint32_t Cy_MCWDT_GetCount(MCWDT_STRUCT_Type const *base, cy_en_mcwdtctr_t counter)
{
    ...
    switch (counter)
    {
        case CY_MCWDT_COUNTER0:
            #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
            countVal = _FLD2VAL(MCWDT_MAIN_MCWDT_CNTLOW_WDT_CTR0, MCWDT_CNTLOW(base));
            #else
        ...
        case CY_MCWDT_COUNTER1:
            #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
            countVal = _FLD2VAL(MCWDT_MAIN_MCWDT_CNTLOW_WDT_CTR1, MCWDT_CNTLOW(base));
            #else
        ...
        case CY_MCWDT_COUNTER2:
            #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
            countVal = _FLD2VAL(MCWDT_MAIN_MCWDT_CNTHIGH_WDT_CTR2, MCWDT_CNTHIGH(base));
            #else
...
*
*  \note
*  For XMC7 and TVIIBE devices, only CY_MCWDT_CTR0 and CY_MCWDT_CTR1 can be Reset.
*
* \funcusage
...
__STATIC_INLINE void Cy_MCWDT_ResetCounters(MCWDT_STRUCT_Type *base, uint32_t counters, uint16_t waitUs)
{
    ...
    #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
    resetCounters = ((0UL != (counters & CY_MCWDT_CTR0)) ? MCWDT_MAIN_MCWDT_CTL_WDT_RESET0_Msk : 0UL) |
                    ((0UL != (counters & CY_MCWDT_CTR1)) ? MCWDT_MAIN_MCWDT_CTL_WDT_RESET1_Msk : 0UL) |
                    ((0UL != (counters & CY_MCWDT_CTR2)) ? MCWDT_MAIN_MCWDT_CTL_WDT_RESET2_Msk : 0UL);
    #else
...
__STATIC_INLINE void Cy_MCWDT_SetLowerLimit(MCWDT_STRUCT_Type *base, cy_en_mcwdtlowerlimit_t counter, uint32_t lowerLimit, uint16_t waitUs)
{
    ...
    MCWDT_LOWER_LIMIT(base) = (counter == CY_MCWDT_LOWER_LIMIT0) ?
        _CLR_SET_FLD32U(MCWDT_LOWER_LIMIT(base), MCWDT_MAIN_MCWDT_LOWER_LIMIT_WDT_LOWER_LIMIT0,
                        (lowerLimit & MCWDT_MAIN_MCWDT_LOWER_LIMIT_WDT_LOWER_LIMIT0_Msk)) :
        _CLR_SET_FLD32U(MCWDT_LOWER_LIMIT(base), MCWDT_MAIN_MCWDT_LOWER_LIMIT_WDT_LOWER_LIMIT1,
                        (lowerLimit & MCWDT_MAIN_MCWDT_LOWER_LIMIT_WDT_LOWER_LIMIT0_Msk));
    #else
    MCWDT_LOWER_LIMIT(base) = (counter == CY_MCWDT_LOWER_LIMIT0) ?
...
__STATIC_INLINE uint32_t Cy_MCWDT_GetLowerLimit(MCWDT_STRUCT_Type const *base, cy_en_mcwdtlowerlimit_t counter)
{
    ...
    switch (counter)
    {
        case CY_MCWDT_LOWER_LIMIT0:
            #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
            countVal = _FLD2VAL(MCWDT_MAIN_MCWDT_LOWER_LIMIT_WDT_LOWER_LIMIT0, MCWDT_LOWER_LIMIT(base));
            #else
        ...
        case CY_MCWDT_LOWER_LIMIT1:
            #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
            countVal = _FLD2VAL(MCWDT_MAIN_MCWDT_LOWER_LIMIT_WDT_LOWER_LIMIT1, MCWDT_LOWER_LIMIT(base));
            #else
...
__STATIC_INLINE void Cy_MCWDT_SetLowerLimitMode(MCWDT_STRUCT_Type *base, cy_en_mcwdtlowerlimit_t counter, cy_en_mcwdtlowerlimitmode_t mode)
{
    ...
    {
        #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
        MCWDT_CONFIG(base) = _CLR_SET_FLD32U(MCWDT_CONFIG(base), MCWDT_MAIN_MCWDT_CONFIG_WDT_LOWER_MODE0, mode);
        #else
    ...
    {
        #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
        MCWDT_CONFIG(base) = _CLR_SET_FLD32U(MCWDT_CONFIG(base), MCWDT_MAIN_MCWDT_CONFIG_WDT_LOWER_MODE1, mode);
        #else
...
__STATIC_INLINE cy_en_mcwdtlowerlimitmode_t Cy_MCWDT_GetLowerLimitMode(MCWDT_STRUCT_Type const *base, cy_en_mcwdtlowerlimit_t counter)
{
    ...
    {
        #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
        getLowerLimitMode = _FLD2VAL(MCWDT_MAIN_MCWDT_CONFIG_WDT_LOWER_MODE0, MCWDT_CONFIG(base));
        #else
    ...
    {
        #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
        getLowerLimitMode = _FLD2VAL(MCWDT_MAIN_MCWDT_CONFIG_WDT_LOWER_MODE1, MCWDT_CONFIG(base));
        #else
...
__STATIC_INLINE void Cy_MCWDT_SetCascadeCarryOutRollOver(MCWDT_STRUCT_Type *base, cy_en_mcwdtcascade_t counter, bool carryoutconfig)
{
    ...
    {
        #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
        MCWDT_CONFIG(base) = _CLR_SET_FLD32U(MCWDT_CONFIG(base), MCWDT_MAIN_MCWDT_CONFIG_WDT_CARRY0_1, carryoutconfig);
        #else
    ...
    {
        #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
        MCWDT_CONFIG(base) = _CLR_SET_FLD32U(MCWDT_CONFIG(base), MCWDT_MAIN_MCWDT_CONFIG_WDT_CARRY1_2, carryoutconfig);
        #else
...
__STATIC_INLINE bool Cy_MCWDT_GetCascadeCarryOutRollOver(MCWDT_STRUCT_Type const *base, cy_en_mcwdtcascade_t counter)
{
    ...
    switch (counter)
    {
        case CY_MCWDT_CASCADE_C0C1:
            #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
            countVal = _FLD2BOOL(MCWDT_MAIN_MCWDT_CONFIG_WDT_CARRY0_1, MCWDT_CONFIG(base));
            #else
        ...
        case CY_MCWDT_CASCADE_C1C2:
            #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
            countVal = _FLD2BOOL(MCWDT_MAIN_MCWDT_CONFIG_WDT_CARRY1_2, MCWDT_CONFIG(base));
            #else
...
__STATIC_INLINE void Cy_MCWDT_SetCascadeMatchCombined(MCWDT_STRUCT_Type *base, cy_en_mcwdtcascade_t counter, bool matchconfig)
{
    ...
    {
        #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
        MCWDT_CONFIG(base) = _CLR_SET_FLD32U(MCWDT_CONFIG(base), MCWDT_MAIN_MCWDT_CONFIG_WDT_MATCH0_1, matchconfig);
        #else
    ...
    {
        #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
        MCWDT_CONFIG(base) = _CLR_SET_FLD32U(MCWDT_CONFIG(base), MCWDT_MAIN_MCWDT_CONFIG_WDT_MATCH1_2, matchconfig);
        #else
...
__STATIC_INLINE bool Cy_MCWDT_GetCascadeMatchCombined(MCWDT_STRUCT_Type const *base, cy_en_mcwdtcascade_t counter)
{
    ...
    switch (counter)
    {
        case CY_MCWDT_CASCADE_C0C1:
            #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
            countVal = _FLD2BOOL(MCWDT_MAIN_MCWDT_CONFIG_WDT_MATCH0_1, MCWDT_CONFIG(base));
            #else
        ...
        case CY_MCWDT_CASCADE_C1C2:
            #if (defined (CY_IP_MXS22SRSS) && (CY_IP_MXS22SRSS_VERSION == 2))
            countVal = _FLD2BOOL(MCWDT_MAIN_MCWDT_CONFIG_WDT_MATCH1_2, MCWDT_CONFIG(base));
            #else

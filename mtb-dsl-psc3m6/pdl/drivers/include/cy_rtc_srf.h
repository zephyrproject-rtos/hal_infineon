...
*   \defgroup group_rtc_srf_macros          Macros
*   \defgroup group_rtc_srf_enums           Enums
*   \defgroup group_rtc_srf_data_structures Data Structures
*/
 ...
 * \ingroup group_rtc_srf_data_structures
 */

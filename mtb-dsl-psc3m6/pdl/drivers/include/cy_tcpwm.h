...
#define CY_TCPWM_ID                     (CY_PDL_DRV_ID(CY_PDL_RSLT_MODULE_TCPWM))
...
#if defined (CY_IP_MXS40TCPWM_VERSION_MINOR) && (CY_IP_MXS40TCPWM_VERSION_MINOR >= 1U)
    CY_TCPWM_OUTPUT_TR_MASK           = 0x07U,   /**< PWM signal for masking the PWM output on another counter */
    CY_TCPWM_OUTPUT_TR_MASK_COMPL     = 0x08U,   /**< Complimentary PWM signal for masking the PWM output on another counter */
#endif /* defined (CY_IP_MXS40TCPWM_VERSION_MINOR) && (CY_IP_MXS40TCPWM_VERSION_MINOR >= 1U) */
#endif /* defined (CY_IP_MXS40TCPWM) || defined (CY_DOXYGEN) */
...
typedef enum
{
    CY_TCPWM_DISABLE_COPY_OR_SWAP               = 0UL,   /**< Reload is disabled. There is no copy or swap enabled.  */
...
#if defined (CY_IP_MXS40TCPWM_VERSION_MINOR) && (CY_IP_MXS40TCPWM_VERSION_MINOR >= 1U)
/*******************************************************************************
* Function Name: Cy_TCPWM_TriggerForMasking
****************************************************************************//**
*
*  SW external event trigger for masking.
*
* \param base
* The pointer to a TCPWM instance.
*
...
*
*******************************************************************************/
__STATIC_INLINE void Cy_TCPWM_TriggerForMasking(TCPWM_Type *base, uint32_t cntNum)
{

        TCPWM_GRP_CNT_TR_CMD(base, TCPWM_GRP_CNT_GET_GRP(cntNum), cntNum) =
                TCPWM_GRP_CNT_TR_CMD_MASK_Msk;
}

/*******************************************************************************
* Function Name: Cy_TCPWM_TriggerDutyCycle_Control
****************************************************************************//**
*
*  SW external event trigger for duty cycle control.
*
* \param base
* The pointer to a TCPWM instance.
*
...
*
*******************************************************************************/
__STATIC_INLINE void Cy_TCPWM_TriggerDutyCycle_Control(TCPWM_Type *base, uint32_t cntNum)
{

        TCPWM_GRP_CNT_TR_CMD(base, TCPWM_GRP_CNT_GET_GRP(cntNum), cntNum) =
                TCPWM_GRP_CNT_TR_CMD_DC_Msk;
}
#endif /* defined (CY_IP_MXS40TCPWM_VERSION_MINOR) && (CY_IP_MXS40TCPWM_VERSION_MINOR >= 1U) */

...
typedef struct cy_stc_tcpwm_motif_quaddec_config
{
    ...
    cy_en_tcpwm_edge_config_t           phase_A_edge_mode;            /**< Sets edge mode for Phase A */
    cy_en_tcpwm_edge_config_t           phase_B_edge_mode;            /**< Sets edge mode for Phase B */
...
__STATIC_INLINE uint16_t Cy_TCPWM_MOTIF_Get_Lowpass_Filter_Status(TCPWM_MOTIF_GRP_MOTIF_Type *base, cy_en_low_pass_filter_number_t lowpass_filter);

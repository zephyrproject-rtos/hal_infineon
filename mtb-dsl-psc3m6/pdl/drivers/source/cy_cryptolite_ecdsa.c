...
cy_stc_cryptolite_ecc_dp_type *Cy_Cryptolite_ECC_GetCurveParams(cy_en_cryptolite_ecc_curve_id_t curveId)
{
    ...
    CY_ALIGN(4) static const uint8_t  eccP192A[CY_CRYPTOLITE_ECC_P192_BYTE_SIZE] =
    {
        0xfcu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu,
        0xfeu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu,
        0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu
    };
    CY_ALIGN(4) static const uint8_t  eccP192B[CY_CRYPTOLITE_ECC_P192_BYTE_SIZE] =
    {
   ...
   CY_ALIGN(4) static const uint8_t  eccP224A[CY_CRYPTOLITE_ECC_P224_BYTE_SIZE] =
    {
        0xfeu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu,
    ...
    CY_ALIGN(4) static const uint8_t  eccP224B[CY_CRYPTOLITE_ECC_P224_BYTE_SIZE] =
    {
   ...
   CY_ALIGN(4) static const uint8_t  eccP256A[CY_CRYPTOLITE_ECC_P256_BYTE_SIZE] =
    {
        0xfcu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu,
        0xffu, 0xffu, 0xffu, 0xffu, 0x00u, 0x00u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
    ...
    CY_ALIGN(4) static const uint8_t  eccP256B[CY_CRYPTOLITE_ECC_P256_BYTE_SIZE] =
    {
    ...
    CY_ALIGN(4) static const uint8_t  eccP384A[CY_CRYPTOLITE_ECC_P384_BYTE_SIZE] =
    {
    ...
    CY_ALIGN(4) static const uint8_t  eccP384B[CY_CRYPTOLITE_ECC_P384_BYTE_SIZE] =
    {
    ...
    CY_ALIGN(4) static const uint8_t  eccP521A[CY_CRYPTOLITE_ECC_P521_BYTE_SIZE] =
    {
        0xfcu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu,
        0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu,
        0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu, 0xffu,
    ...
    CY_ALIGN(4) static const uint8_t  eccP521B[CY_CRYPTOLITE_ECC_P521_BYTE_SIZE] =
    {
...
/*******************************************************************************
* Function Name: Cy_Cryptolite_ECC_Reset
****************************************************************************//*
*
* Reset ECC Context.
*
...
*
*******************************************************************************/
cy_en_cryptolite_status_t Cy_Cryptolite_ECC_Reset(CRYPTOLITE_Type *base,
                            cy_stc_cryptolite_context_ecdsa_t *cfContext)
{
    if(base == NULL || cfContext == NULL)
    {
...
#ifdef CY_CRYPTOLITE_CFG_ECP_DP_SECP521R1_ENABLED
            if(eccDp->id == CY_CRYPTOLITE_ECC_ECP_SECP521R1)
            {
                return CY_CRYPTOLITE_NOT_SUPPORTED;
            }
#endif
                            ...
                            cy_en_cryptolite_sig_verify_result_t *stat, const cy_stc_cryptolite_ecc_key *key)
{
    ...
    cy_en_cryptolite_status_t result = CY_CRYPTOLITE_BAD_PARAMS;
    const cy_stc_cryptolite_ecc_dp_type *eccDp;
    volatile uint32_t stat_check = (uint32_t)CY_CRYPTOLITE_SIG_INVALID;
    volatile uint32_t verification_counter = 0u;
    (void)siglen;
    ...
    if ((sig != NULL) && (hash != NULL) && (0u != hashlen) && (stat != NULL) && (key != NULL) && (cfContext != NULL))
    {
        ...
        result = Cy_Cryptolite_ECC_Reset(base, cfContext);
        if(CY_CRYPTOLITE_SUCCESS != result)
        {
            return result;
        }
        ...
        if (eccDp != NULL)
        {
            ...
            uint32_t bitsize  = eccDp->size;
            uint32_t bytesize = CY_CRYPTOLITE_BYTE_SIZE_OF_BITS(eccDp->size);
            bool isHashZero = false;

            /* Initialize verification result to INVALID */
            *stat = CY_CRYPTOLITE_SIG_INVALID;
            stat_check = (uint32_t)CY_CRYPTOLITE_SIG_INVALID;
            verification_counter++;
            ...
            Cy_Cryptolite_Setnumber(p_s, (uint8_t *)&sig[bytesize], bytesize);

            /* First validation pass */
            if (Cy_Cryptolite_Vu_test_zero(base, vu_struct0, p_r, (uint16_t)bitsize) == true) {
                return CY_CRYPTOLITE_BAD_PARAMS;
            }
            /* Redundant R zero check for Fault attack */
            if (Cy_Cryptolite_Vu_test_zero(base, vu_struct0, p_r, (uint16_t)bitsize) == true) {
                return CY_CRYPTOLITE_BAD_PARAMS;
            }
            verification_counter++;
            ...
            /* Redundant R range check for Fault attack */
            if (Cy_Cryptolite_Vu_test_less_than(base, vu_struct1, p_r, my_P, (uint16_t)bitsize) == false) {
                return CY_CRYPTOLITE_BAD_PARAMS;
            }
            verification_counter++;
            ...
            /* Redundant S zero check for Fault attack */
            if (Cy_Cryptolite_Vu_test_zero(base, vu_struct0, p_s, (uint16_t)bitsize) == true) {
                return CY_CRYPTOLITE_BAD_PARAMS;
            }
            verification_counter++;
            ...
            /* Redundant S range check for Fault attack*/
            if (Cy_Cryptolite_Vu_test_less_than(base, vu_struct1, p_s, my_P, (uint16_t)bitsize) == false) {
                return CY_CRYPTOLITE_BAD_PARAMS;
            }
            verification_counter++;
            ...
            /* First comparison - primary verification */
            if (Cy_Cryptolite_Vu_test_equal(base, vu_struct0, p_s, p_r, (uint16_t)bitsize))
            {
                stat_check = ((uint32_t)CY_CRYPTOLITE_SIG_VALID & 0xFFFFu);
                verification_counter++;
            }
            else
            {
            ...
            if (verification_counter != 8U) {
               *stat = CY_CRYPTOLITE_SIG_INVALID;
               return CY_CRYPTOLITE_SUCCESS;
            }

            /* Second comparison - verification for fault injection protection */
            if (Cy_Cryptolite_Vu_test_equal(base, vu_struct0, p_s, p_r, (uint16_t)bitsize))
            {
                if (stat_check == ((uint32_t)CY_CRYPTOLITE_SIG_VALID & 0xFFFFu))
                {
                    stat_check |= ((uint32_t)CY_CRYPTOLITE_SIG_VALID & 0xFFFF0000u);
                    verification_counter++;
                }
            }
            else
            {
                /* Second comparison failed - return error immediately */
                *stat = CY_CRYPTOLITE_SIG_INVALID;
                return CY_CRYPTOLITE_SUCCESS;
            }

            /* Verify minimum verification steps were performed */
            if (verification_counter == 9U)
            {
                *stat = (cy_en_cryptolite_sig_verify_result_t)stat_check;
                verification_counter++;
            }

            /* Verify minimum verification steps were performed */
            if (verification_counter == 10U)
            {
                result = CY_CRYPTOLITE_SUCCESS;
            }
        }

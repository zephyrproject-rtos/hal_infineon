...
typedef struct {
  ...
  __IOM uint32_t ADFT;                          /*!< 0x00000004 Retention, Hidden */
...
/* INFRA_LPOSC.ADFT */
#define INFRA_LPOSC_ADFT_FSEL_Pos               0UL
#define INFRA_LPOSC_ADFT_FSEL_Msk               0x1UL
#define INFRA_LPOSC_ADFT_ADFT_SEL_Pos           16UL
#define INFRA_LPOSC_ADFT_ADFT_SEL_Msk           0x30000UL
#define INFRA_LPOSC_ADFT_ADFT_EN_Pos            18UL
#define INFRA_LPOSC_ADFT_ADFT_EN_Msk            0x40000UL
/* INFRA_LPOSC.TRIM */

...
#ifndef _CYIP_M0SECCPUSS_STATUS_H_
#define _CYIP_M0SECCPUSS_STATUS_H_
...
/**
  * \brief M0 Secured CPU subsystem (M0SECCPUSS_STATUS)
  */
typedef struct {
...
#endif /* _CYIP_M0SECCPUSS_STATUS_H_ */

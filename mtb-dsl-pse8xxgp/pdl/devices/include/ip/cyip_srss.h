...
typedef struct {
  ...
  __IOM uint32_t STATUS;                        /*!< 0x00000014 DPLL_LP Status Register */
...
typedef struct {
  ...
  __IOM uint32_t PWR_MISCLDO_CTL;               /*!< 0x00001C30 MISCLDO Control Register */
   __IM uint32_t RESERVED33[51];
   __IM uint32_t DECODED_LCS_DATA;              /*!< 0x00001D00 Decoded Life Cycle Stage Data Register */
   __IM uint32_t RESERVED34[259];
...
#define CLK_DPLL_LP_CONFIG4_DCO_SD_EN_Pos       31UL
#define CLK_DPLL_LP_CONFIG4_DCO_SD_EN_Msk       0x80000000UL
/* CLK_DPLL_LP.CONFIG5 */
#define CLK_DPLL_LP_CONFIG5_KI_INT_Pos          0UL
#define CLK_DPLL_LP_CONFIG5_KI_INT_Msk          0xFUL
#define CLK_DPLL_LP_CONFIG5_KI_FRACT_Pos        4UL
#define CLK_DPLL_LP_CONFIG5_KI_FRACT_Msk        0xF0UL
#define CLK_DPLL_LP_CONFIG5_KI_SSCG_Pos         12UL
#define CLK_DPLL_LP_CONFIG5_KI_SSCG_Msk         0xF000UL
#define CLK_DPLL_LP_CONFIG5_KP_INT_Pos          16UL
#define CLK_DPLL_LP_CONFIG5_KP_INT_Msk          0xF0000UL
#define CLK_DPLL_LP_CONFIG5_KP_FRACT_Pos        20UL
#define CLK_DPLL_LP_CONFIG5_KP_FRACT_Msk        0xF00000UL
#define CLK_DPLL_LP_CONFIG5_KP_SSCG_Pos         28UL
#define CLK_DPLL_LP_CONFIG5_KP_SSCG_Msk         0xF0000000UL
/* CLK_DPLL_LP.STATUS */

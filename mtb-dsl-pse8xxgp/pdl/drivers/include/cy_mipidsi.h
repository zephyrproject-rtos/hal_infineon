...
typedef enum {
    CY_MIPI_DSI_V_SYNC_START = 0x01,
    CY_MIPI_DSI_V_SYNC_END = 0x11,
    CY_MIPI_DSI_H_SYNC_START = 0x21,
    CY_MIPI_DSI_H_SYNC_END = 0x31,
    CY_MIPI_DSI_COLOR_MODE_OFF = 0x02,
    CY_MIPI_DSI_COLOR_MODE_ON = 0x12,
    CY_MIPI_DSI_SHUTDOWN_PERIPHERAL = 0x22,
    CY_MIPI_DSI_TURN_ON_PERIPHERAL = 0x32,
    CY_MIPI_DSI_GENERIC_SHORT_WRITE_0_PARAM = 0x03,
    CY_MIPI_DSI_GENERIC_SHORT_WRITE_1_PARAM = 0x13,
    CY_MIPI_DSI_GENERIC_SHORT_WRITE_2_PARAM = 0x23,
    CY_MIPI_DSI_GENERIC_READ_REQUEST_0_PARAM = 0x04,
    CY_MIPI_DSI_GENERIC_READ_REQUEST_1_PARAM = 0x14,
    CY_MIPI_DSI_GENERIC_READ_REQUEST_2_PARAM = 0x24,
    CY_MIPI_DSI_DCS_SHORT_WRITE = 0x05,
    CY_MIPI_DSI_DCS_SHORT_WRITE_PARAM = 0x15,
    CY_MIPI_DSI_DCS_READ = 0x06,
    CY_MIPI_DSI_SET_MAXIMUM_RETURN_PACKET_SIZE = 0x37,
    CY_MIPI_DSI_END_OF_TRANSMISSION = 0x08,
    CY_MIPI_DSI_NULL_PACKET = 0x09,
    CY_MIPI_DSI_BLANKING_PACKET = 0x19,
    CY_MIPI_DSI_GENERIC_LONG_WRITE = 0x29,
    CY_MIPI_DSI_DCS_LONG_WRITE = 0x39,
    CY_MIPI_DSI_LOOSELY_PACKED_PIXEL_STREAM_YCBCR20 = 0x0c,
    CY_MIPI_DSI_PACKED_PIXEL_STREAM_YCBCR24 = 0x1c,
    CY_MIPI_DSI_PACKED_PIXEL_STREAM_YCBCR16 = 0x2c,
    CY_MIPI_DSI_PACKED_PIXEL_STREAM_30 = 0x0d,
    CY_MIPI_DSI_PACKED_PIXEL_STREAM_36 = 0x1d,
    CY_MIPI_DSI_PACKED_PIXEL_STREAM_YCBCR12 = 0x3d,
    CY_MIPI_DSI_PACKED_PIXEL_STREAM_16 = 0x0e,
    CY_MIPI_DSI_PACKED_PIXEL_STREAM_18 = 0x1e,
    CY_MIPI_DSI_PIXEL_STREAM_3BYTE_18 = 0x2e,
    CY_MIPI_DSI_PACKED_PIXEL_STREAM_24 = 0x3e
}cy_en_mipidsi_packet_type_t;

/** MIPI DCS commands */
typedef enum {
    CY_MIPI_DCS_NOP            = 0x00,
    CY_MIPI_DCS_SOFT_RESET        = 0x01,
    CY_MIPI_DCS_GET_COMPRESSION_MODE    = 0x03,
    CY_MIPI_DCS_GET_DISPLAY_ID        = 0x04,
    CY_MIPI_DCS_GET_ERROR_COUNT_ON_DSI    = 0x05,
    CY_MIPI_DCS_GET_RED_CHANNEL    = 0x06,
    CY_MIPI_DCS_GET_GREEN_CHANNEL    = 0x07,
    CY_MIPI_DCS_GET_BLUE_CHANNEL    = 0x08,
    CY_MIPI_DCS_GET_DISPLAY_STATUS    = 0x09,
    CY_MIPI_DCS_GET_POWER_MODE        = 0x0A,
    CY_MIPI_DCS_GET_ADDRESS_MODE    = 0x0B,
    CY_MIPI_DCS_GET_PIXEL_FORMAT    = 0x0C,
    CY_MIPI_DCS_GET_DISPLAY_MODE    = 0x0D,
    CY_MIPI_DCS_GET_SIGNAL_MODE    = 0x0E,
    CY_MIPI_DCS_GET_DIAGNOSTIC_RESULT    = 0x0F,
    CY_MIPI_DCS_ENTER_SLEEP_MODE    = 0x10,
    CY_MIPI_DCS_EXIT_SLEEP_MODE    = 0x11,
    CY_MIPI_DCS_ENTER_PARTIAL_MODE    = 0x12,
    CY_MIPI_DCS_ENTER_NORMAL_MODE    = 0x13,
    CY_MIPI_DCS_GET_IMAGE_CHECKSUM_RGB    = 0x14,
    CY_MIPI_DCS_GET_IMAGE_CHECKSUM_CT    = 0x15,
    CY_MIPI_DCS_EXIT_INVERT_MODE    = 0x20,
    CY_MIPI_DCS_ENTER_INVERT_MODE    = 0x21,
    CY_MIPI_DCS_SET_GAMMA_CURVE    = 0x26,
    CY_MIPI_DCS_SET_DISPLAY_OFF    = 0x28,
    CY_MIPI_DCS_SET_DISPLAY_ON        = 0x29,
    CY_MIPI_DCS_SET_COLUMN_ADDRESS    = 0x2A,
    CY_MIPI_DCS_SET_PAGE_ADDRESS    = 0x2B,
    CY_MIPI_DCS_WRITE_MEMORY_START    = 0x2C,
    CY_MIPI_DCS_WRITE_LUT        = 0x2D,
    CY_MIPI_DCS_READ_MEMORY_START    = 0x2E,
    CY_MIPI_DCS_SET_PARTIAL_ROWS    = 0x30,        /* MIPI DCS 1.02 - MIPI_DCS_SET_PARTIAL_AREA before that */
    CY_MIPI_DCS_SET_PARTIAL_COLUMNS    = 0x31,
    CY_MIPI_DCS_SET_SCROLL_AREA    = 0x33,
    CY_MIPI_DCS_SET_TEAR_OFF        = 0x34,
    CY_MIPI_DCS_SET_TEAR_ON        = 0x35,
    CY_MIPI_DCS_SET_ADDRESS_MODE    = 0x36,
    CY_MIPI_DCS_SET_SCROLL_START    = 0x37,
    CY_MIPI_DCS_EXIT_IDLE_MODE        = 0x38,
    CY_MIPI_DCS_ENTER_IDLE_MODE    = 0x39,
    CY_MIPI_DCS_SET_PIXEL_FORMAT    = 0x3A,
    CY_MIPI_DCS_WRITE_MEMORY_CONTINUE    = 0x3C,
    CY_MIPI_DCS_SET_3D_CONTROL        = 0x3D,
    CY_MIPI_DCS_READ_MEMORY_CONTINUE    = 0x3E,
    CY_MIPI_DCS_GET_3D_CONTROL        = 0x3F,
    CY_MIPI_DCS_SET_VSYNC_TIMING    = 0x40,
    CY_MIPI_DCS_SET_TEAR_SCANLINE    = 0x44,
    CY_MIPI_DCS_GET_SCANLINE        = 0x45,
    CY_MIPI_DCS_SET_DISPLAY_BRIGHTNESS = 0x51,        /* MIPI DCS 1.3 */
    CY_MIPI_DCS_GET_DISPLAY_BRIGHTNESS = 0x52,        /* MIPI DCS 1.3 */
    CY_MIPI_DCS_WRITE_CONTROL_DISPLAY  = 0x53,        /* MIPI DCS 1.3 */
    CY_MIPI_DCS_GET_CONTROL_DISPLAY    = 0x54,        /* MIPI DCS 1.3 */
    CY_MIPI_DCS_WRITE_POWER_SAVE    = 0x55,        /* MIPI DCS 1.3 */
    CY_MIPI_DCS_GET_POWER_SAVE        = 0x56,        /* MIPI DCS 1.3 */
    CY_MIPI_DCS_SET_CABC_MIN_BRIGHTNESS = 0x5E,    /* MIPI DCS 1.3 */
    CY_MIPI_DCS_GET_CABC_MIN_BRIGHTNESS = 0x5F,    /* MIPI DCS 1.3 */
    CY_MIPI_DCS_READ_DDB_START        = 0xA1,
    CY_MIPI_DCS_READ_PPS_START        = 0xA2,
    CY_MIPI_DCS_READ_DDB_CONTINUE    = 0xA8,
    CY_MIPI_DCS_READ_PPS_CONTINUE    = 0xA9,

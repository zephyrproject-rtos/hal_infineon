 ...
 * CY_PDL_SYSPM_OP_HIBWAKEPREP: CYCFG_PPC_SECURED_SRSS_MAIN/CYCFG_PPC_SECURED_SRSS_HIB_DATA
 */
...
typedef enum
{
    ...
    CY_PDL_SYSPM_OP_SETDSOFFTOKEN,          /**< Cy_SysPm_SetDeepSleepOffToken */
    CY_PDL_SYSPM_OP_HIBWAKEPREP,            /**< Cy_SysPm_HibernateWakePrepare */

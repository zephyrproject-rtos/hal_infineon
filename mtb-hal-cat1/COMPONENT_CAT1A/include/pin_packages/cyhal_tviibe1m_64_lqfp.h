/***************************************************************************//**
* \file cyhal_tviibe1m_64_lqfp.h
*
* \brief
* TVIIBE1M device GPIO HAL header for 64-LQFP package
*
********************************************************************************
* \copyright
...
#ifndef _CYHAL_TVIIBE1M_64_LQFP_H_
#define _CYHAL_TVIIBE1M_64_LQFP_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_tviibe1m_64_lqfp TVIIBE1M 64-LQFP
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_en[5];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_rx[8];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_tx[7];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line[49];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[50];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_tr_one_cnt_in[92];
...
#endif /* _CYHAL_TVIIBE1M_64_LQFP_H_ */

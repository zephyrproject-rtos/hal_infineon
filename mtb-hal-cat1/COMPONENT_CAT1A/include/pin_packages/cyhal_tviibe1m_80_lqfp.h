/***************************************************************************//**
* \file cyhal_tviibe1m_80_lqfp.h
*
* \brief
* TVIIBE1M device GPIO HAL header for 80-LQFP package
*
********************************************************************************
* \copyright
...
#ifndef _CYHAL_TVIIBE1M_80_LQFP_H_
#define _CYHAL_TVIIBE1M_80_LQFP_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_tviibe1m_80_lqfp TVIIBE1M 80-LQFP
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the TVIIBE1M 80-LQFP package.
 */
...
/** Definitions for all of the pins that are bonded out on in the 80-LQFP package for the TVIIBE1M series. */
typedef enum {
...
} cyhal_gpio_tviibe1m_80_lqfp_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_tviibe1m_80_lqfp_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_canfd_ttcan_rx[8];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_en[8];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_tx[8];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_tr_one_cnt_in[122];
...
#endif /* _CYHAL_TVIIBE1M_80_LQFP_H_ */

/***************************************************************************//**
* \file cyhal_tviibe2m_176_lqfp.h
*
* \brief
* TVIIBE2M device GPIO HAL header for 176-LQFP package
*
********************************************************************************
* \copyright
...
#ifndef _CYHAL_TVIIBE2M_176_LQFP_H_
#define _CYHAL_TVIIBE2M_176_LQFP_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_tviibe2m_176_lqfp TVIIBE2M 176-LQFP
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the TVIIBE2M 176-LQFP package.
 */
...
/** Definitions for all of the pins that are bonded out on in the 176-LQFP package for the TVIIBE2M series. */
typedef enum {
...
} cyhal_gpio_tviibe2m_176_lqfp_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_tviibe2m_176_lqfp_t cyhal_gpio_t;
...
#endif /* _CYHAL_TVIIBE2M_176_LQFP_H_ */

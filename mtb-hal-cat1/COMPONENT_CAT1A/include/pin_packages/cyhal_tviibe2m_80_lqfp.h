...
#ifndef _CYHAL_TVIIBE2M_80_LQFP_H_
#define _CYHAL_TVIIBE2M_80_LQFP_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_tviibe2m_80_lqfp TVIIBE2M 80-LQFP
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the TVIIBE2M 80-LQFP package.
 */
...
/** Definitions for all of the pins that are bonded out on in the 80-LQFP package for the TVIIBE2M series. */
typedef enum {
...
} cyhal_gpio_tviibe2m_80_lqfp_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_tviibe2m_80_lqfp_t cyhal_gpio_t;
...
#endif /* _CYHAL_TVIIBE2M_80_LQFP_H_ */

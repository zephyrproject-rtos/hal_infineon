...
#ifndef _CYHAL_TVIIBE4M_64_LQFP_H_
#define _CYHAL_TVIIBE4M_64_LQFP_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_tviibe4m_64_lqfp TVIIBE4M 64-LQFP
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the TVIIBE4M 64-LQFP package.
 */
...
/** Definitions for all of the pins that are bonded out on in the 64-LQFP package for the TVIIBE4M series. */
typedef enum {
...
} cyhal_gpio_tviibe4m_64_lqfp_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_tviibe4m_64_lqfp_t cyhal_gpio_t;
...
#endif /* _CYHAL_TVIIBE4M_64_LQFP_H_ */

/***************************************************************************//**
* \file cyhal_tviibe4m_80_lqfp.h
*
* \brief
* TVIIBE4M device GPIO HAL header for 80-LQFP package
*
********************************************************************************
* \copyright
...
#ifndef _CYHAL_TVIIBE4M_80_LQFP_H_
#define _CYHAL_TVIIBE4M_80_LQFP_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_tviibe4m_80_lqfp TVIIBE4M 80-LQFP
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the TVIIBE4M 80-LQFP package.
 */
...
/** Definitions for all of the pins that are bonded out on in the 80-LQFP package for the TVIIBE4M series. */
typedef enum {
...
} cyhal_gpio_tviibe4m_80_lqfp_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_tviibe4m_80_lqfp_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_canfd_ttcan_rx[9];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_canfd_ttcan_tx[9];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_cpuss_trace_data[6];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_cxpi_cxpi_en[3];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_cxpi_cxpi_tx[3];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_rx[13];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_tx[11];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_sar_ext_mux_sel[4];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_sarmux_pads[34];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_peri_tr_io_input[12];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_miso[9];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_s_miso[9];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line[67];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[67];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_tr_one_cnt_in[126];
...
#endif /* _CYHAL_TVIIBE4M_80_LQFP_H_ */

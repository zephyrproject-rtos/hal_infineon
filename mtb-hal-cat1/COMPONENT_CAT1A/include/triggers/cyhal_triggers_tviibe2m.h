/***************************************************************************//**
* \file cyhal_triggers_tviibe2m.h
*
* \brief
* TVIIBE2M family HAL triggers header
*
********************************************************************************
* \copyright
...
#ifndef _CYHAL_TRIGGERS_TVIIBE2M_H_
#define _CYHAL_TRIGGERS_TVIIBE2M_H_

/**
 * \addtogroup group_hal_impl_triggers_tviibe2m TVIIBE2M
 * \ingroup group_hal_impl_triggers
 * \{
 * Trigger connections for tviibe2m
 */
...
} _cyhal_trigger_source_tviibe2m_t;

/** Typedef for internal device family specific trigger source to generic trigger source */
typedef _cyhal_trigger_source_tviibe2m_t cyhal_internal_source_t;

/** @brief Get a public source signal type (cyhal_trigger_source_tviibe2m_t) given an internal source signal and signal type */
#define _CYHAL_TRIGGER_CREATE_SOURCE(src, type)    ((src) << 1 | (type))
/** @brief Get an internal source signal (_cyhal_trigger_source_tviibe2m_t) given a public source signal. */
...
} cyhal_trigger_source_tviibe2m_t;

/** Typedef from device family specific trigger source to generic trigger source */
typedef cyhal_trigger_source_tviibe2m_t cyhal_source_t;
...
} cyhal_trigger_dest_tviibe2m_t;

/** Typedef from device family specific trigger dest to generic trigger dest */
typedef cyhal_trigger_dest_tviibe2m_t cyhal_dest_t;
...
extern const _cyhal_trigger_source_tviibe2m_t* cyhal_mux_to_sources [22];
...
#endif /* __cplusplus */
/** \} group_hal_impl_triggers_tviibe2m */
#endif /* _CYHAL_TRIGGERS_TVIIBE2M_H_ */

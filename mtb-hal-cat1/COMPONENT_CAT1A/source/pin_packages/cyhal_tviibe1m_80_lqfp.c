...
#if defined(_GPIO_TVIIBE1M_80_LQFP_H_)
#include "pin_packages/cyhal_tviibe1m_80_lqfp.h"

/* Pin connections */
/* Connections for: canfd_ttcan_rx */
const cyhal_resource_pin_mapping_t cyhal_pin_map_canfd_ttcan_rx[8] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_tx[8] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_tr_one_cnt_in[122] = {

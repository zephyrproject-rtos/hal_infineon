/***************************************************************************//**
* \file cyhal_tviibe2m_100_lqfp.c
*
* \brief
* TVIIBE2M device GPIO HAL header for 100-LQFP package
*
********************************************************************************
* \copyright
...
#if defined(_GPIO_TVIIBE2M_100_LQFP_H_)
#include "pin_packages/cyhal_tviibe2m_100_lqfp.h"

/* Pin connections */
/* Connections for: canfd_ttcan_rx */
const cyhal_resource_pin_mapping_t cyhal_pin_map_canfd_ttcan_rx[11] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_cxpi_cxpi_en[4] = {
    {0u, 0u, P7_2, P7_2_CXPI0_CXPI_EN0},
    {0u, 1u, P13_2, P13_2_CXPI0_CXPI_EN1},
    {0u, 2u, P13_7, P13_7_CXPI0_CXPI_EN2},
    {0u, 3u, P19_3, P19_3_CXPI0_CXPI_EN3},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_cxpi_cxpi_tx[4] = {
    {0u, 0u, P7_1, P7_1_CXPI0_CXPI_TX0},
    {0u, 1u, P13_1, P13_1_CXPI0_CXPI_TX1},
    {0u, 2u, P13_6, P13_6_CXPI0_CXPI_TX2},
    {0u, 3u, P19_2, P19_2_CXPI0_CXPI_TX3},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_rx[16] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_tx[12] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_sarmux_pads[39] = {
    ...
    {0u, 12u, P7_4, HSIOM_SEL_GPIO},
    {0u, 13u, P7_5, HSIOM_SEL_GPIO},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_miso[11] = {
    ...
    {3u, 0u, P17_1, P17_1_SCB3_SPI_MISO},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_mosi[11] = {
    ...
    {3u, 0u, P17_2, P17_2_SCB3_SPI_MOSI},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line[84] = {
    ...
    {2u, 2u, P17_1, P17_1_TCPWM0_LINE514},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[86] = {
    ...
    {2u, 2u, P17_2, P17_2_TCPWM0_LINE_COMPL514},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_tr_one_cnt_in[158] = {

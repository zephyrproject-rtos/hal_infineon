/***************************************************************************//**
* \file cyhal_tviibe2m_176_lqfp.c
*
* \brief
...
#if defined(_GPIO_TVIIBE2M_176_LQFP_H_)
#include "pin_packages/cyhal_tviibe2m_176_lqfp.h"

/* Pin connections */
/* Connections for: canfd_ttcan_rx */
const cyhal_resource_pin_mapping_t cyhal_pin_map_canfd_ttcan_rx[15] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_cxpi_cxpi_en[8] = {
    {0u, 0u, P7_2, P7_2_CXPI0_CXPI_EN0},
    {0u, 0u, P10_7, P10_7_CXPI0_CXPI_EN0},
    {0u, 1u, P13_2, P13_2_CXPI0_CXPI_EN1},
    {0u, 2u, P13_7, P13_7_CXPI0_CXPI_EN2},
    {0u, 2u, P14_7, P14_7_CXPI0_CXPI_EN2},
    {0u, 1u, P15_2, P15_2_CXPI0_CXPI_EN1},
    {0u, 3u, P19_3, P19_3_CXPI0_CXPI_EN3},
    {0u, 3u, P20_7, P20_7_CXPI0_CXPI_EN3},
};

/* Connections for: cxpi_cxpi_rx */
const cyhal_resource_pin_mapping_t cyhal_pin_map_cxpi_cxpi_rx[8] = {
    {0u, 0u, P7_0, P7_0_CXPI0_CXPI_RX0},
    {0u, 0u, P10_5, P10_5_CXPI0_CXPI_RX0},
    {0u, 1u, P13_0, P13_0_CXPI0_CXPI_RX1},
    {0u, 2u, P13_5, P13_5_CXPI0_CXPI_RX2},
    {0u, 2u, P14_5, P14_5_CXPI0_CXPI_RX2},
    {0u, 1u, P15_0, P15_0_CXPI0_CXPI_RX1},
    {0u, 3u, P19_1, P19_1_CXPI0_CXPI_RX3},
    {0u, 3u, P20_5, P20_5_CXPI0_CXPI_RX3},
};

/* Connections for: cxpi_cxpi_tx */
const cyhal_resource_pin_mapping_t cyhal_pin_map_cxpi_cxpi_tx[8] = {
    {0u, 0u, P7_1, P7_1_CXPI0_CXPI_TX0},
    {0u, 0u, P10_6, P10_6_CXPI0_CXPI_TX0},
    {0u, 1u, P13_1, P13_1_CXPI0_CXPI_TX1},
    {0u, 2u, P13_6, P13_6_CXPI0_CXPI_TX2},
    {0u, 2u, P14_6, P14_6_CXPI0_CXPI_TX2},
    {0u, 1u, P15_1, P15_1_CXPI0_CXPI_TX1},
    {0u, 3u, P19_2, P19_2_CXPI0_CXPI_TX3},
    {0u, 3u, P20_6, P20_6_CXPI0_CXPI_TX3},
};

/* Connections for: lin_lin_en */
const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_en[21] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_sarmux_pads[64] = {
    ...
    {0u, 14u, P7_6, HSIOM_SEL_GPIO},
    {0u, 15u, P7_7, HSIOM_SEL_GPIO},
    {0u, 16u, P8_1, HSIOM_SEL_GPIO},
    {0u, 17u, P8_2, HSIOM_SEL_GPIO},
    {0u, 18u, P8_3, HSIOM_SEL_GPIO},
    {0u, 19u, P8_4, HSIOM_SEL_GPIO},
    {0u, 20u, P9_0, HSIOM_SEL_GPIO},
    {0u, 21u, P9_1, HSIOM_SEL_GPIO},
    {0u, 22u, P9_2, HSIOM_SEL_GPIO},
    {0u, 23u, P9_3, HSIOM_SEL_GPIO},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_mosi[16] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_select1[15] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_s_mosi[16] = {
    {0u, 0u, P0_1, P0_1_SCB0_SPI_MOSI},
    {0u, 0u, P1_1, P1_1_SCB0_SPI_MOSI},
    {7u, 0u, P2_1, P2_1_SCB7_SPI_MOSI},
    {6u, 0u, P3_1, P3_1_SCB6_SPI_MOSI},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_s_select1[15] = {
    {0u, 0u, P2_0, P2_0_SCB0_SPI_SELECT1},
    {7u, 0u, P2_4, P2_4_SCB7_SPI_SELECT1},
    {6u, 0u, P3_4, P3_4_SCB6_SPI_SELECT1},
    {5u, 0u, P4_4, P4_4_SCB5_SPI_SELECT1},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line[165] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[165] = {

/***************************************************************************//**
* \file cyhal_tviibe4m_64_lqfp.c
*
* \brief
* TVIIBE4M device GPIO HAL header for 64-LQFP package
*
********************************************************************************
* \copyright
...
#if defined(_GPIO_TVIIBE4M_64_LQFP_H_)
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_rx[10] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_tx[9] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line[51] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[51] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_tr_one_cnt_in[94] = {

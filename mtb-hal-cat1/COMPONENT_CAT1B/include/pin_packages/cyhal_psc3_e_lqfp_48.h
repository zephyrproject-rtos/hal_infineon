/***************************************************************************//**
* \file cyhal_psc3_e_lqfp_48.h
*
* \brief
* PSC3 device GPIO HAL header for E-LQFP-48 package
*
********************************************************************************
* \copyright
...
#ifndef _CYHAL_PSC3_E_LQFP_48_H_
#define _CYHAL_PSC3_E_LQFP_48_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_psc3_e_lqfp_48 PSC3 E-LQFP-48
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the PSC3 E-LQFP-48 package.
 */
...
/** Definitions for all of the pins that are bonded out on in the E-LQFP-48 package for the PSC3 series. */
typedef enum {
...
} cyhal_gpio_psc3_e_lqfp_48_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_psc3_e_lqfp_48_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_canfd_ttcan_rx[3];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_canfd_ttcan_tx[3];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_debug600_trace_clock[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_debug600_trace_data[7];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_an_a_pad_aio[6];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_an_b_pad_aio[4];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_mcpass_dclk[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_mcpass_dout[7];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_peri_tr_io_input[29];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_peri_tr_io_output[59];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[12];
...
#endif /* _CYHAL_PSC3_E_LQFP_48_H_ */

...
#ifndef _CYHAL_PSC3_E_LQFP_64_H_
#define _CYHAL_PSC3_E_LQFP_64_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_psc3_e_lqfp_64 PSC3 E-LQFP-64
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the PSC3 E-LQFP-64 package.
 */
...
/** Definitions for all of the pins that are bonded out on in the E-LQFP-64 package for the PSC3 series. */
typedef enum {
...
} cyhal_gpio_psc3_e_lqfp_64_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_psc3_e_lqfp_64_t cyhal_gpio_t;
...
#endif /* _CYHAL_PSC3_E_LQFP_64_H_ */

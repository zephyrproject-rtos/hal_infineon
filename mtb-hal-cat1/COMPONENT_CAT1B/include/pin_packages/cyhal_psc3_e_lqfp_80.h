...
#ifndef _CYHAL_PSC3_E_LQFP_80_H_
#define _CYHAL_PSC3_E_LQFP_80_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_psc3_e_lqfp_80 PSC3 E-LQFP-80
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the PSC3 E-LQFP-80 package.
 */
...
/** Definitions for all of the pins that are bonded out on in the E-LQFP-80 package for the PSC3 series. */
typedef enum {
...
} cyhal_gpio_psc3_e_lqfp_80_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_psc3_e_lqfp_80_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_peri_tr_io_input[50];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_peri_tr_io_output[98];
...
#endif /* _CYHAL_PSC3_E_LQFP_80_H_ */

/***************************************************************************//**
* \file cyhal_psc3_vqfn_48.h
*
* \brief
* PSC3 device GPIO HAL header for VQFN-48 package
*
********************************************************************************
* \copyright
...
#ifndef _CYHAL_PSC3_VQFN_48_H_
#define _CYHAL_PSC3_VQFN_48_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_psc3_vqfn_48 PSC3 VQFN-48
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the PSC3 VQFN-48 package.
 */
...
/** Definitions for all of the pins that are bonded out on in the VQFN-48 package for the PSC3 series. */
typedef enum {
...
} cyhal_gpio_psc3_vqfn_48_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_psc3_vqfn_48_t cyhal_gpio_t;

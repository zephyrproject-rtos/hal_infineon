...
typedef enum
{
    ...
    _CYHAL_TRIGGER_CRYPTO_TR_TRNG_BITSTREAM = 27, //!< crypto.tr_trng_bitstream
    _CYHAL_TRIGGER_IOSS_PERI_TR_IO_INPUT_IN0 = 28, //!< ioss.peri_tr_io_input_in[0]
    _CYHAL_TRIGGER_IOSS_PERI_TR_IO_INPUT_IN1 = 29, //!< ioss.peri_tr_io_input_in[1]
    _CYHAL_TRIGGER_IOSS_PERI_TR_IO_INPUT_IN2 = 30, //!< ioss.peri_tr_io_input_in[2]
    _CYHAL_TRIGGER_IOSS_PERI_TR_IO_INPUT_IN3 = 31, //!< ioss.peri_tr_io_input_in[3]
    _CYHAL_TRIGGER_IOSS_PERI_TR_IO_INPUT_IN4 = 32, //!< ioss.peri_tr_io_input_in[4]
    _CYHAL_TRIGGER_IOSS_PERI_TR_IO_INPUT_IN5 = 33, //!< ioss.peri_tr_io_input_in[5]
    _CYHAL_TRIGGER_IOSS_PERI_TR_IO_INPUT_IN6 = 34, //!< ioss.peri_tr_io_input_in[6]
    _CYHAL_TRIGGER_IOSS_PERI_TR_IO_INPUT_IN7 = 35, //!< ioss.peri_tr_io_input_in[7]
    _CYHAL_TRIGGER_PDM_TR_RX_REQ_ALL = 36, //!< pdm.tr_rx_req_all
    _CYHAL_TRIGGER_PDM_TR_RX_REQ0 = 37, //!< pdm.tr_rx_req[0]
    _CYHAL_TRIGGER_PDM_TR_RX_REQ1 = 38, //!< pdm.tr_rx_req[1]
    _CYHAL_TRIGGER_SCB0_TR_I2C_SCL_FILTERED = 39, //!< scb[0].tr_i2c_scl_filtered
    _CYHAL_TRIGGER_SCB2_TR_I2C_SCL_FILTERED = 40, //!< scb[2].tr_i2c_scl_filtered
    _CYHAL_TRIGGER_SCB0_TR_RX_REQ = 41, //!< scb[0].tr_rx_req
    _CYHAL_TRIGGER_SCB1_TR_RX_REQ = 42, //!< scb[1].tr_rx_req
    _CYHAL_TRIGGER_SCB2_TR_RX_REQ = 43, //!< scb[2].tr_rx_req
    _CYHAL_TRIGGER_SCB0_TR_TX_REQ = 44, //!< scb[0].tr_tx_req
    _CYHAL_TRIGGER_SCB1_TR_TX_REQ = 45, //!< scb[1].tr_tx_req
    _CYHAL_TRIGGER_SCB2_TR_TX_REQ = 46, //!< scb[2].tr_tx_req
    _CYHAL_TRIGGER_SMIF_TR_RX_REQ = 47, //!< smif.tr_rx_req
    _CYHAL_TRIGGER_SMIF_TR_TX_REQ = 48, //!< smif.tr_tx_req
    _CYHAL_TRIGGER_TCPWM0_TR_OUT00 = 49, //!< tcpwm[0].tr_out0[0]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT01 = 50, //!< tcpwm[0].tr_out0[1]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT0256 = 51, //!< tcpwm[0].tr_out0[256]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT0257 = 52, //!< tcpwm[0].tr_out0[257]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT0258 = 53, //!< tcpwm[0].tr_out0[258]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT0259 = 54, //!< tcpwm[0].tr_out0[259]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT0260 = 55, //!< tcpwm[0].tr_out0[260]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT0261 = 56, //!< tcpwm[0].tr_out0[261]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT0262 = 57, //!< tcpwm[0].tr_out0[262]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT10 = 58, //!< tcpwm[0].tr_out1[0]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT11 = 59, //!< tcpwm[0].tr_out1[1]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT1256 = 60, //!< tcpwm[0].tr_out1[256]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT1257 = 61, //!< tcpwm[0].tr_out1[257]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT1258 = 62, //!< tcpwm[0].tr_out1[258]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT1259 = 63, //!< tcpwm[0].tr_out1[259]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT1260 = 64, //!< tcpwm[0].tr_out1[260]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT1261 = 65, //!< tcpwm[0].tr_out1[261]
    _CYHAL_TRIGGER_TCPWM0_TR_OUT1262 = 66, //!< tcpwm[0].tr_out1[262]
    _CYHAL_TRIGGER_TDM_TR_RX_REQ0 = 67, //!< tdm.tr_rx_req[0]
    _CYHAL_TRIGGER_TDM_TR_TX_REQ0 = 68, //!< tdm.tr_tx_req[0]
...
typedef enum
{
    ...
    CYHAL_TRIGGER_CRYPTO_TR_TRNG_BITSTREAM = _CYHAL_TRIGGER_CREATE_SOURCE(_CYHAL_TRIGGER_CRYPTO_TR_TRNG_BITSTREAM, CYHAL_SIGNAL_TYPE_LEVEL), //!< crypto.tr_trng_bitstream

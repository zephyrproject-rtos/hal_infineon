...
#if defined(_GPIO_PSC3_E_LQFP_48_H_)
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_an_a_pad_aio[6] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_an_b_pad_aio[4] = {

/***************************************************************************//**
* \file cyhal_psc3_e_lqfp_80.c
*
* \brief
* PSC3 device GPIO HAL header for E-LQFP-80 package
*
********************************************************************************
* \copyright
...
#if defined(_GPIO_PSC3_E_LQFP_80_H_)
...
/* The actual channel_num has no value to how the connection works. However, the HAL driver needs
   ...
   instead. */
const cyhal_resource_pin_mapping_t cyhal_pin_map_peri_tr_io_input[50] = {
    ...
    {0u, 10u, P3_0, P3_0_PERI_TR_IO_INPUT10},
    {0u, 11u, P3_1, P3_1_PERI_TR_IO_INPUT11},
    {0u, 12u, P3_2, P3_2_PERI_TR_IO_INPUT12},
    {0u, 13u, P3_3, P3_3_PERI_TR_IO_INPUT13},
    ...
    {0u, 35u, P7_5, P7_5_PERI_TR_IO_INPUT35},
    {0u, 36u, P7_6, P7_6_PERI_TR_IO_INPUT36},
    {0u, 37u, P7_7, P7_7_PERI_TR_IO_INPUT37},
    ...
    {0u, 42u, P8_4, P8_4_PERI_TR_IO_INPUT42},
    {0u, 43u, P8_5, P8_5_PERI_TR_IO_INPUT43},
    ...
    {0u, 48u, P9_4, P9_4_PERI_TR_IO_INPUT48},
    {0u, 49u, P9_5, P9_5_PERI_TR_IO_INPUT49},
};
...
/* The actual channel_num has no value to how the connection works. However, the HAL driver needs
   to know the index of the input or output trigger line. Store that in the channel_num field
   instead. */
const cyhal_resource_pin_mapping_t cyhal_pin_map_peri_tr_io_output[98] = {
    ...
    {0u, 10u, P3_0, P3_0_PERI_TR_IO_OUTPUT10},
    {0u, 62u, P3_0, P3_0_PERI_TR_IO_OUTPUT62},
    {0u, 11u, P3_1, P3_1_PERI_TR_IO_OUTPUT11},
    {0u, 63u, P3_1, P3_1_PERI_TR_IO_OUTPUT63},
    {0u, 12u, P3_2, P3_2_PERI_TR_IO_OUTPUT12},
    {0u, 64u, P3_2, P3_2_PERI_TR_IO_OUTPUT64},
    {0u, 13u, P3_3, P3_3_PERI_TR_IO_OUTPUT13},
    {0u, 65u, P3_3, P3_3_PERI_TR_IO_OUTPUT65},
    ...
    {0u, 35u, P7_5, P7_5_PERI_TR_IO_OUTPUT35},
    {0u, 55u, P7_5, P7_5_PERI_TR_IO_OUTPUT55},
    {0u, 36u, P7_6, P7_6_PERI_TR_IO_OUTPUT36},
    {0u, 56u, P7_6, P7_6_PERI_TR_IO_OUTPUT56},
    {0u, 37u, P7_7, P7_7_PERI_TR_IO_OUTPUT37},
    {0u, 57u, P7_7, P7_7_PERI_TR_IO_OUTPUT57},
    ...
    {0u, 42u, P8_4, P8_4_PERI_TR_IO_OUTPUT42},
    {0u, 43u, P8_5, P8_5_PERI_TR_IO_OUTPUT43},
    ...
    {0u, 48u, P9_4, P9_4_PERI_TR_IO_OUTPUT48},
    {0u, 49u, P9_5, P9_5_PERI_TR_IO_OUTPUT49},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_select1[3] = {
    ...
    {5u, 0u, P8_4, P8_4_SCB5_SPI_SELECT1},
    {0u, 0u, P9_4, P9_4_SCB0_SPI_SELECT1},
};

/* Connections for: scb_spi_m_select2 */
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_select2[3] = {
    {2u, 0u, P7_5, P7_5_SCB2_SPI_SELECT2},
    {5u, 0u, P8_5, P8_5_SCB5_SPI_SELECT2},
    {0u, 0u, P9_5, P9_5_SCB0_SPI_SELECT2},
};

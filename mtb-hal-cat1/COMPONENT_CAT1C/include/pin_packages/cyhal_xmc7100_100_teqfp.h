/***************************************************************************//**
* \file cyhal_xmc7100_100_teqfp.h
*
* \brief
...
#ifndef _CYHAL_XMC7100_100_TEQFP_H_
#define _CYHAL_XMC7100_100_TEQFP_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_xmc7100_100_teqfp XMC7100 100-TEQFP
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the XMC7100 100-TEQFP package.
 */
...
/** Definitions for all of the pins that are bonded out on in the 100-TEQFP package for the XMC7100 series. */
typedef enum {
...
} cyhal_gpio_xmc7100_100_teqfp_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_xmc7100_100_teqfp_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_audioss_rx_sck[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_audioss_rx_ws[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_en[12];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_rx[17];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_tx[16];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_sarmux_pads[37];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_tr_one_cnt_in[154];
...
#endif /* _CYHAL_XMC7100_100_TEQFP_H_ */

/***************************************************************************//**
* \file cyhal_xmc7200_272_bga.h
*
* \brief
* XMC7200 device GPIO HAL header for 272-BGA package
*
********************************************************************************
* \copyright
...
#ifndef _CYHAL_XMC7200_272_BGA_H_
#define _CYHAL_XMC7200_272_BGA_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_xmc7200_272_bga XMC7200 272-BGA
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the XMC7200 272-BGA package.
 */
...
/** Definitions for all of the pins that are bonded out on in the 272-BGA package for the XMC7200 series. */
typedef enum {
...
} cyhal_gpio_xmc7200_272_bga_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_xmc7200_272_bga_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_eth_tsu_timer_cmp_val[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_mdc[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_mdio[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_ref_clk[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_rx_clk[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_rx_ctl[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_rxd[8];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_tx_clk[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_tx_ctl[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_txd[8];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_en[38];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_tx[48];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_peri_tr_io_input[46];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_i2c_scl[22];
...
#endif /* _CYHAL_XMC7200_272_BGA_H_ */

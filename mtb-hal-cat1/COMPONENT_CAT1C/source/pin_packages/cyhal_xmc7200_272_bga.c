...
#if defined(_GPIO_XMC7200_272_BGA_H_)
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_eth_tsu_timer_cmp_val[2] = {
    {0u, 0u, P2_3, P2_3_ETH0_ETH_TSU_TIMER_CMP_VAL},
    {1u, 0u, P27_7, P27_7_ETH1_ETH_TSU_TIMER_CMP_VAL},
};

/* Connections for: eth_mdc */
const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_mdc[2] = {
    {0u, 0u, P3_1, P3_1_ETH0_MDC},
    {1u, 0u, P27_6, P27_6_ETH1_MDC},
};

/* Connections for: eth_mdio */
const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_mdio[2] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_rx_clk[2] = {
    {0u, 0u, P23_3, P23_3_ETH0_RX_CLK},
    {1u, 0u, P27_4, P27_4_ETH1_RX_CLK},
};

/* Connections for: eth_rx_ctl */
const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_rx_ctl[2] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_rxd[8] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_tx_clk[2] = {
    {0u, 0u, P18_3, P18_3_ETH0_TX_CLK},
    {1u, 0u, P26_2, P26_2_ETH1_TX_CLK},
};

/* Connections for: eth_tx_ctl */
const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_tx_ctl[2] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_eth_txd[8] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_en[38] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_lin_lin_tx[48] = {
...
/* The actual channel_num has no value to how the connection works. However, the HAL driver needs
   ...
   instead. */
const cyhal_resource_pin_mapping_t cyhal_pin_map_peri_tr_io_input[46] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_i2c_scl[22] = {

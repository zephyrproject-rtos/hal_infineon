...
static inline uint8_t _cyhal_dma_dw_get_block_from_irqn(IRQn_Type irqn)
{
    ...
    if (irqn >= cpuss_interrupts_dw0_0_IRQn && irqn < cpuss_interrupts_dw0_0_IRQn + (IRQn_Type)CYHAL_DMA_DW0_MAX_CONTIGUOUS_IRQ)
        return 0;
#if (CYHAL_DMA_DW0_MAX_CONTIGUOUS_IRQ != CPUSS_DW0_CH_NR)
    if ((irqn >= _CYHAL_DMA_GET_CPUSS_IRQN(0, CYHAL_DMA_DW0_MAX_CONTIGUOUS_IRQ)) &&
        (irqn < (IRQn_Type)(_CYHAL_DMA_GET_CPUSS_IRQN(0, CYHAL_DMA_DW0_MAX_CONTIGUOUS_IRQ) + CPUSS_DW0_CH_NR - CYHAL_DMA_DW0_MAX_CONTIGUOUS_IRQ)))
        return 0;
#endif
#endif
#if (CPUSS_DW1_PRESENT==1)
    if (irqn >= cpuss_interrupts_dw1_0_IRQn && irqn < cpuss_interrupts_dw1_0_IRQn + (IRQn_Type)CYHAL_DMA_DW1_MAX_CONTIGUOUS_IRQ)
        return 1;
#if (CYHAL_DMA_DW1_MAX_CONTIGUOUS_IRQ != CPUSS_DW1_CH_NR)
    if ((irqn >= _CYHAL_DMA_GET_CPUSS_IRQN(1, CYHAL_DMA_DW1_MAX_CONTIGUOUS_IRQ)) &&
        (irqn < (IRQn_Type)(_CYHAL_DMA_GET_CPUSS_IRQN(1, CYHAL_DMA_DW1_MAX_CONTIGUOUS_IRQ) + CPUSS_DW1_CH_NR - CYHAL_DMA_DW1_MAX_CONTIGUOUS_IRQ)))
        return 1;
#endif
#endif
    CY_ASSERT(false);
...
static inline IRQn_Type _cyhal_dma_dw_get_irqn(cyhal_dma_t *obj)
{
    ...
    {
        return (IRQn_Type)((uint8_t)cpuss_interrupts_dw0_0_IRQn + obj->resource.channel_num);
    }
    #if (CYHAL_DMA_DW0_MAX_CONTIGUOUS_IRQ != CPUSS_DW0_CH_NR)
    else if ((obj->resource.block_num == 0 && obj->resource.channel_num < CPUSS_DW0_CH_NR))
    {
        return (IRQn_Type)((uint8_t)_CYHAL_DMA_GET_CPUSS_IRQN(0, CYHAL_DMA_DW0_MAX_CONTIGUOUS_IRQ) + (obj->resource.channel_num - CYHAL_DMA_DW0_MAX_CONTIGUOUS_IRQ));
    }
    #endif
#endif
#if (CPUSS_DW1_PRESENT==1)
    ...
    {
        return (IRQn_Type)((uint8_t)cpuss_interrupts_dw1_0_IRQn + obj->resource.channel_num);
    }
    #if (CYHAL_DMA_DW1_MAX_CONTIGUOUS_IRQ != CPUSS_DW1_CH_NR)
    else if (obj->resource.block_num == 1 && obj->resource.channel_num < CPUSS_DW1_CH_NR)
    {
        return (IRQn_Type)((uint8_t)_CYHAL_DMA_GET_CPUSS_IRQN(1, CYHAL_DMA_DW1_MAX_CONTIGUOUS_IRQ) + (obj->resource.channel_num - CYHAL_DMA_DW1_MAX_CONTIGUOUS_IRQ));
    }
    #endif
#endif
...
cy_rslt_t _cyhal_dma_dw_stage(cyhal_dma_t *obj)
{
    ...
    IRQn_Type irqn = _cyhal_dma_dw_get_irqn(obj);

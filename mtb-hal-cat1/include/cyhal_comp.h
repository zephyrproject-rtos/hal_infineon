...
/** Not supported */
#define CYHAL_COMP_RSLT_ERR_NOT_SUPPORTED                  \
    (CY_RSLT_CREATE_EX(CY_RSLT_TYPE_ERROR, CY_RSLT_MODULE_ABSTRACTION_HAL, CYHAL_RSLT_MODULE_COMP, 3))
/** Failed to initialize Comp clock */
#define CYHAL_COMP_RSLT_FAILED_CLOCK                     \
    (CY_RSLT_CREATE_EX(CY_RSLT_TYPE_ERROR, CY_RSLT_MODULE_ABSTRACTION_HAL, CYHAL_RSLT_MODULE_COMP, 4))
/** Comparator operation timed out */
#define CYHAL_COMP_RSLT_TIMEOUT                    \
    (CY_RSLT_CREATE_EX(CY_RSLT_TYPE_ERROR, CY_RSLT_MODULE_ABSTRACTION_HAL, CYHAL_RSLT_MODULE_COMP, 5))

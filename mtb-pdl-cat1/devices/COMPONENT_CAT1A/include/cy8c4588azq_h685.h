/***************************************************************************//**
* \file cy8c4588azq_h685.h
*
* \brief
* CY8C4588AZQ-H685 device header
*
********************************************************************************
* \copyright
...
#ifndef _CY8C4588AZQ_H685_H_
#define _CY8C4588AZQ_H685_H_

/**
* \addtogroup group_device CY8C4588AZQ-H685
* \{
*/
...
typedef enum {
  ...
  /* CY8C4588AZQ-H685 User Interrupt Numbers */
  ...
  /* CY8C4588AZQ-H685 Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CY8C4588AZQ-H685 Peripheral Interrupt Numbers */
...
/* CY8C4588AZQ-H685 interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_0_IRQn       =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_2_IRQn       =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #2 */
  ioss_interrupts_gpio_3_IRQn       =   3,      /*!<   3 [DeepSleep] GPIO Port Interrupt #3 */
...
#define CY_IP_MXS40PASS_CTB_VERSION_MINOR 0u
...
#define CY_DEVICE_SERIES_PSOC_4500H
#define CY_SILICON_ID                   0xEAFB120EUL

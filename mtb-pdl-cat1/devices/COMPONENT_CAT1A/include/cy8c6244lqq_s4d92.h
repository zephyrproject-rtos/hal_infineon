/***************************************************************************//**
* \file cy8c6244lqq_s4d92.h
*
* \brief
* CY8C6244LQQ-S4D92 device header
*
********************************************************************************
* \copyright
...
#ifndef _CY8C6244LQQ_S4D92_H_
#define _CY8C6244LQQ_S4D92_H_

/**
* \addtogroup group_device CY8C6244LQQ-S4D92
* \{
*/
...
typedef enum {
  ...
  /* CY8C6244LQQ-S4D92 User Interrupt Numbers */
  ...
  /* CY8C6244LQQ-S4D92 Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CY8C6244LQQ-S4D92 Peripheral Interrupt Numbers */
...
/* CY8C6244LQQ-S4D92 interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_0_IRQn       =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_2_IRQn       =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #2 */
  ioss_interrupts_gpio_3_IRQn       =   3,      /*!<   3 [DeepSleep] GPIO Port Interrupt #3 */
...
#define CY_SILICON_ID                   0xEAD5120EUL

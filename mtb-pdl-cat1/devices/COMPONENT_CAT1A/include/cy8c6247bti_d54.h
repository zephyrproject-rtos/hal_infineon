/***************************************************************************//**
* \file cy8c6247bti_d54.h
*
* \brief
* CY8C6247BTI-D54 device header
*
********************************************************************************
* \copyright
...
#ifndef _CY8C6247BTI_D54_H_
#define _CY8C6247BTI_D54_H_

/**
* \addtogroup group_device CY8C6247BTI-D54
* \{
*/
...
typedef enum {
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CY8C6247BTI-D54 Peripheral Interrupt Numbers */
...
/* CY8C6247BTI-D54 interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_0_IRQn       =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_1_IRQn       =   1,      /*!<   1 [DeepSleep] GPIO Port Interrupt #1 */
  ioss_interrupts_gpio_2_IRQn       =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #2 */
...
#define CY_SILICON_ID                   0xE2702100UL

/***************************************************************************//**
* \file cy8c624alqi_s2d02.h
*
* \brief
* CY8C624ALQI-S2D02 device header
*
********************************************************************************
* \copyright
...
#ifndef _CY8C624ALQI_S2D02_H_
#define _CY8C624ALQI_S2D02_H_

/**
* \addtogroup group_device CY8C624ALQI-S2D02
* \{
*/
...
typedef enum {
  ...
  /* CY8C624ALQI-S2D02 User Interrupt Numbers */
  ...
  /* CY8C624ALQI-S2D02 Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CY8C624ALQI-S2D02 Peripheral Interrupt Numbers */
...
/* CY8C624ALQI-S2D02 interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_0_IRQn       =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_1_IRQn       =   1,      /*!<   1 [DeepSleep] GPIO Port Interrupt #1 */
  ioss_interrupts_gpio_2_IRQn       =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #2 */
...
#define CY_SILICON_ID                   0xE4B11202UL

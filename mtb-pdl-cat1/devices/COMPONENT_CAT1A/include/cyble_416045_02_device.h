/***************************************************************************//**
* \file cyble_416045_02_device.h
*
* \brief
* CYBLE-416045-02-device device header
*
********************************************************************************
* \copyright
...
#ifndef _CYBLE_416045_02_DEVICE_H_
#define _CYBLE_416045_02_DEVICE_H_

/**
* \addtogroup group_device CYBLE-416045-02-device
* \{
*/
...
typedef enum {
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CYBLE-416045-02-device Peripheral Interrupt Numbers */
...
/* CYBLE-416045-02-device interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_0_IRQn       =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_1_IRQn       =   1,      /*!<   1 [DeepSleep] GPIO Port Interrupt #1 */
  ioss_interrupts_gpio_2_IRQn       =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #2 */
...
#define CY_IP_MXUDB_VERSION_MINOR       0u
...
/** \} CYBLE-416045-02-device */

#endif /* _CYBLE_416045_02_DEVICE_H_ */

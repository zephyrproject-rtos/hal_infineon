...
#ifndef _CYS0644AFNI_S2D43_H_
#define _CYS0644AFNI_S2D43_H_

/**
* \addtogroup group_device CYS0644AFNI-S2D43
* \{
*/
...
typedef enum {
  ...
  /* CYS0644AFNI-S2D43 User Interrupt Numbers */
  ...
  /* CYS0644AFNI-S2D43 Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CYS0644AFNI-S2D43 Peripheral Interrupt Numbers */
...
/* CYS0644AFNI-S2D43 interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_0_IRQn       =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_1_IRQn       =   1,      /*!<   1 [DeepSleep] GPIO Port Interrupt #1 */
  ioss_interrupts_gpio_2_IRQn       =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #2 */
...
#define CY_DEVICE_SERIES_PSOC_64
#define CY_DEVICE_SECURE
#define CY_SILICON_ID                   0xE4C01202UL

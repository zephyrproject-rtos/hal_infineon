...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT2BL8BAE User Interrupt Numbers */
  ...
  /* CYT2BL8BAE Internal SW Interrupt Numbers */
...
#define CY_SILICON_ID                   0xEA091108UL
...
#include "gpio_tviibe4m_176_lqfp.h"
...
#define CXPI0_CH2                               ((CXPI_CH_Type*) &CXPI0->CH[2])                                   /* 0x40518200 */
#define CXPI0_CH3                               ((CXPI_CH_Type*) &CXPI0->CH[3])                                   /* 0x40518300 */

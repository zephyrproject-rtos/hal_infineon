/***************************************************************************//**
* \file cyusb2315_bf104axi.h
*
* \brief
* CYUSB2315-BF104AXI device header
*
********************************************************************************
* \copyright
...
#ifndef _CYUSB2315_BF104AXI_H_
#define _CYUSB2315_BF104AXI_H_

/**
* \addtogroup group_device CYUSB2315-BF104AXI
* \{
*/
...
typedef enum {
  ...
  /* CYUSB2315-BF104AXI User Interrupt Numbers */
  ...
  /* CYUSB2315-BF104AXI Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CYUSB2315-BF104AXI Peripheral Interrupt Numbers */
...
/* CYUSB2315-BF104AXI interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_dpslp_0_IRQn =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_dpslp_1_IRQn =   1,      /*!<   1 [DeepSleep] GPIO Port Interrupt #1 */
  ioss_interrupts_gpio_dpslp_4_IRQn =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #4 */
...
#define CY_SILICON_ID                   0xED54111CUL

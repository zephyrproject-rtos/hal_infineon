/***************************************************************************//**
* \file cyusb2318_bf104axi.h
*
* \brief
* CYUSB2318-BF104AXI device header
*
********************************************************************************
* \copyright
...
#ifndef _CYUSB2318_BF104AXI_H_
#define _CYUSB2318_BF104AXI_H_

/**
* \addtogroup group_device CYUSB2318-BF104AXI
* \{
*/
...
typedef enum {
  ...
  /* CYUSB2318-BF104AXI User Interrupt Numbers */
  ...
  /* CYUSB2318-BF104AXI Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CYUSB2318-BF104AXI Peripheral Interrupt Numbers */
...
/* CYUSB2318-BF104AXI interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_dpslp_0_IRQn =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_dpslp_1_IRQn =   1,      /*!<   1 [DeepSleep] GPIO Port Interrupt #1 */
  ioss_interrupts_gpio_dpslp_4_IRQn =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #4 */
...
#define CY_DEVICE_SERIES_FX2G3
#define CY_SILICON_ID                   0xED57111CUL
...
#define SMIF0_BASE                              0x40410000UL
#define SMIF0                                   ((SMIF_Type*) SMIF0_BASE)                                         /* 0x40410000 */
#define SMIF0_DEVICE0                           ((SMIF_DEVICE_Type*) &SMIF0->DEVICE[0])                           /* 0x40410800 */
#define SMIF0_DEVICE1                           ((SMIF_DEVICE_Type*) &SMIF0->DEVICE[1])                           /* 0x40410880 */
#define SMIF0_DEVICE2                           ((SMIF_DEVICE_Type*) &SMIF0->DEVICE[2])                           /* 0x40410900 */
#define SMIF0_DEVICE3                           ((SMIF_DEVICE_Type*) &SMIF0->DEVICE[3])                           /* 0x40410980 */

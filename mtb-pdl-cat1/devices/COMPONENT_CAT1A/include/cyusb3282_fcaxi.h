/***************************************************************************//**
* \file cyusb3282_fcaxi.h
*
* \brief
* CYUSB3282-FCAXI device header
*
********************************************************************************
* \copyright
...
#ifndef _CYUSB3282_FCAXI_H_
#define _CYUSB3282_FCAXI_H_

/**
* \addtogroup group_device CYUSB3282-FCAXI
* \{
*/
...
typedef enum {
  ...
  /* CYUSB3282-FCAXI User Interrupt Numbers */
  ...
  /* CYUSB3282-FCAXI Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CYUSB3282-FCAXI Peripheral Interrupt Numbers */
...
/* CYUSB3282-FCAXI interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_dpslp_0_IRQn =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_dpslp_1_IRQn =   1,      /*!<   1 [DeepSleep] GPIO Port Interrupt #1 */
  ioss_interrupts_gpio_dpslp_4_IRQn =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #4 */
...
#define CY_SILICON_ID                   0xED52111CUL

/***************************************************************************//**
* \file cyusb4022_fcaxi.h
*
* \brief
* CYUSB4022-FCAXI device header
*
********************************************************************************
* \copyright
...
#ifndef _CYUSB4022_FCAXI_H_
#define _CYUSB4022_FCAXI_H_

/**
* \addtogroup group_device CYUSB4022-FCAXI
* \{
*/
...
typedef enum {
  ...
  /* CYUSB4022-FCAXI User Interrupt Numbers */
  ...
  /* CYUSB4022-FCAXI Internal SW Interrupt Numbers */
  ...
  PendSV_IRQn                       =  -2,      /*!<  -2 Pendable request for system service */
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
  /* CYUSB4022-FCAXI Peripheral Interrupt Numbers */
...
/* CYUSB4022-FCAXI interrupts that can be routed to the CM0+ NVIC */
typedef enum {
  ioss_interrupts_gpio_dpslp_0_IRQn =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio_dpslp_1_IRQn =   1,      /*!<   1 [DeepSleep] GPIO Port Interrupt #1 */
  ioss_interrupts_gpio_dpslp_4_IRQn =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #4 */
...
#define CY_SILICON_ID                   0xED71111CUL

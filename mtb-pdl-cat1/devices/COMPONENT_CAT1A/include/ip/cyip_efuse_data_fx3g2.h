...
#ifndef _CYIP_EFUSE_DATA_FX3G2_H_
#define _CYIP_EFUSE_DATA_FX3G2_H_
...
typedef struct {
    ...
    uint8_t RESERVED2[8];
    cy_stc_customer_data_t CUSTOMER_DATA[46];
} cy_stc_efuse_data_t;


#endif /* _CYIP_EFUSE_DATA_FX3G2_H_ */

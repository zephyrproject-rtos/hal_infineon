...
#ifndef _CYIP_EPASS_H_
#define _CYIP_EPASS_H_
...
} PASS_SAR_CH_V1_Type;                          /*!< Size = 64 (0x40) */
...
typedef struct {
  ...
  __IOM uint32_t CAL_UPD_CMD;                   /*!< 0x00000098 Calibration update command */
   ...
   __IM uint32_t RESERVED7[382];
        PASS_SAR_CH_V1_Type CH[32];             /*!< 0x00000800 Channel structure */
} PASS_SAR_V1_Type;                             /*!< Size = 4096 (0x1000) */
...
} PASS_EPASS_MMIO_V1_Type;                      /*!< Size = 4096 (0x1000) */

/**
  * \brief Programmable Analog Subsystem for S40E (PASS)
  */
typedef struct {
        PASS_SAR_V1_Type SAR[4];                /*!< 0x00000000 SAR ADC with Sequencer for S40E */
   __IM uint32_t RESERVED[241664];
        PASS_EPASS_MMIO_V1_Type EPASS_MMIO;     /*!< 0x000F0000 PASS top-level MMIO (Generic Triggers) */
} PASS_V1_Type;                                 /*!< Size = 987136 (0xF1000) */

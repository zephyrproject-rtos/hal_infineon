...
#ifndef _CYIP_FLASHC_V2_ECT_H_
#define _CYIP_FLASHC_V2_ECT_H_
...
#define FLASHC_FM_CTL_ECT_V2_SECTION_SIZE       0x00001000UL
...
} FLASHC_FM_CTL_ECT_V2_Type;                    /*!< Size = 4096 (0x1000) */
...
typedef struct {
  ...
  __IOM uint32_t EXT_MS1_BUFF_CTL;              /*!< 0x00000780 External master 1 buffer control */
   __IM uint32_t RESERVED14[14879];
        FLASHC_FM_CTL_ECT_V2_Type FM_CTL_ECT;   /*!< 0x0000F000 Flash Macro Registers */
} FLASHC_V2_Type;                               /*!< Size = 65536 (0x10000) */


/* FLASHC_FM_CTL_ECT.FM_CTL */
#define FLASHC_FM_CTL_ECT_V2_FM_CTL_FM_MODE_Pos 0UL
#define FLASHC_FM_CTL_ECT_V2_FM_CTL_FM_MODE_Msk 0x1FUL
#define FLASHC_FM_CTL_ECT_V2_FM_CTL_EMB_START_Pos 31UL
#define FLASHC_FM_CTL_ECT_V2_FM_CTL_EMB_START_Msk 0x80000000UL
/* FLASHC_FM_CTL_ECT.FM_CODE_MARGIN */
#define FLASHC_FM_CTL_ECT_V2_FM_CODE_MARGIN_MARGIN_DCS_TRIM_Pos 0UL
#define FLASHC_FM_CTL_ECT_V2_FM_CODE_MARGIN_MARGIN_DCS_TRIM_Msk 0x1FFUL
#define FLASHC_FM_CTL_ECT_V2_FM_CODE_MARGIN_MARGIN_DCS_TRIM_EN_Pos 9UL
#define FLASHC_FM_CTL_ECT_V2_FM_CODE_MARGIN_MARGIN_DCS_TRIM_EN_Msk 0x200UL
#define FLASHC_FM_CTL_ECT_V2_FM_CODE_MARGIN_MARGIN_RDREG_TRIM_Pos 10UL
#define FLASHC_FM_CTL_ECT_V2_FM_CODE_MARGIN_MARGIN_RDREG_TRIM_Msk 0xFC00UL
#define FLASHC_FM_CTL_ECT_V2_FM_CODE_MARGIN_MARGIN_PGM_ERS_B_Pos 29UL
#define FLASHC_FM_CTL_ECT_V2_FM_CODE_MARGIN_MARGIN_PGM_ERS_B_Msk 0x20000000UL
#define FLASHC_FM_CTL_ECT_V2_FM_CODE_MARGIN_MARGIN_MODE_RDREG_CHNG_EN_Pos 30UL
#define FLASHC_FM_CTL_ECT_V2_FM_CODE_MARGIN_MARGIN_MODE_RDREG_CHNG_EN_Msk 0x40000000UL
#define FLASHC_FM_CTL_ECT_V2_FM_CODE_MARGIN_MARGIN_MODE_EN_Pos 31UL
#define FLASHC_FM_CTL_ECT_V2_FM_CODE_MARGIN_MARGIN_MODE_EN_Msk 0x80000000UL
/* FLASHC_FM_CTL_ECT.FM_ADDR */
#define FLASHC_FM_CTL_ECT_V2_FM_ADDR_FM_ADDR_Pos 0UL
#define FLASHC_FM_CTL_ECT_V2_FM_ADDR_FM_ADDR_Msk 0xFFFFFFFFUL
/* FLASHC_FM_CTL_ECT.INTR */
#define FLASHC_FM_CTL_ECT_V2_INTR_INTR_Pos      0UL
#define FLASHC_FM_CTL_ECT_V2_INTR_INTR_Msk      0x1UL
/* FLASHC_FM_CTL_ECT.INTR_SET */
#define FLASHC_FM_CTL_ECT_V2_INTR_SET_INTR_SET_Pos 0UL
#define FLASHC_FM_CTL_ECT_V2_INTR_SET_INTR_SET_Msk 0x1UL
/* FLASHC_FM_CTL_ECT.INTR_MASK */
#define FLASHC_FM_CTL_ECT_V2_INTR_MASK_INTR_MASK_Pos 0UL
#define FLASHC_FM_CTL_ECT_V2_INTR_MASK_INTR_MASK_Msk 0x1UL
/* FLASHC_FM_CTL_ECT.INTR_MASKED */
#define FLASHC_FM_CTL_ECT_V2_INTR_MASKED_INTR_MASKED_Pos 0UL
#define FLASHC_FM_CTL_ECT_V2_INTR_MASKED_INTR_MASKED_Msk 0x1UL
/* FLASHC_FM_CTL_ECT.ECC_OVERRIDE */
#define FLASHC_FM_CTL_ECT_V2_ECC_OVERRIDE_ECC_OVERRIDE_SYNDROME_Pos 0UL
#define FLASHC_FM_CTL_ECT_V2_ECC_OVERRIDE_ECC_OVERRIDE_SYNDROME_Msk 0xFFUL
#define FLASHC_FM_CTL_ECT_V2_ECC_OVERRIDE_ECC_OVERRIDE_WORK_Pos 30UL
#define FLASHC_FM_CTL_ECT_V2_ECC_OVERRIDE_ECC_OVERRIDE_WORK_Msk 0x40000000UL
#define FLASHC_FM_CTL_ECT_V2_ECC_OVERRIDE_ECC_OVERRIDE_CODE_Pos 31UL
#define FLASHC_FM_CTL_ECT_V2_ECC_OVERRIDE_ECC_OVERRIDE_CODE_Msk 0x80000000UL
/* FLASHC_FM_CTL_ECT.FM_DATA */
#define FLASHC_FM_CTL_ECT_V2_FM_DATA_FM_DATA_Pos 0UL
#define FLASHC_FM_CTL_ECT_V2_FM_DATA_FM_DATA_Msk 0xFFFFFFFFUL
/* FLASHC_FM_CTL_ECT.BOOKMARK */
#define FLASHC_FM_CTL_ECT_V2_BOOKMARK_BOOKMARK_Pos 0UL
#define FLASHC_FM_CTL_ECT_V2_BOOKMARK_BOOKMARK_Msk 0xFFFFFFFFUL
/* FLASHC_FM_CTL_ECT.MAIN_FLASH_SAFETY */
#define FLASHC_FM_CTL_ECT_V2_MAIN_FLASH_SAFETY_MAINFLASHWRITEENABLE_Pos 0UL
#define FLASHC_FM_CTL_ECT_V2_MAIN_FLASH_SAFETY_MAINFLASHWRITEENABLE_Msk 0x1UL
/* FLASHC_FM_CTL_ECT.STATUS */
#define FLASHC_FM_CTL_ECT_V2_STATUS_PGM_CODE_Pos 0UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_PGM_CODE_Msk 0x1UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_PGM_WORK_Pos 1UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_PGM_WORK_Msk 0x2UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_ERASE_CODE_Pos 2UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_ERASE_CODE_Msk 0x4UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_ERASE_WORK_Pos 3UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_ERASE_WORK_Msk 0x8UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_ERS_SUSPEND_Pos 4UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_ERS_SUSPEND_Msk 0x10UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_BLANK_CHECK_WORK_Pos 5UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_BLANK_CHECK_WORK_Msk 0x20UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_BLANK_CHCEK_PASS_Pos 6UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_BLANK_CHCEK_PASS_Msk 0x40UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_POR_1B_ECC_CORRECTED_Pos 27UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_POR_1B_ECC_CORRECTED_Msk 0x8000000UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_POR_2B_ECC_ERROR_Pos 28UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_POR_2B_ECC_ERROR_Msk 0x10000000UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_NATIVE_POR_Pos 29UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_NATIVE_POR_Msk 0x20000000UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_HANG_Pos    30UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_HANG_Msk    0x40000000UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_BUSY_Pos    31UL
#define FLASHC_FM_CTL_ECT_V2_STATUS_BUSY_Msk    0x80000000UL
/* FLASHC_FM_CTL_ECT.WORK_FLASH_SAFETY */
#define FLASHC_FM_CTL_ECT_V2_WORK_FLASH_SAFETY_WORKFLASHWRITEENABLE_Pos 0UL
#define FLASHC_FM_CTL_ECT_V2_WORK_FLASH_SAFETY_WORKFLASHWRITEENABLE_Msk 0x1UL

...
#ifndef _CYIP_MXPDM_H_
#define _CYIP_MXPDM_H_
...
typedef struct {
  ...
  __IOM uint32_t FIR1_COEFF13;                  /*!< 0x00000174 FIR 1 coefficients 13 */
   __IM uint32_t RESERVED5[8098];
        PDM_CH_V1_Type CH[8];                   /*!< 0x00008000 PDM RX structure */
} PDM_V1_Type;                                  /*!< Size = 34816 (0x8800) */

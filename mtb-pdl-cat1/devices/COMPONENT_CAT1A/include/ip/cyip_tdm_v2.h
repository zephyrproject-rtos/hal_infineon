...
#ifndef _CYIP_TDM_V2_H_
#define _CYIP_TDM_V2_H_
...
#define TDM_TDM_STRUCT_TDM_TX_STRUCT_V2_SECTION_SIZE 0x00000100UL
#define TDM_TDM_STRUCT_TDM_RX_STRUCT_V2_SECTION_SIZE 0x00000100UL
#define TDM_TDM_STRUCT_V2_SECTION_SIZE          0x00000200UL
#define TDM_V2_SECTION_SIZE                     0x00010000UL
...
} TDM_TDM_STRUCT_TDM_TX_STRUCT_V2_Type;         /*!< Size = 256 (0x100) */
...
typedef struct {
  ...
  __IOM uint32_t INTR_RX_MASK;                  /*!< 0x000000C8 Interrupt mask */
   ...
   __IM uint32_t RESERVED4[12];
} TDM_TDM_STRUCT_TDM_RX_STRUCT_V2_Type;         /*!< Size = 256 (0x100) */

/**
  * \brief TDM structure (TDM_TDM_STRUCT)
  */
typedef struct {
        TDM_TDM_STRUCT_TDM_TX_STRUCT_V2_Type TDM_TX_STRUCT; /*!< 0x00000000 TDM TX structure */
        TDM_TDM_STRUCT_TDM_RX_STRUCT_V2_Type TDM_RX_STRUCT; /*!< 0x00000100 TDM RX structure */
} TDM_TDM_STRUCT_V2_Type;                       /*!< Size = 512 (0x200) */
...
typedef struct {
   __IM uint32_t RESERVED[8192];
        TDM_TDM_STRUCT_V2_Type TDM_STRUCT[4];   /*!< 0x00008000 TDM structure */
} TDM_V2_Type;                                  /*!< Size = 34816 (0x8800) */

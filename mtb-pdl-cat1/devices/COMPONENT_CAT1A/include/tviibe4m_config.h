/***************************************************************************//**
* \file tviibe4m_config.h
*
* \brief
* TVIIBE4M device configuration header
*
********************************************************************************
* \copyright
...
#ifndef _TVIIBE4M_CONFIG_H_
#define _TVIIBE4M_CONFIG_H_
...
#define CY_DEVICE_CFG                   (&cy_deviceIpBlockCfgTVIIBE4M)

/* Include IP definitions */
#include "ip/cyip_sflash_tviibe4m.h"
...
#include "ip/cyip_efuse_data_tviibe4m.h"
...
typedef CSV_HF_CSV_V3_Type CSV_HF_CSV_Type;
typedef CSV_HF_V3_Type CSV_HF_Type;
typedef CSV_REF_CSV_V3_Type CSV_REF_CSV_Type;
typedef CSV_REF_V3_Type CSV_REF_Type;
typedef CSV_LF_CSV_V3_Type CSV_LF_CSV_Type;
typedef CSV_LF_V3_Type CSV_LF_Type;
typedef CSV_ILO_CSV_V3_Type CSV_ILO_CSV_Type;
typedef CSV_ILO_V3_Type CSV_ILO_Type;
typedef CLK_PLL400M_V3_Type CLK_PLL400M_Type;
typedef MCWDT_CTR_V3_Type MCWDT_CTR_Type;
typedef MCWDT_V3_Type MCWDT_Type;
typedef WDT_V3_Type WDT_Type;
typedef SRSS_V3_Type SRSS_Type;
typedef BACKUP_V3_Type BACKUP_Type;
...
#define CPUSS_FLASH_SIZE                0x00001000u

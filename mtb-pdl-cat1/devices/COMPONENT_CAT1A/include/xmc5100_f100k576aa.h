/***************************************************************************//**
* XMC5100-F100K576AA device header
*
********************************************************************************
* \copyright
...
#ifndef _XMC5100_F100K576AA_H_
#define _XMC5100_F100K576AA_H_

/**
* \addtogroup group_device XMC5100-F100K576AA
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* XMC5100-F100K576AA User Interrupt Numbers */
  ...
  /* XMC5100-F100K576AA Internal SW Interrupt Numbers */
...
/* XMC5100-F100K576AA peripheral interrupts */
typedef enum {
...
#define CY_DEVICE_XMC5100
#define CY_DEVICE_SERIES_XMC5100
#define CY_SILICON_ID                   0xE35B2301UL
...
#include "xmc5100_config.h"
#include "gpio_xmc5100_100_lqfp.h"

/***************************************************************************//**
* XMC5200-F64K1088AA device header
*
********************************************************************************
* \copyright
...
#ifndef _XMC5200_F64K1088AA_H_
#define _XMC5200_F64K1088AA_H_

/**
* \addtogroup group_device XMC5200-F64K1088AA
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* XMC5200-F64K1088AA User Interrupt Numbers */
  ...
  /* XMC5200-F64K1088AA Internal SW Interrupt Numbers */
...
/* XMC5200-F64K1088AA peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0xE3CB2301UL
...
#include "gpio_xmc5200_64_lqfp.h"

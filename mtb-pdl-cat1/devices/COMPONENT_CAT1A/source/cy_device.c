...
/* The header strategy used with TVIIBE does not bring in some legacy defines required
 * for PSoC6_01 - ignore defining this device family when compiling for TVIIBE. */

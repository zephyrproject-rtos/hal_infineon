...
#ifndef _CYW20829B0_CONFIG_H_
#define _CYW20829B0_CONFIG_H_
...
typedef enum
{
    ...
    TRIG_IN_MUX_0_CRYPTO_TR_TRNG    = 0x00000019u /* crypto.tr_trng_bitstream */
...
typedef enum
{
    ...
    TRIG_IN_MUX_1_CRYPTO_TR_TRNG    = 0x0000011Eu, /* crypto.tr_trng_bitstream */
...
typedef enum
{
    ...
    TRIG_IN_MUX_2_CRYPTO_TR_TRNG    = 0x0000021Eu, /* crypto.tr_trng_bitstream */
...
typedef enum
{
    ...
    TRIG_IN_MUX_3_CRYPTO_TR_TRNG    = 0x0000031Eu, /* crypto.tr_trng_bitstream */
...
typedef enum
{
    ...
    TRIG_IN_MUX_4_CRYPTO_TR_TRNG    = 0x00000426u, /* crypto.tr_trng_bitstream */
...
/* CRYPTO Trigger Types */
#define TRIGGER_TYPE_CRYPTO_TR_TRNG_BITSTREAM   TRIGGER_TYPE_LEVEL
/* LIN Trigger Types */
...
#define CPUSS_RAMC0_PWR_GROUP_NR        4u
...
#define CPUSS_SYSTEM_INT_NR             70u
...
#define CPUSS_CHIP_TOP_RAMC0_SIZE       256u
...
#define MXCM33_SYSTEM_INT_NR            70u
...
#define RAMC_MPC_BLK_IDX_MAX            1u
#define RAMC_MPC_BLK_IDX_WIDTH          1u
#define RAMC_MPC_EXT_PRESENT            0u
#define RAMC_MPC_BLK_IDX_MAX_TIMES_FOUR_PLUS_THREE 7u
...
typedef enum
{
    ...
    PROT_CRYPTO_TRNG                =  85,      /* Address 0x40230100, size 0x00000100 */
    PROT_HSIOM_PRT0_PRT             =  86,      /* Address 0x40400000, size 0x00000008 */
    PROT_HSIOM_PRT1_PRT             =  87,      /* Address 0x40400010, size 0x00000008 */
    PROT_HSIOM_PRT2_PRT             =  88,      /* Address 0x40400020, size 0x00000008 */
    PROT_HSIOM_PRT3_PRT             =  89,      /* Address 0x40400030, size 0x00000008 */
    PROT_HSIOM_PRT4_PRT             =  90,      /* Address 0x40400040, size 0x00000008 */
    PROT_HSIOM_PRT5_PRT             =  91,      /* Address 0x40400050, size 0x00000008 */

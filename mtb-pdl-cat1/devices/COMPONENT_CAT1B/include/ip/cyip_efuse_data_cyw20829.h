/***************************************************************************//**
* \file cyip_efuse_data_cyw20829.h
*
* \brief
...
#ifndef _CYIP_EFUSE_DATA_CYW20829_H_
#define _CYIP_EFUSE_DATA_CYW20829_H_
...
typedef struct {
  ...
  __IOM uint32_t NV_COUNTER;                    /*!< 0x00000034 Anti-rollback (upto 32 updates) */
  __IOM uint32_t OEM_CONFIG;                    /*!< 0x00000038 OEM Key Revocation and SMIF Configuration */
  __IOM uint32_t BLE_RADIO_TRIM;                /*!< 0x0000003C BLE Radio Trim 2 (8 bits), BLE, BLE Access, HCI Mode, BLESS Key
                                                                Revocation */
  ...
  __IOM uint32_t OEM_SECURE_KEY[4];             /*!< 0x00000060 OEM Secure key (16 bytes) or BLE radio trims (based on
                                                                BLE_RADIO_TRIM[25] bit) */
...
#define EFUSE_DATA_NUM_ZEROS_SECURE_KEY_Pos     16UL
#define EFUSE_DATA_NUM_ZEROS_SECURE_KEY_Msk     0xFF0000UL
#define EFUSE_DATA_NUM_ZEROS_UNUSED_3_Pos       24UL
#define EFUSE_DATA_NUM_ZEROS_UNUSED_3_Msk       0xFF000000UL
...
/* EFUSE_DATA.BLE_RADIO_TRIM */
#define EFUSE_DATA_BLE_RADIO_TRIM_OUTPUT_POWER_CAL_1_Pos 0UL
#define EFUSE_DATA_BLE_RADIO_TRIM_OUTPUT_POWER_CAL_1_Msk 0xFFUL
#define EFUSE_DATA_BLE_RADIO_TRIM_BLE_Pos       8UL
#define EFUSE_DATA_BLE_RADIO_TRIM_BLE_Msk       0x300UL
#define EFUSE_DATA_BLE_RADIO_TRIM_BLE_ACCESS_Pos 10UL
#define EFUSE_DATA_BLE_RADIO_TRIM_BLE_ACCESS_Msk 0x400UL
#define EFUSE_DATA_BLE_RADIO_TRIM_HCI_MODE_Pos  11UL
#define EFUSE_DATA_BLE_RADIO_TRIM_HCI_MODE_Msk  0x800UL
#define EFUSE_DATA_BLE_RADIO_TRIM_BLE_KEY_REVOCATION_Pos 12UL
#define EFUSE_DATA_BLE_RADIO_TRIM_BLE_KEY_REVOCATION_Msk 0x1000UL
#define EFUSE_DATA_BLE_RADIO_TRIM_OUTPUT_POWER_CAL_2_Pos 13UL
#define EFUSE_DATA_BLE_RADIO_TRIM_OUTPUT_POWER_CAL_2_Msk 0x6000UL
#define EFUSE_DATA_BLE_RADIO_TRIM_BLE_TRIM_VALID_Pos 15UL
#define EFUSE_DATA_BLE_RADIO_TRIM_BLE_TRIM_VALID_Msk 0x8000UL
#define EFUSE_DATA_BLE_RADIO_TRIM_PKG_Pos       16UL
#define EFUSE_DATA_BLE_RADIO_TRIM_PKG_Msk       0xF0000UL
#define EFUSE_DATA_BLE_RADIO_TRIM_WOUNDING_Pos  20UL
#define EFUSE_DATA_BLE_RADIO_TRIM_WOUNDING_Msk  0x1F00000UL
#define EFUSE_DATA_BLE_RADIO_TRIM_OEM_SECURE_KEY_OR_BLE_RADIO_TRIM_Pos 25UL
#define EFUSE_DATA_BLE_RADIO_TRIM_OEM_SECURE_KEY_OR_BLE_RADIO_TRIM_Msk 0x2000000UL
#define EFUSE_DATA_BLE_RADIO_TRIM_UNUSED_12_Pos 26UL
#define EFUSE_DATA_BLE_RADIO_TRIM_UNUSED_12_Msk 0xFC000000UL
...
/* EFUSE_DATA.OEM_SECURE_KEY */
#define EFUSE_DATA_OEM_SECURE_KEY_OEM_SECURE_KEY_Pos 0UL
#define EFUSE_DATA_OEM_SECURE_KEY_OEM_SECURE_KEY_Msk 0xFFFFFFFFUL
...
#endif /* _CYIP_EFUSE_DATA_CYW20829_H_ */

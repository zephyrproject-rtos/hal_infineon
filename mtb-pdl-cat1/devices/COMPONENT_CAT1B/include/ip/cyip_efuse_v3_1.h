...
#ifndef _CYIP_EFUSE_V3_1_H_
#define _CYIP_EFUSE_V3_1_H_
...
typedef struct {
  ...
  __IOM uint32_t TEST;                          /*!< 0x00000100 Test */
   __IM uint32_t RESERVED1[3];
  __IOM uint32_t CMD;                           /*!< 0x00000110 Command */
  __IOM uint32_t CONFIG;                        /*!< 0x00000114 Config */
   __IM uint32_t RESERVED2[2];
  __IOM uint32_t SEQ_DEFAULT;                   /*!< 0x00000120 Sequencer Default value */
   __IM uint32_t RESERVED3[7];
  __IOM uint32_t SEQ_READ_CTL_0;                /*!< 0x00000140 Sequencer read control 0 */
  __IOM uint32_t SEQ_READ_CTL_1;                /*!< 0x00000144 Sequencer read control 1 */
  __IOM uint32_t SEQ_READ_CTL_2;                /*!< 0x00000148 Sequencer read control 2 */
  __IOM uint32_t SEQ_READ_CTL_3;                /*!< 0x0000014C Sequencer read control 3 */
  __IOM uint32_t SEQ_READ_CTL_4;                /*!< 0x00000150 Sequencer read control 4 */
  __IOM uint32_t SEQ_READ_CTL_5;                /*!< 0x00000154 Sequencer read control 5 */
  __IOM uint32_t SEQ_READ_CTL_6;                /*!< 0x00000158 Sequencer read control 6 */
  __IOM uint32_t SEQ_READ_CTL_7;                /*!< 0x0000015C Sequencer read control 7 */
  __IOM uint32_t SEQ_PROGRAM_CTL_0;             /*!< 0x00000160 Sequencer program control 0 */
  __IOM uint32_t SEQ_PROGRAM_CTL_1;             /*!< 0x00000164 Sequencer program control 1 */
  __IOM uint32_t SEQ_PROGRAM_CTL_2;             /*!< 0x00000168 Sequencer program control 2 */
  __IOM uint32_t SEQ_PROGRAM_CTL_3;             /*!< 0x0000016C Sequencer program control 3 */
  __IOM uint32_t SEQ_PROGRAM_CTL_4;             /*!< 0x00000170 Sequencer program control 4 */
  __IOM uint32_t SEQ_PROGRAM_CTL_5;             /*!< 0x00000174 Sequencer program control 5 */
  __IOM uint32_t SEQ_PROGRAM_CTL_6;             /*!< 0x00000178 Sequencer program control 6 */
  __IOM uint32_t SEQ_PROGRAM_CTL_7;             /*!< 0x0000017C Sequencer program control 7 */
   __IM uint32_t BOOTROW;                       /*!< 0x00000180 Content of Boot Row latches at power-on-reset */
} EFUSE_Type;                                   /*!< Size = 388 (0x184) */


/* EFUSE.CTL */
#define EFUSE_CTL_LOCK_CC312_REGION_Pos         0UL
#define EFUSE_CTL_LOCK_CC312_REGION_Msk         0x1UL
...
/* EFUSE.CONFIG */
#define EFUSE_CONFIG_PGM_32B_EN_Pos             0UL
#define EFUSE_CONFIG_PGM_32B_EN_Msk             0x1UL
/* EFUSE.SEQ_DEFAULT */
...
/* EFUSE.SEQ_READ_CTL_6 */
#define EFUSE_SEQ_READ_CTL_6_CYCLES_Pos         0UL
#define EFUSE_SEQ_READ_CTL_6_CYCLES_Msk         0x3FFUL
#define EFUSE_SEQ_READ_CTL_6_STROBE_A_Pos       16UL
#define EFUSE_SEQ_READ_CTL_6_STROBE_A_Msk       0x10000UL
#define EFUSE_SEQ_READ_CTL_6_STROBE_B_Pos       17UL
#define EFUSE_SEQ_READ_CTL_6_STROBE_B_Msk       0x20000UL
#define EFUSE_SEQ_READ_CTL_6_STROBE_C_Pos       18UL
#define EFUSE_SEQ_READ_CTL_6_STROBE_C_Msk       0x40000UL
#define EFUSE_SEQ_READ_CTL_6_STROBE_D_Pos       19UL
#define EFUSE_SEQ_READ_CTL_6_STROBE_D_Msk       0x80000UL
#define EFUSE_SEQ_READ_CTL_6_STROBE_E_Pos       20UL
#define EFUSE_SEQ_READ_CTL_6_STROBE_E_Msk       0x100000UL
#define EFUSE_SEQ_READ_CTL_6_STROBE_F_Pos       21UL
#define EFUSE_SEQ_READ_CTL_6_STROBE_F_Msk       0x200000UL
#define EFUSE_SEQ_READ_CTL_6_STROBE_G_Pos       22UL
#define EFUSE_SEQ_READ_CTL_6_STROBE_G_Msk       0x400000UL
#define EFUSE_SEQ_READ_CTL_6_DONE_Pos           31UL
#define EFUSE_SEQ_READ_CTL_6_DONE_Msk           0x80000000UL
/* EFUSE.SEQ_READ_CTL_7 */
#define EFUSE_SEQ_READ_CTL_7_CYCLES_Pos         0UL
#define EFUSE_SEQ_READ_CTL_7_CYCLES_Msk         0x3FFUL
#define EFUSE_SEQ_READ_CTL_7_STROBE_A_Pos       16UL
#define EFUSE_SEQ_READ_CTL_7_STROBE_A_Msk       0x10000UL
#define EFUSE_SEQ_READ_CTL_7_STROBE_B_Pos       17UL
#define EFUSE_SEQ_READ_CTL_7_STROBE_B_Msk       0x20000UL
#define EFUSE_SEQ_READ_CTL_7_STROBE_C_Pos       18UL
#define EFUSE_SEQ_READ_CTL_7_STROBE_C_Msk       0x40000UL
#define EFUSE_SEQ_READ_CTL_7_STROBE_D_Pos       19UL
#define EFUSE_SEQ_READ_CTL_7_STROBE_D_Msk       0x80000UL
#define EFUSE_SEQ_READ_CTL_7_STROBE_E_Pos       20UL
#define EFUSE_SEQ_READ_CTL_7_STROBE_E_Msk       0x100000UL
#define EFUSE_SEQ_READ_CTL_7_STROBE_F_Pos       21UL
#define EFUSE_SEQ_READ_CTL_7_STROBE_F_Msk       0x200000UL
#define EFUSE_SEQ_READ_CTL_7_STROBE_G_Pos       22UL
#define EFUSE_SEQ_READ_CTL_7_STROBE_G_Msk       0x400000UL
#define EFUSE_SEQ_READ_CTL_7_DONE_Pos           31UL
#define EFUSE_SEQ_READ_CTL_7_DONE_Msk           0x80000000UL
...
/* EFUSE.SEQ_PROGRAM_CTL_6 */
#define EFUSE_SEQ_PROGRAM_CTL_6_CYCLES_Pos      0UL
#define EFUSE_SEQ_PROGRAM_CTL_6_CYCLES_Msk      0x3FFUL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_A_Pos    16UL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_A_Msk    0x10000UL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_B_Pos    17UL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_B_Msk    0x20000UL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_C_Pos    18UL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_C_Msk    0x40000UL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_D_Pos    19UL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_D_Msk    0x80000UL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_E_Pos    20UL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_E_Msk    0x100000UL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_F_Pos    21UL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_F_Msk    0x200000UL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_G_Pos    22UL
#define EFUSE_SEQ_PROGRAM_CTL_6_STROBE_G_Msk    0x400000UL
#define EFUSE_SEQ_PROGRAM_CTL_6_DONE_Pos        31UL
#define EFUSE_SEQ_PROGRAM_CTL_6_DONE_Msk        0x80000000UL
/* EFUSE.SEQ_PROGRAM_CTL_7 */
#define EFUSE_SEQ_PROGRAM_CTL_7_CYCLES_Pos      0UL
#define EFUSE_SEQ_PROGRAM_CTL_7_CYCLES_Msk      0x3FFUL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_A_Pos    16UL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_A_Msk    0x10000UL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_B_Pos    17UL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_B_Msk    0x20000UL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_C_Pos    18UL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_C_Msk    0x40000UL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_D_Pos    19UL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_D_Msk    0x80000UL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_E_Pos    20UL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_E_Msk    0x100000UL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_F_Pos    21UL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_F_Msk    0x200000UL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_G_Pos    22UL
#define EFUSE_SEQ_PROGRAM_CTL_7_STROBE_G_Msk    0x400000UL
#define EFUSE_SEQ_PROGRAM_CTL_7_DONE_Pos        31UL
#define EFUSE_SEQ_PROGRAM_CTL_7_DONE_Msk        0x80000000UL
/* EFUSE.BOOTROW */
#define EFUSE_BOOTROW_BOOT_ROW_DATA_Pos         0UL
#define EFUSE_BOOTROW_BOOT_ROW_DATA_Msk         0xFFFFFFFFUL


#endif /* _CYIP_EFUSE_V3_1_H_ */

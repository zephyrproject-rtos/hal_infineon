...
#ifndef _CYIP_TCPWM_V3_H_
#define _CYIP_TCPWM_V3_H_
...
typedef struct {
  ...
  __IOM uint32_t PRUNS;                         /*!< 0x00000008 MOTIF run bit set */
   ...
   __IM uint32_t MIDR;                          /*!< 0x00000020 Module Identification register */
...
/* TCPWM_MOTIF_GRP_MOTIF.MIDR */
#define TCPWM_MOTIF_GRP_MOTIF_MIDR_MODR_Pos     0UL
#define TCPWM_MOTIF_GRP_MOTIF_MIDR_MODR_Msk     0xFFUL
#define TCPWM_MOTIF_GRP_MOTIF_MIDR_MODT_Pos     8UL
#define TCPWM_MOTIF_GRP_MOTIF_MIDR_MODT_Msk     0xFF00UL
#define TCPWM_MOTIF_GRP_MOTIF_MIDR_MODN_Pos     16UL
#define TCPWM_MOTIF_GRP_MOTIF_MIDR_MODN_Msk     0xFFFF0000UL

/***************************************************************************//**
* \file psc3p2fds2abq1_s.h
*
* \brief
* PSC3P2FDS2ABQ1 device header with secure MMIO offsets
*
********************************************************************************
* \copyright
...
#ifndef _PSC3P2FDS2ABQ1_S_H_
#define _PSC3P2FDS2ABQ1_S_H_

/**
* \addtogroup group_device PSC3P2FDS2ABQ1
* \{
*/
...
typedef enum {
  ...
  /* PSC3P2FDS2ABQ1 Peripheral Interrupt Numbers */
...
#define CY_SILICON_ID                   0xEE5F1118UL

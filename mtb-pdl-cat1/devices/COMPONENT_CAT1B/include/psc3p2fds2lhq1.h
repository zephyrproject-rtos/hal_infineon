/***************************************************************************//**
* \file psc3p2fds2lhq1.h
*
* \brief
* PSC3P2FDS2LHQ1 device header
*
********************************************************************************
* \copyright
...
#ifndef _PSC3P2FDS2LHQ1_H_
#define _PSC3P2FDS2LHQ1_H_

/**
* \addtogroup group_device PSC3P2FDS2LHQ1
* \{
*/
...
typedef enum {
  ...
  /* PSC3P2FDS2LHQ1 Peripheral Interrupt Numbers */
...
#define CY_DEVICE_SERIES_PSC3P2
#define CY_SILICON_ID                   0xEE5B1118UL

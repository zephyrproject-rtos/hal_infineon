/***************************************************************************//**
* \file psc3p5fds2lgq1_s.h
*
* \brief
* PSC3P5FDS2LGQ1 device header with secure MMIO offsets
*
********************************************************************************
* \copyright
...
#ifndef _PSC3P5FDS2LGQ1_S_H_
#define _PSC3P5FDS2LGQ1_S_H_

/**
* \addtogroup group_device PSC3P5FDS2LGQ1
* \{
*/
...
typedef enum {
  ...
  /* PSC3P5FDS2LGQ1 Peripheral Interrupt Numbers */
...
#define CY_SILICON_ID                   0xEE4B1118UL

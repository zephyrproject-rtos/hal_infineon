...
#ifndef _CYT4DNJBSS_H_
#define _CYT4DNJBSS_H_

/**
* \addtogroup group_device CYT4DNJBSS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT4DNJBSS User Interrupt Numbers */
  ...
  /* CYT4DNJBSS Internal SW Interrupt Numbers */
...
/* CYT4DNJBSS peripheral interrupts */
typedef enum {
...
#define CY_IP_MXJPEGDEC_VERSION_MINOR   0u
...
#define CY_IP_MXVIDEOSS_VERSION_MINOR   0u

#define CY_DEVICE_TVIIC2D6M
#define CY_DEVICE_SERIES_CYT4DN
#define CY_SILICON_ID                   0xE8302206UL
...
#define CSV_HF_CSV8                             ((CSV_HF_CSV_Type*) &SRSS->CSV_HF.CSV[8])                         /* 0x40261480 */
#define CSV_HF_CSV9                             ((CSV_HF_CSV_Type*) &SRSS->CSV_HF.CSV[9])                         /* 0x40261490 */
#define CSV_HF_CSV10                            ((CSV_HF_CSV_Type*) &SRSS->CSV_HF.CSV[10])                        /* 0x402614A0 */
#define CSV_HF_CSV11                            ((CSV_HF_CSV_Type*) &SRSS->CSV_HF.CSV[11])                        /* 0x402614B0 */
#define CSV_HF_CSV12                            ((CSV_HF_CSV_Type*) &SRSS->CSV_HF.CSV[12])                        /* 0x402614C0 */
#define CSV_HF_CSV13                            ((CSV_HF_CSV_Type*) &SRSS->CSV_HF.CSV[13])                        /* 0x402614D0 */
...
#define VIDEOSS0                                ((VIDEOSS_Type*) VIDEOSS0_BASE)                                   /* 0x40A00000 */
#define VIDEOSS0_SUBSS0                         ((VIDEOSS_SUBSS_Type*) &VIDEOSS0->SUBSS[0])                       /* 0x40A00000 */
#define VIDEOSS0_SUBSS0_VIDEOSSCFG              ((VIDEOSS_SUBSS_VIDEOSSCFG_Type*) &VIDEOSS0->SUBSS[0].VIDEOSSCFG) /* 0x40A00000 */
#define VIDEOSS0_SUBSS0_VRAM                    ((VIDEOSS_SUBSS_VRAM_Type*) &VIDEOSS0->SUBSS[0].VRAM)             /* 0x40A00400 */
#define VIDEOSS0_SUBSS0_GFX2D0                  ((VIDEOSS_SUBSS_GFX2D_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0])        /* 0x40A40000 */
#define VIDEOSS0_SUBSS0_GFX2D0_GFX2DCFG         ((VIDEOSS_SUBSS_GFX2D_GFX2DCFG_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].GFX2DCFG) /* 0x40A40000 */
#define VIDEOSS0_SUBSS0_GFX2D0_CMDSEQ           ((VIDEOSS_SUBSS_GFX2D_CMDSEQ_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].CMDSEQ) /* 0x40A50000 */
#define VIDEOSS0_SUBSS0_GFX2D0_BLITENG0         ((VIDEOSS_SUBSS_GFX2D_BLITENG_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].BLITENG[0]) /* 0x40A60000 */
#define VIDEOSS0_SUBSS0_GFX2D0_BLITENG0_BLITENGCFG ((VIDEOSS_SUBSS_GFX2D_BLITENG_BLITENGCFG_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].BLITENG[0].BLITENGCFG) /* 0x40A60000 */
#define VIDEOSS0_SUBSS0_GFX2D0_BLITENG0_FETCHSRC ((VIDEOSS_SUBSS_GFX2D_BLITENG_FETCHSRC_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].BLITENG[0].FETCHSRC) /* 0x40A64000 */
#define VIDEOSS0_SUBSS0_GFX2D0_BLITENG0_FETCHDST ((VIDEOSS_SUBSS_GFX2D_BLITENG_FETCHDST_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].BLITENG[0].FETCHDST) /* 0x40A64400 */
#define VIDEOSS0_SUBSS0_GFX2D0_BLITENG0_FETCHMASK ((VIDEOSS_SUBSS_GFX2D_BLITENG_FETCHMASK_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].BLITENG[0].FETCHMASK) /* 0x40A64800 */
#define VIDEOSS0_SUBSS0_GFX2D0_BLITENG0_ROP     ((VIDEOSS_SUBSS_GFX2D_BLITENG_ROP_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].BLITENG[0].ROP) /* 0x40A65000 */
#define VIDEOSS0_SUBSS0_GFX2D0_BLITENG0_CLUT    ((VIDEOSS_SUBSS_GFX2D_BLITENG_CLUT_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].BLITENG[0].CLUT) /* 0x40A65800 */
#define VIDEOSS0_SUBSS0_GFX2D0_BLITENG0_MATRIX  ((VIDEOSS_SUBSS_GFX2D_BLITENG_MATRIX_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].BLITENG[0].MATRIX) /* 0x40A66000 */
#define VIDEOSS0_SUBSS0_GFX2D0_BLITENG0_GPSCALER ((VIDEOSS_SUBSS_GFX2D_BLITENG_GPSCALER_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].BLITENG[0].GPSCALER) /* 0x40A66400 */
#define VIDEOSS0_SUBSS0_GFX2D0_BLITENG0_BLITBLEND ((VIDEOSS_SUBSS_GFX2D_BLITENG_BLITBLEND_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].BLITENG[0].BLITBLEND) /* 0x40A66800 */
#define VIDEOSS0_SUBSS0_GFX2D0_BLITENG0_STORE   ((VIDEOSS_SUBSS_GFX2D_BLITENG_STORE_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].BLITENG[0].STORE) /* 0x40A66C00 */
#define VIDEOSS0_SUBSS0_GFX2D0_DRAWENG          ((VIDEOSS_SUBSS_GFX2D_DRAWENG_Type*) &VIDEOSS0->SUBSS[0].GFX2D[0].DRAWENG) /* 0x40A70000 */
#define VIDEOSS0_VIDEOIO0                       ((VIDEOSS_VIDEOIO_Type*) &VIDEOSS0->VIDEOIO[0])                   /* 0x40A80000 */
#define VIDEOSS0_VIDEOIO0_SUBIO0                ((VIDEOSS_VIDEOIO_SUBIO_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0])    /* 0x40A80000 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_VIDEOIOCFG     ((VIDEOSS_VIDEOIO_SUBIO_VIDEOIOCFG_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].VIDEOIOCFG) /* 0x40A80000 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_FRAMEDUMP      ((VIDEOSS_VIDEOIO_SUBIO_FRAMEDUMP_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].FRAMEDUMP) /* 0x40A80400 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_CAPENG00       ((VIDEOSS_VIDEOIO_SUBIO_CAPENG0_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].CAPENG0[0]) /* 0x40A81000 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_CAPENG00_FRAMECAP ((VIDEOSS_VIDEOIO_SUBIO_CAPENG0_FRAMECAP_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].CAPENG0[0].FRAMECAP) /* 0x40A81400 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0       ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0]) /* 0x40A90000 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_COMPENGCFG ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_COMPENGCFG_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].COMPENGCFG) /* 0x40A90000 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_CONSTFRAME0 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_CONSTFRAME0_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].CONSTFRAME0) /* 0x40A92000 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_EXTDST0 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_EXTDST0_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].EXTDST0) /* 0x40A92400 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_CONSTFRAME4 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_CONSTFRAME4_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].CONSTFRAME4) /* 0x40A92800 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_EXTDST4 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_EXTDST4_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].EXTDST4) /* 0x40A92C00 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_CONSTFRAME1 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_CONSTFRAME1_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].CONSTFRAME1) /* 0x40A93000 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_EXTDST1 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_EXTDST1_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].EXTDST1) /* 0x40A93400 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_CONSTFRAME5 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_CONSTFRAME5_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].CONSTFRAME5) /* 0x40A93800 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_EXTDST5 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_EXTDST5_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].EXTDST5) /* 0x40A93C00 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_EXTSRC4 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_EXTSRC4_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].EXTSRC4) /* 0x40A94000 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_STORE4 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_STORE4_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].STORE4) /* 0x40A94400 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_FETCHLAYER0 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_FETCHLAYER0_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].FETCHLAYER0) /* 0x40A94800 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_FETCHDECODE4 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_FETCHDECODE4_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].FETCHDECODE4) /* 0x40A94C00 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_FETCHECO4 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_FETCHECO4_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].FETCHECO4) /* 0x40A95000 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_FETCHWARP1 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_FETCHWARP1_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].FETCHWARP1) /* 0x40A95800 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_FETCHECO1 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_FETCHECO1_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].FETCHECO1) /* 0x40A95C00 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_FETCHLAYER1 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_FETCHLAYER1_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].FETCHLAYER1) /* 0x40A96000 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_FETCHDECODE0 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_FETCHDECODE0_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].FETCHDECODE0) /* 0x40A96400 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_GAMMACOR4 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_GAMMACOR4_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].GAMMACOR4) /* 0x40A96800 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_MATRIX4 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_MATRIX4_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].MATRIX4) /* 0x40A96C00 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_GPSCALER4 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_GPSCALER4_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].GPSCALER4) /* 0x40A97000 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_HISTOGRAM4 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_HISTOGRAM4_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].HISTOGRAM4) /* 0x40A97400 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_LAYERBLEND1 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_LAYERBLEND1_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].LAYERBLEND1) /* 0x40A97800 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_LAYERBLEND2 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_LAYERBLEND2_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].LAYERBLEND2) /* 0x40A97C00 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_LAYERBLEND3 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_LAYERBLEND3_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].LAYERBLEND3) /* 0x40A98000 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_LAYERBLEND4 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_LAYERBLEND4_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].LAYERBLEND4) /* 0x40A98400 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_LAYERBLEND5 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_LAYERBLEND5_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].LAYERBLEND5) /* 0x40A98800 */
#define VIDEOSS0_VIDEOIO0_SUBIO0_COMPENG0_EXTSRC8 ((VIDEOSS_VIDEOIO_SUBIO_COMPENG_EXTSRC8_Type*) &VIDEOSS0->VIDEOIO[0].SUBIO[0].COMPENG[0].EXTSRC8) /* 0x40A98C00 */
#define VIDEOSS0_VIDEOIO0_DISENG00              ((VIDEOSS_VIDEOIO_DISENG0_Type*) &VIDEOSS0->VIDEOIO[0].DISENG0[0]) /* 0x40AA0000 */
#define VIDEOSS0_VIDEOIO0_DISENG00_DISENGCFG0   ((VIDEOSS_VIDEOIO_DISENG0_DISENGCFG0_Type*) &VIDEOSS0->VIDEOIO[0].DISENG0[0].DISENGCFG0) /* 0x40AA0000 */
#define VIDEOSS0_VIDEOIO0_DISENG00_SIG0         ((VIDEOSS_VIDEOIO_DISENG0_SIG0_Type*) &VIDEOSS0->VIDEOIO[0].DISENG0[0].SIG0) /* 0x40AA1000 */
#define VIDEOSS0_VIDEOIO0_DISENG00_FRAMEGEN0    ((VIDEOSS_VIDEOIO_DISENG0_FRAMEGEN0_Type*) &VIDEOSS0->VIDEOIO[0].DISENG0[0].FRAMEGEN0) /* 0x40AA2000 */
#define VIDEOSS0_VIDEOIO0_DISENG00_GAMMACOR0    ((VIDEOSS_VIDEOIO_DISENG0_GAMMACOR0_Type*) &VIDEOSS0->VIDEOIO[0].DISENG0[0].GAMMACOR0) /* 0x40AA2400 */
#define VIDEOSS0_VIDEOIO0_DISENG00_DITHER0      ((VIDEOSS_VIDEOIO_DISENG0_DITHER0_Type*) &VIDEOSS0->VIDEOIO[0].DISENG0[0].DITHER0) /* 0x40AA2800 */
#define VIDEOSS0_VIDEOIO0_DISENG00_TCON0        ((VIDEOSS_VIDEOIO_DISENG0_TCON0_Type*) &VIDEOSS0->VIDEOIO[0].DISENG0[0].TCON0) /* 0x40AA3000 */
#define VIDEOSS0_VIDEOIO0_DISENG10              ((VIDEOSS_VIDEOIO_DISENG1_Type*) &VIDEOSS0->VIDEOIO[0].DISENG1[0]) /* 0x40AA4000 */
#define VIDEOSS0_VIDEOIO0_DISENG10_DISENGCFG1   ((VIDEOSS_VIDEOIO_DISENG1_DISENGCFG1_Type*) &VIDEOSS0->VIDEOIO[0].DISENG1[0].DISENGCFG1) /* 0x40AA4000 */
#define VIDEOSS0_VIDEOIO0_DISENG10_SIG1         ((VIDEOSS_VIDEOIO_DISENG1_SIG1_Type*) &VIDEOSS0->VIDEOIO[0].DISENG1[0].SIG1) /* 0x40AA5000 */
#define VIDEOSS0_VIDEOIO0_DISENG10_FRAMEGEN1    ((VIDEOSS_VIDEOIO_DISENG1_FRAMEGEN1_Type*) &VIDEOSS0->VIDEOIO[0].DISENG1[0].FRAMEGEN1) /* 0x40AA6000 */
#define VIDEOSS0_VIDEOIO0_DISENG10_GAMMACOR1    ((VIDEOSS_VIDEOIO_DISENG1_GAMMACOR1_Type*) &VIDEOSS0->VIDEOIO[0].DISENG1[0].GAMMACOR1) /* 0x40AA6400 */
#define VIDEOSS0_VIDEOIO0_DISENG10_DITHER1      ((VIDEOSS_VIDEOIO_DISENG1_DITHER1_Type*) &VIDEOSS0->VIDEOIO[0].DISENG1[0].DITHER1) /* 0x40AA6800 */
#define VIDEOSS0_VIDEOIO0_DISENG10_TCON1        ((VIDEOSS_VIDEOIO_DISENG1_TCON1_Type*) &VIDEOSS0->VIDEOIO[0].DISENG1[0].TCON1) /* 0x40AA7000 */
#define VIDEOSS0_FPDLINK0                       ((VIDEOSS_FPDLINK0_Type*) &VIDEOSS0->FPDLINK0)                    /* 0x40AC0000 */
#define VIDEOSS0_FPDLINK1                       ((VIDEOSS_FPDLINK1_Type*) &VIDEOSS0->FPDLINK1)                    /* 0x40AC8000 */
#define VIDEOSS0_MIPICSI0                       ((VIDEOSS_MIPICSI_Type*) &VIDEOSS0->MIPICSI[0])                   /* 0x40AD0000 */
#define VIDEOSS0_MIPICSI0_MIPICSI_STRUCT        ((VIDEOSS_MIPICSI_MIPICSI_STRUCT_Type*) &VIDEOSS0->MIPICSI[0].MIPICSI_STRUCT) /* 0x40AD0000 */
#define VIDEOSS0_MIPICSI0_MIPICSI_STRUCT_MIPICSI_WRAP ((VIDEOSS_MIPICSI_MIPICSI_STRUCT_MIPICSI_WRAP_Type*) &VIDEOSS0->MIPICSI[0].MIPICSI_STRUCT.MIPICSI_WRAP) /* 0x40AD0000 */
#define VIDEOSS0_MIPICSI0_MIPICSI_STRUCT_MIPICSI_CORE ((VIDEOSS_MIPICSI_MIPICSI_STRUCT_MIPICSI_CORE_Type*) &VIDEOSS0->MIPICSI[0].MIPICSI_STRUCT.MIPICSI_CORE) /* 0x40AD0200 */
#define VIDEOSS0_INFRA0                         ((VIDEOSS_INFRA_Type*) &VIDEOSS0->INFRA[0])                       /* 0x40AF0000 */
#define VIDEOSS0_INFRA0_VRPU                    ((VIDEOSS_INFRA_VRPU_Type*) &VIDEOSS0->INFRA[0].VRPU)             /* 0x40AF0000 */
#define VIDEOSS0_INFRA0_VRPU_VRPU_STRUCT0       ((VIDEOSS_INFRA_VRPU_VRPU_STRUCT_Type*) &VIDEOSS0->INFRA[0].VRPU.VRPU_STRUCT[0]) /* 0x40AF2000 */
#define VIDEOSS0_INFRA0_VRPU_VRPU_STRUCT1       ((VIDEOSS_INFRA_VRPU_VRPU_STRUCT_Type*) &VIDEOSS0->INFRA[0].VRPU.VRPU_STRUCT[1]) /* 0x40AF2040 */
#define VIDEOSS0_INFRA0_VRPU_VRPU_STRUCT2       ((VIDEOSS_INFRA_VRPU_VRPU_STRUCT_Type*) &VIDEOSS0->INFRA[0].VRPU.VRPU_STRUCT[2]) /* 0x40AF2080 */
#define VIDEOSS0_INFRA0_VRPU_VRPU_STRUCT3       ((VIDEOSS_INFRA_VRPU_VRPU_STRUCT_Type*) &VIDEOSS0->INFRA[0].VRPU.VRPU_STRUCT[3]) /* 0x40AF20C0 */
#define VIDEOSS0_INFRA0_VRPU_VRPU_STRUCT4       ((VIDEOSS_INFRA_VRPU_VRPU_STRUCT_Type*) &VIDEOSS0->INFRA[0].VRPU.VRPU_STRUCT[4]) /* 0x40AF2100 */
#define VIDEOSS0_INFRA0_VRPU_VRPU_STRUCT5       ((VIDEOSS_INFRA_VRPU_VRPU_STRUCT_Type*) &VIDEOSS0->INFRA[0].VRPU.VRPU_STRUCT[5]) /* 0x40AF2140 */
#define VIDEOSS0_INFRA0_VRPU_VRPU_STRUCT6       ((VIDEOSS_INFRA_VRPU_VRPU_STRUCT_Type*) &VIDEOSS0->INFRA[0].VRPU.VRPU_STRUCT[6]) /* 0x40AF2180 */
#define VIDEOSS0_INFRA0_VRPU_VRPU_STRUCT7       ((VIDEOSS_INFRA_VRPU_VRPU_STRUCT_Type*) &VIDEOSS0->INFRA[0].VRPU.VRPU_STRUCT[7]) /* 0x40AF21C0 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD0             ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[0]) /* 0x40AF4000 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD1             ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[1]) /* 0x40AF4400 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD2             ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[2]) /* 0x40AF4800 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD3             ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[3]) /* 0x40AF4C00 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD4             ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[4]) /* 0x40AF5000 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD5             ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[5]) /* 0x40AF5400 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD6             ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[6]) /* 0x40AF5800 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD7             ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[7]) /* 0x40AF5C00 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD8             ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[8]) /* 0x40AF6000 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD9             ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[9]) /* 0x40AF6400 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD10            ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[10]) /* 0x40AF6800 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD11            ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[11]) /* 0x40AF6C00 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD12            ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[12]) /* 0x40AF7000 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD13            ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[13]) /* 0x40AF7400 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD14            ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[14]) /* 0x40AF7800 */
#define VIDEOSS0_INFRA0_GFX_MPU_RD15            ((VIDEOSS_INFRA_GFX_MPU_RD_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_RD[15]) /* 0x40AF7C00 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR0             ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[0]) /* 0x40AF8000 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR1             ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[1]) /* 0x40AF8400 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR2             ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[2]) /* 0x40AF8800 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR3             ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[3]) /* 0x40AF8C00 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR4             ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[4]) /* 0x40AF9000 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR5             ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[5]) /* 0x40AF9400 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR6             ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[6]) /* 0x40AF9800 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR7             ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[7]) /* 0x40AF9C00 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR8             ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[8]) /* 0x40AFA000 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR9             ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[9]) /* 0x40AFA400 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR10            ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[10]) /* 0x40AFA800 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR11            ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[11]) /* 0x40AFAC00 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR12            ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[12]) /* 0x40AFB000 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR13            ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[13]) /* 0x40AFB400 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR14            ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[14]) /* 0x40AFB800 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR15            ((VIDEOSS_INFRA_GFX_MPU_WR_Type*) &VIDEOSS0->INFRA[0].GFX_MPU_WR[15]) /* 0x40AFBC00 */
...
#define JPEGDEC                                 ((JPEGDEC_Type*) JPEGDEC_BASE)                                    /* 0x40B10000 */
#define JPEGDEC_HF                              ((JPEGDEC_HF_Type*) &JPEGDEC->HF)                                 /* 0x40B11000 */
#define JPEGDEC_DEC                             ((JPEGDEC_DEC_Type*) &JPEGDEC->DEC)                               /* 0x40B11800 */

/** \} CYT4DNJBSS */

#endif /* _CYT4DNJBSS_H_ */

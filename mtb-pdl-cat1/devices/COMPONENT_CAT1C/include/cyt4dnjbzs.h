...
#ifndef _CYT4DNJBZS_H_
#define _CYT4DNJBZS_H_

/**
* \addtogroup group_device CYT4DNJBZS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT4DNJBZS User Interrupt Numbers */
  ...
  /* CYT4DNJBZS Internal SW Interrupt Numbers */
...
/* CYT4DNJBZS peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0xE8372206UL

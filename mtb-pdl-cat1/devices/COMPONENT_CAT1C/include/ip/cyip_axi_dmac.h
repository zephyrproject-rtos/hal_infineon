...
} AXI_DMAC_CH_Type;                             /*!< Size = 256 (0x100) */
...
typedef struct {
  __IOM uint32_t CTL;                           /*!< 0x00000000 Control */
   ...
   __IM uint32_t ACTIVE_SEC;                    /*!< 0x00000008 Active secure channels */
   __IM uint32_t ACTIVE_NONSEC;                 /*!< 0x0000000C Active non-secure channels */
   __IM uint32_t RESERVED[1020];
        AXI_DMAC_CH_Type CH[8];                 /*!< 0x00001000 AXI DMA controller channel */
} AXI_DMAC_Type;                                /*!< Size = 6144 (0x1800) */

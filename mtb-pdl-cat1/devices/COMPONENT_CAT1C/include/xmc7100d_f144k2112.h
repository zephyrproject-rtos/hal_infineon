/***************************************************************************//**
* \file xmc7100d_f144k2112.h
*
* \brief
* XMC7100D-F144K2112 device header
*
********************************************************************************
* \copyright
...
#ifndef _XMC7100D_F144K2112_H_
#define _XMC7100D_F144K2112_H_

/**
* \addtogroup group_device XMC7100D-F144K2112
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* XMC7100D-F144K2112 User Interrupt Numbers */
  ...
  /* XMC7100D-F144K2112 Internal SW Interrupt Numbers */
...
/* XMC7100D-F144K2112 peripheral interrupts */
typedef enum {
...
#define CY_SRAM_SIZE                    0x00060000UL
...
#define CY_SILICON_ID                   0xE94B1207UL
...
#include "gpio_xmc7100_144_teqfp.h"

/***************************************************************************//**
* \file xmc7200d_e272k8384.h
*
* \brief
* XMC7200D-E272K8384 device header
*
********************************************************************************
* \copyright
...
#ifndef _XMC7200D_E272K8384_H_
#define _XMC7200D_E272K8384_H_

/**
* \addtogroup group_device XMC7200D-E272K8384
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* XMC7200D-E272K8384 User Interrupt Numbers */
  ...
  /* XMC7200D-E272K8384 Internal SW Interrupt Numbers */
...
/* XMC7200D-E272K8384 peripheral interrupts */
typedef enum {
...
#define CY_DEVICE_SERIES_XMC7200
#define CY_SILICON_ID                   0xE5432303UL
...
#include "gpio_xmc7200_272_bga.h"
...
#define PERI_TR_1TO1_GR11                       ((PERI_TR_1TO1_GR_Type*) &PERI->TR_1TO1_GR[11])                   /* 0x4000EC00 */
#define PERI_TR_1TO1_GR12                       ((PERI_TR_1TO1_GR_Type*) &PERI->TR_1TO1_GR[12])                   /* 0x4000F000 */
#define PERI_TR_1TO1_GR13                       ((PERI_TR_1TO1_GR_Type*) &PERI->TR_1TO1_GR[13])                   /* 0x4000F400 */
...
#define PERI_MS_PPU_FX_PROT_MPU9_MAIN           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[59])                     /* 0x400216C0 */
#define PERI_MS_PPU_FX_PROT_MPU10_MAIN          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[60])                     /* 0x40021700 */
#define PERI_MS_PPU_FX_PROT_MPU13_MAIN          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[61])                     /* 0x40021740 */
#define PERI_MS_PPU_FX_PROT_MPU14_MAIN          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[62])                     /* 0x40021780 */
#define PERI_MS_PPU_FX_PROT_MPU15_MAIN          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[63])                     /* 0x400217C0 */
#define PERI_MS_PPU_FX_FLASHC_MAIN              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[64])                     /* 0x40021800 */
#define PERI_MS_PPU_FX_FLASHC_CMD               ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[65])                     /* 0x40021840 */
#define PERI_MS_PPU_FX_FLASHC_DFT               ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[66])                     /* 0x40021880 */
#define PERI_MS_PPU_FX_FLASHC_CM0               ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[67])                     /* 0x400218C0 */
#define PERI_MS_PPU_FX_FLASHC_CM7_0             ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[68])                     /* 0x40021900 */
#define PERI_MS_PPU_FX_FLASHC_CM7_1             ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[69])                     /* 0x40021940 */
#define PERI_MS_PPU_FX_FLASHC_CRYPTO            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[70])                     /* 0x40021980 */
#define PERI_MS_PPU_FX_FLASHC_DW0               ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[71])                     /* 0x400219C0 */
#define PERI_MS_PPU_FX_FLASHC_DW1               ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[72])                     /* 0x40021A00 */
#define PERI_MS_PPU_FX_FLASHC_DMAC              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[73])                     /* 0x40021A40 */
#define PERI_MS_PPU_FX_FLASHC_SLOW0             ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[74])                     /* 0x40021A80 */
...
#define PERI_MS_PPU_FX_DW0_CH_STRUCT100_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[194])                    /* 0x40023880 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT101_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[195])                    /* 0x400238C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT102_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[196])                    /* 0x40023900 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT103_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[197])                    /* 0x40023940 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT104_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[198])                    /* 0x40023980 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT105_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[199])                    /* 0x400239C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT106_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[200])                    /* 0x40023A00 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT107_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[201])                    /* 0x40023A40 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT108_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[202])                    /* 0x40023A80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT109_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[203])                    /* 0x40023AC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT110_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[204])                    /* 0x40023B00 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT111_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[205])                    /* 0x40023B40 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT112_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[206])                    /* 0x40023B80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT113_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[207])                    /* 0x40023BC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT114_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[208])                    /* 0x40023C00 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT115_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[209])                    /* 0x40023C40 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT116_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[210])                    /* 0x40023C80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT117_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[211])                    /* 0x40023CC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT118_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[212])                    /* 0x40023D00 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT119_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[213])                    /* 0x40023D40 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT120_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[214])                    /* 0x40023D80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT121_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[215])                    /* 0x40023DC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT122_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[216])                    /* 0x40023E00 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT123_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[217])                    /* 0x40023E40 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT124_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[218])                    /* 0x40023E80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT125_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[219])                    /* 0x40023EC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT126_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[220])                    /* 0x40023F00 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT127_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[221])                    /* 0x40023F40 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT128_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[222])                    /* 0x40023F80 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT129_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[223])                    /* 0x40023FC0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT130_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[224])                    /* 0x40024000 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT131_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[225])                    /* 0x40024040 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT132_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[226])                    /* 0x40024080 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT133_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[227])                    /* 0x400240C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT134_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[228])                    /* 0x40024100 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT135_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[229])                    /* 0x40024140 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT136_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[230])                    /* 0x40024180 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT137_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[231])                    /* 0x400241C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT138_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[232])                    /* 0x40024200 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT139_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[233])                    /* 0x40024240 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT140_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[234])                    /* 0x40024280 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT141_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[235])                    /* 0x400242C0 */
#define PERI_MS_PPU_FX_DW0_CH_STRUCT142_CH      ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[236])                    /* 0x40024300 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT0_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[237])                    /* 0x40024340 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT1_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[238])                    /* 0x40024380 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT2_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[239])                    /* 0x400243C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT3_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[240])                    /* 0x40024400 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT4_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[241])                    /* 0x40024440 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT5_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[242])                    /* 0x40024480 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT6_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[243])                    /* 0x400244C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT7_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[244])                    /* 0x40024500 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT8_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[245])                    /* 0x40024540 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT9_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[246])                    /* 0x40024580 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT10_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[247])                    /* 0x400245C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT11_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[248])                    /* 0x40024600 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT12_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[249])                    /* 0x40024640 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT13_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[250])                    /* 0x40024680 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT14_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[251])                    /* 0x400246C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT15_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[252])                    /* 0x40024700 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT16_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[253])                    /* 0x40024740 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT17_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[254])                    /* 0x40024780 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT18_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[255])                    /* 0x400247C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT19_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[256])                    /* 0x40024800 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT20_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[257])                    /* 0x40024840 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT21_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[258])                    /* 0x40024880 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT22_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[259])                    /* 0x400248C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT23_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[260])                    /* 0x40024900 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT24_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[261])                    /* 0x40024940 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT25_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[262])                    /* 0x40024980 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT26_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[263])                    /* 0x400249C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT27_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[264])                    /* 0x40024A00 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT28_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[265])                    /* 0x40024A40 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT29_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[266])                    /* 0x40024A80 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT30_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[267])                    /* 0x40024AC0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT31_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[268])                    /* 0x40024B00 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT32_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[269])                    /* 0x40024B40 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT33_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[270])                    /* 0x40024B80 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT34_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[271])                    /* 0x40024BC0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT35_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[272])                    /* 0x40024C00 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT36_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[273])                    /* 0x40024C40 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT37_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[274])                    /* 0x40024C80 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT38_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[275])                    /* 0x40024CC0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT39_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[276])                    /* 0x40024D00 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT40_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[277])                    /* 0x40024D40 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT41_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[278])                    /* 0x40024D80 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT42_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[279])                    /* 0x40024DC0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT43_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[280])                    /* 0x40024E00 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT44_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[281])                    /* 0x40024E40 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT45_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[282])                    /* 0x40024E80 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT46_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[283])                    /* 0x40024EC0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT47_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[284])                    /* 0x40024F00 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT48_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[285])                    /* 0x40024F40 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT49_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[286])                    /* 0x40024F80 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT50_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[287])                    /* 0x40024FC0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT51_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[288])                    /* 0x40025000 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT52_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[289])                    /* 0x40025040 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT53_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[290])                    /* 0x40025080 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT54_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[291])                    /* 0x400250C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT55_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[292])                    /* 0x40025100 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT56_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[293])                    /* 0x40025140 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT57_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[294])                    /* 0x40025180 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT58_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[295])                    /* 0x400251C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT59_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[296])                    /* 0x40025200 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT60_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[297])                    /* 0x40025240 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT61_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[298])                    /* 0x40025280 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT62_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[299])                    /* 0x400252C0 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT63_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[300])                    /* 0x40025300 */
#define PERI_MS_PPU_FX_DW1_CH_STRUCT64_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[301])                    /* 0x40025340 */
#define PERI_MS_PPU_FX_DMAC_TOP                 ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[302])                    /* 0x40025380 */
#define PERI_MS_PPU_FX_DMAC_CH0_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[303])                    /* 0x400253C0 */
#define PERI_MS_PPU_FX_DMAC_CH1_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[304])                    /* 0x40025400 */
#define PERI_MS_PPU_FX_DMAC_CH2_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[305])                    /* 0x40025440 */
#define PERI_MS_PPU_FX_DMAC_CH3_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[306])                    /* 0x40025480 */
#define PERI_MS_PPU_FX_DMAC_CH4_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[307])                    /* 0x400254C0 */
#define PERI_MS_PPU_FX_DMAC_CH5_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[308])                    /* 0x40025500 */
#define PERI_MS_PPU_FX_DMAC_CH6_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[309])                    /* 0x40025540 */
#define PERI_MS_PPU_FX_DMAC_CH7_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[310])                    /* 0x40025580 */
#define PERI_MS_PPU_FX_EFUSE_CTL                ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[311])                    /* 0x400255C0 */
#define PERI_MS_PPU_FX_EFUSE_DATA               ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[312])                    /* 0x40025600 */
#define PERI_MS_PPU_FX_BIST                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[313])                    /* 0x40025640 */
#define PERI_MS_PPU_FX_HSIOM_PRT0_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[314])                    /* 0x40025680 */
#define PERI_MS_PPU_FX_HSIOM_PRT1_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[315])                    /* 0x400256C0 */
#define PERI_MS_PPU_FX_HSIOM_PRT2_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[316])                    /* 0x40025700 */
#define PERI_MS_PPU_FX_HSIOM_PRT3_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[317])                    /* 0x40025740 */
#define PERI_MS_PPU_FX_HSIOM_PRT4_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[318])                    /* 0x40025780 */
#define PERI_MS_PPU_FX_HSIOM_PRT5_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[319])                    /* 0x400257C0 */
#define PERI_MS_PPU_FX_HSIOM_PRT6_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[320])                    /* 0x40025800 */
#define PERI_MS_PPU_FX_HSIOM_PRT7_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[321])                    /* 0x40025840 */
#define PERI_MS_PPU_FX_HSIOM_PRT8_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[322])                    /* 0x40025880 */
#define PERI_MS_PPU_FX_HSIOM_PRT9_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[323])                    /* 0x400258C0 */
#define PERI_MS_PPU_FX_HSIOM_PRT10_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[324])                    /* 0x40025900 */
#define PERI_MS_PPU_FX_HSIOM_PRT11_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[325])                    /* 0x40025940 */
#define PERI_MS_PPU_FX_HSIOM_PRT12_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[326])                    /* 0x40025980 */
#define PERI_MS_PPU_FX_HSIOM_PRT13_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[327])                    /* 0x400259C0 */
#define PERI_MS_PPU_FX_HSIOM_PRT14_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[328])                    /* 0x40025A00 */
#define PERI_MS_PPU_FX_HSIOM_PRT15_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[329])                    /* 0x40025A40 */
#define PERI_MS_PPU_FX_HSIOM_PRT16_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[330])                    /* 0x40025A80 */
#define PERI_MS_PPU_FX_HSIOM_PRT17_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[331])                    /* 0x40025AC0 */
#define PERI_MS_PPU_FX_HSIOM_PRT18_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[332])                    /* 0x40025B00 */
#define PERI_MS_PPU_FX_HSIOM_PRT19_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[333])                    /* 0x40025B40 */
#define PERI_MS_PPU_FX_HSIOM_PRT20_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[334])                    /* 0x40025B80 */
#define PERI_MS_PPU_FX_HSIOM_PRT21_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[335])                    /* 0x40025BC0 */
#define PERI_MS_PPU_FX_HSIOM_PRT22_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[336])                    /* 0x40025C00 */
#define PERI_MS_PPU_FX_HSIOM_PRT23_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[337])                    /* 0x40025C40 */
#define PERI_MS_PPU_FX_HSIOM_PRT24_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[338])                    /* 0x40025C80 */
#define PERI_MS_PPU_FX_HSIOM_PRT25_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[339])                    /* 0x40025CC0 */
#define PERI_MS_PPU_FX_HSIOM_PRT26_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[340])                    /* 0x40025D00 */
#define PERI_MS_PPU_FX_HSIOM_PRT27_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[341])                    /* 0x40025D40 */
#define PERI_MS_PPU_FX_HSIOM_PRT28_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[342])                    /* 0x40025D80 */
#define PERI_MS_PPU_FX_HSIOM_PRT29_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[343])                    /* 0x40025DC0 */
#define PERI_MS_PPU_FX_HSIOM_PRT30_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[344])                    /* 0x40025E00 */
#define PERI_MS_PPU_FX_HSIOM_PRT31_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[345])                    /* 0x40025E40 */
#define PERI_MS_PPU_FX_HSIOM_PRT32_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[346])                    /* 0x40025E80 */
#define PERI_MS_PPU_FX_HSIOM_PRT33_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[347])                    /* 0x40025EC0 */
#define PERI_MS_PPU_FX_HSIOM_PRT34_PRT          ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[348])                    /* 0x40025F00 */
#define PERI_MS_PPU_FX_HSIOM_AMUX               ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[349])                    /* 0x40025F40 */
#define PERI_MS_PPU_FX_HSIOM_MON                ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[350])                    /* 0x40025F80 */
#define PERI_MS_PPU_FX_HSIOM_ALTJTAG            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[351])                    /* 0x40025FC0 */
#define PERI_MS_PPU_FX_GPIO_PRT0_PRT            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[352])                    /* 0x40026000 */
#define PERI_MS_PPU_FX_GPIO_PRT1_PRT            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[353])                    /* 0x40026040 */
#define PERI_MS_PPU_FX_GPIO_PRT2_PRT            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[354])                    /* 0x40026080 */
#define PERI_MS_PPU_FX_GPIO_PRT3_PRT            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[355])                    /* 0x400260C0 */
#define PERI_MS_PPU_FX_GPIO_PRT4_PRT            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[356])                    /* 0x40026100 */
#define PERI_MS_PPU_FX_GPIO_PRT5_PRT            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[357])                    /* 0x40026140 */
#define PERI_MS_PPU_FX_GPIO_PRT6_PRT            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[358])                    /* 0x40026180 */
#define PERI_MS_PPU_FX_GPIO_PRT7_PRT            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[359])                    /* 0x400261C0 */
#define PERI_MS_PPU_FX_GPIO_PRT8_PRT            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[360])                    /* 0x40026200 */
#define PERI_MS_PPU_FX_GPIO_PRT9_PRT            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[361])                    /* 0x40026240 */
#define PERI_MS_PPU_FX_GPIO_PRT10_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[362])                    /* 0x40026280 */
#define PERI_MS_PPU_FX_GPIO_PRT11_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[363])                    /* 0x400262C0 */
#define PERI_MS_PPU_FX_GPIO_PRT12_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[364])                    /* 0x40026300 */
#define PERI_MS_PPU_FX_GPIO_PRT13_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[365])                    /* 0x40026340 */
#define PERI_MS_PPU_FX_GPIO_PRT14_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[366])                    /* 0x40026380 */
#define PERI_MS_PPU_FX_GPIO_PRT15_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[367])                    /* 0x400263C0 */
#define PERI_MS_PPU_FX_GPIO_PRT16_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[368])                    /* 0x40026400 */
#define PERI_MS_PPU_FX_GPIO_PRT17_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[369])                    /* 0x40026440 */
#define PERI_MS_PPU_FX_GPIO_PRT18_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[370])                    /* 0x40026480 */
#define PERI_MS_PPU_FX_GPIO_PRT19_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[371])                    /* 0x400264C0 */
#define PERI_MS_PPU_FX_GPIO_PRT20_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[372])                    /* 0x40026500 */
#define PERI_MS_PPU_FX_GPIO_PRT21_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[373])                    /* 0x40026540 */
#define PERI_MS_PPU_FX_GPIO_PRT22_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[374])                    /* 0x40026580 */
#define PERI_MS_PPU_FX_GPIO_PRT23_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[375])                    /* 0x400265C0 */
#define PERI_MS_PPU_FX_GPIO_PRT24_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[376])                    /* 0x40026600 */
#define PERI_MS_PPU_FX_GPIO_PRT25_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[377])                    /* 0x40026640 */
#define PERI_MS_PPU_FX_GPIO_PRT26_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[378])                    /* 0x40026680 */
#define PERI_MS_PPU_FX_GPIO_PRT27_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[379])                    /* 0x400266C0 */
#define PERI_MS_PPU_FX_GPIO_PRT28_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[380])                    /* 0x40026700 */
#define PERI_MS_PPU_FX_GPIO_PRT29_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[381])                    /* 0x40026740 */
#define PERI_MS_PPU_FX_GPIO_PRT30_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[382])                    /* 0x40026780 */
#define PERI_MS_PPU_FX_GPIO_PRT31_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[383])                    /* 0x400267C0 */
#define PERI_MS_PPU_FX_GPIO_PRT32_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[384])                    /* 0x40026800 */
#define PERI_MS_PPU_FX_GPIO_PRT33_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[385])                    /* 0x40026840 */
#define PERI_MS_PPU_FX_GPIO_PRT34_PRT           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[386])                    /* 0x40026880 */
#define PERI_MS_PPU_FX_GPIO_PRT0_CFG            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[387])                    /* 0x400268C0 */
#define PERI_MS_PPU_FX_GPIO_PRT1_CFG            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[388])                    /* 0x40026900 */
#define PERI_MS_PPU_FX_GPIO_PRT2_CFG            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[389])                    /* 0x40026940 */
#define PERI_MS_PPU_FX_GPIO_PRT3_CFG            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[390])                    /* 0x40026980 */
#define PERI_MS_PPU_FX_GPIO_PRT4_CFG            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[391])                    /* 0x400269C0 */
#define PERI_MS_PPU_FX_GPIO_PRT5_CFG            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[392])                    /* 0x40026A00 */
#define PERI_MS_PPU_FX_GPIO_PRT6_CFG            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[393])                    /* 0x40026A40 */
#define PERI_MS_PPU_FX_GPIO_PRT7_CFG            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[394])                    /* 0x40026A80 */
#define PERI_MS_PPU_FX_GPIO_PRT8_CFG            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[395])                    /* 0x40026AC0 */
#define PERI_MS_PPU_FX_GPIO_PRT9_CFG            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[396])                    /* 0x40026B00 */
#define PERI_MS_PPU_FX_GPIO_PRT10_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[397])                    /* 0x40026B40 */
#define PERI_MS_PPU_FX_GPIO_PRT11_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[398])                    /* 0x40026B80 */
#define PERI_MS_PPU_FX_GPIO_PRT12_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[399])                    /* 0x40026BC0 */
#define PERI_MS_PPU_FX_GPIO_PRT13_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[400])                    /* 0x40026C00 */
#define PERI_MS_PPU_FX_GPIO_PRT14_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[401])                    /* 0x40026C40 */
#define PERI_MS_PPU_FX_GPIO_PRT15_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[402])                    /* 0x40026C80 */
#define PERI_MS_PPU_FX_GPIO_PRT16_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[403])                    /* 0x40026CC0 */
#define PERI_MS_PPU_FX_GPIO_PRT17_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[404])                    /* 0x40026D00 */
#define PERI_MS_PPU_FX_GPIO_PRT18_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[405])                    /* 0x40026D40 */
#define PERI_MS_PPU_FX_GPIO_PRT19_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[406])                    /* 0x40026D80 */
#define PERI_MS_PPU_FX_GPIO_PRT20_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[407])                    /* 0x40026DC0 */
#define PERI_MS_PPU_FX_GPIO_PRT21_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[408])                    /* 0x40026E00 */
#define PERI_MS_PPU_FX_GPIO_PRT22_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[409])                    /* 0x40026E40 */
#define PERI_MS_PPU_FX_GPIO_PRT23_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[410])                    /* 0x40026E80 */
#define PERI_MS_PPU_FX_GPIO_PRT24_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[411])                    /* 0x40026EC0 */
#define PERI_MS_PPU_FX_GPIO_PRT25_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[412])                    /* 0x40026F00 */
#define PERI_MS_PPU_FX_GPIO_PRT26_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[413])                    /* 0x40026F40 */
#define PERI_MS_PPU_FX_GPIO_PRT27_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[414])                    /* 0x40026F80 */
#define PERI_MS_PPU_FX_GPIO_PRT28_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[415])                    /* 0x40026FC0 */
#define PERI_MS_PPU_FX_GPIO_PRT29_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[416])                    /* 0x40027000 */
#define PERI_MS_PPU_FX_GPIO_PRT30_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[417])                    /* 0x40027040 */
#define PERI_MS_PPU_FX_GPIO_PRT31_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[418])                    /* 0x40027080 */
#define PERI_MS_PPU_FX_GPIO_PRT32_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[419])                    /* 0x400270C0 */
#define PERI_MS_PPU_FX_GPIO_PRT33_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[420])                    /* 0x40027100 */
#define PERI_MS_PPU_FX_GPIO_PRT34_CFG           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[421])                    /* 0x40027140 */
#define PERI_MS_PPU_FX_GPIO_GPIO                ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[422])                    /* 0x40027180 */
#define PERI_MS_PPU_FX_GPIO_TEST                ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[423])                    /* 0x400271C0 */
#define PERI_MS_PPU_FX_SMARTIO_PRT12_PRT        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[424])                    /* 0x40027200 */
#define PERI_MS_PPU_FX_SMARTIO_PRT13_PRT        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[425])                    /* 0x40027240 */
#define PERI_MS_PPU_FX_SMARTIO_PRT14_PRT        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[426])                    /* 0x40027280 */
#define PERI_MS_PPU_FX_SMARTIO_PRT15_PRT        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[427])                    /* 0x400272C0 */
#define PERI_MS_PPU_FX_SMARTIO_PRT17_PRT        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[428])                    /* 0x40027300 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT0_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[429])                    /* 0x40027340 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT1_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[430])                    /* 0x40027380 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT2_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[431])                    /* 0x400273C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT0_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[432])                    /* 0x40027400 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT1_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[433])                    /* 0x40027440 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT2_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[434])                    /* 0x40027480 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT0_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[435])                    /* 0x400274C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT1_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[436])                    /* 0x40027500 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT2_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[437])                    /* 0x40027540 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT0_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[438])                    /* 0x40027580 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT1_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[439])                    /* 0x400275C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT2_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[440])                    /* 0x40027600 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT3_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[441])                    /* 0x40027640 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT4_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[442])                    /* 0x40027680 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT5_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[443])                    /* 0x400276C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT6_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[444])                    /* 0x40027700 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT7_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[445])                    /* 0x40027740 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT8_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[446])                    /* 0x40027780 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT9_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[447])                    /* 0x400277C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT10_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[448])                    /* 0x40027800 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT11_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[449])                    /* 0x40027840 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT12_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[450])                    /* 0x40027880 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT13_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[451])                    /* 0x400278C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT14_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[452])                    /* 0x40027900 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT15_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[453])                    /* 0x40027940 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT16_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[454])                    /* 0x40027980 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT17_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[455])                    /* 0x400279C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT18_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[456])                    /* 0x40027A00 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT19_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[457])                    /* 0x40027A40 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT20_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[458])                    /* 0x40027A80 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT21_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[459])                    /* 0x40027AC0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT22_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[460])                    /* 0x40027B00 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT23_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[461])                    /* 0x40027B40 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT24_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[462])                    /* 0x40027B80 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT25_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[463])                    /* 0x40027BC0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT26_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[464])                    /* 0x40027C00 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT27_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[465])                    /* 0x40027C40 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT28_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[466])                    /* 0x40027C80 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT29_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[467])                    /* 0x40027CC0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT30_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[468])                    /* 0x40027D00 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT31_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[469])                    /* 0x40027D40 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT32_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[470])                    /* 0x40027D80 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT33_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[471])                    /* 0x40027DC0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT34_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[472])                    /* 0x40027E00 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT35_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[473])                    /* 0x40027E40 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT36_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[474])                    /* 0x40027E80 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT37_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[475])                    /* 0x40027EC0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT38_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[476])                    /* 0x40027F00 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT39_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[477])                    /* 0x40027F40 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT40_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[478])                    /* 0x40027F80 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT41_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[479])                    /* 0x40027FC0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT42_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[480])                    /* 0x40028000 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT43_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[481])                    /* 0x40028040 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT44_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[482])                    /* 0x40028080 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT45_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[483])                    /* 0x400280C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT46_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[484])                    /* 0x40028100 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT47_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[485])                    /* 0x40028140 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT48_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[486])                    /* 0x40028180 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT49_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[487])                    /* 0x400281C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT50_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[488])                    /* 0x40028200 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT51_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[489])                    /* 0x40028240 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT52_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[490])                    /* 0x40028280 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT53_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[491])                    /* 0x400282C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT54_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[492])                    /* 0x40028300 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT55_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[493])                    /* 0x40028340 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT56_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[494])                    /* 0x40028380 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT57_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[495])                    /* 0x400283C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT58_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[496])                    /* 0x40028400 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT59_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[497])                    /* 0x40028440 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT60_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[498])                    /* 0x40028480 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT61_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[499])                    /* 0x400284C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT62_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[500])                    /* 0x40028500 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT63_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[501])                    /* 0x40028540 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT64_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[502])                    /* 0x40028580 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT65_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[503])                    /* 0x400285C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT66_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[504])                    /* 0x40028600 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT67_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[505])                    /* 0x40028640 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT68_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[506])                    /* 0x40028680 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT69_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[507])                    /* 0x400286C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT70_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[508])                    /* 0x40028700 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT71_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[509])                    /* 0x40028740 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT72_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[510])                    /* 0x40028780 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT73_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[511])                    /* 0x400287C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT74_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[512])                    /* 0x40028800 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT75_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[513])                    /* 0x40028840 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT76_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[514])                    /* 0x40028880 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT77_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[515])                    /* 0x400288C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT78_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[516])                    /* 0x40028900 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT79_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[517])                    /* 0x40028940 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT80_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[518])                    /* 0x40028980 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT81_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[519])                    /* 0x400289C0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT82_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[520])                    /* 0x40028A00 */
#define PERI_MS_PPU_FX_TCPWM1_GRP0_CNT83_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[521])                    /* 0x40028A40 */
#define PERI_MS_PPU_FX_TCPWM1_GRP1_CNT0_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[522])                    /* 0x40028A80 */
#define PERI_MS_PPU_FX_TCPWM1_GRP1_CNT1_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[523])                    /* 0x40028AC0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP1_CNT2_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[524])                    /* 0x40028B00 */
#define PERI_MS_PPU_FX_TCPWM1_GRP1_CNT3_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[525])                    /* 0x40028B40 */
#define PERI_MS_PPU_FX_TCPWM1_GRP1_CNT4_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[526])                    /* 0x40028B80 */
#define PERI_MS_PPU_FX_TCPWM1_GRP1_CNT5_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[527])                    /* 0x40028BC0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP1_CNT6_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[528])                    /* 0x40028C00 */
#define PERI_MS_PPU_FX_TCPWM1_GRP1_CNT7_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[529])                    /* 0x40028C40 */
#define PERI_MS_PPU_FX_TCPWM1_GRP1_CNT8_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[530])                    /* 0x40028C80 */
#define PERI_MS_PPU_FX_TCPWM1_GRP1_CNT9_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[531])                    /* 0x40028CC0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP1_CNT10_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[532])                    /* 0x40028D00 */
#define PERI_MS_PPU_FX_TCPWM1_GRP1_CNT11_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[533])                    /* 0x40028D40 */
#define PERI_MS_PPU_FX_TCPWM1_GRP2_CNT0_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[534])                    /* 0x40028D80 */
#define PERI_MS_PPU_FX_TCPWM1_GRP2_CNT1_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[535])                    /* 0x40028DC0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP2_CNT2_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[536])                    /* 0x40028E00 */
#define PERI_MS_PPU_FX_TCPWM1_GRP2_CNT3_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[537])                    /* 0x40028E40 */
#define PERI_MS_PPU_FX_TCPWM1_GRP2_CNT4_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[538])                    /* 0x40028E80 */
#define PERI_MS_PPU_FX_TCPWM1_GRP2_CNT5_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[539])                    /* 0x40028EC0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP2_CNT6_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[540])                    /* 0x40028F00 */
#define PERI_MS_PPU_FX_TCPWM1_GRP2_CNT7_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[541])                    /* 0x40028F40 */
#define PERI_MS_PPU_FX_TCPWM1_GRP2_CNT8_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[542])                    /* 0x40028F80 */
#define PERI_MS_PPU_FX_TCPWM1_GRP2_CNT9_CNT     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[543])                    /* 0x40028FC0 */
#define PERI_MS_PPU_FX_TCPWM1_GRP2_CNT10_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[544])                    /* 0x40029000 */
#define PERI_MS_PPU_FX_TCPWM1_GRP2_CNT11_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[545])                    /* 0x40029040 */
#define PERI_MS_PPU_FX_TCPWM1_GRP2_CNT12_CNT    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[546])                    /* 0x40029080 */
#define PERI_MS_PPU_FX_EVTGEN0                  ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[547])                    /* 0x400290C0 */
#define PERI_MS_PPU_FX_SMIF0                    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[548])                    /* 0x40029100 */
#define PERI_MS_PPU_FX_SDHC0                    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[549])                    /* 0x40029140 */
#define PERI_MS_PPU_FX_ETH0                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[550])                    /* 0x40029180 */
#define PERI_MS_PPU_FX_ETH1                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[551])                    /* 0x400291C0 */
#define PERI_MS_PPU_FX_LIN0_MAIN                ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[552])                    /* 0x40029200 */
#define PERI_MS_PPU_FX_LIN0_CH0_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[553])                    /* 0x40029240 */
#define PERI_MS_PPU_FX_LIN0_CH1_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[554])                    /* 0x40029280 */
#define PERI_MS_PPU_FX_LIN0_CH2_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[555])                    /* 0x400292C0 */
#define PERI_MS_PPU_FX_LIN0_CH3_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[556])                    /* 0x40029300 */
#define PERI_MS_PPU_FX_LIN0_CH4_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[557])                    /* 0x40029340 */
#define PERI_MS_PPU_FX_LIN0_CH5_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[558])                    /* 0x40029380 */
#define PERI_MS_PPU_FX_LIN0_CH6_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[559])                    /* 0x400293C0 */
#define PERI_MS_PPU_FX_LIN0_CH7_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[560])                    /* 0x40029400 */
#define PERI_MS_PPU_FX_LIN0_CH8_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[561])                    /* 0x40029440 */
#define PERI_MS_PPU_FX_LIN0_CH9_CH              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[562])                    /* 0x40029480 */
#define PERI_MS_PPU_FX_LIN0_CH10_CH             ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[563])                    /* 0x400294C0 */
#define PERI_MS_PPU_FX_LIN0_CH11_CH             ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[564])                    /* 0x40029500 */
#define PERI_MS_PPU_FX_LIN0_CH12_CH             ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[565])                    /* 0x40029540 */
#define PERI_MS_PPU_FX_LIN0_CH13_CH             ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[566])                    /* 0x40029580 */
#define PERI_MS_PPU_FX_LIN0_CH14_CH             ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[567])                    /* 0x400295C0 */
#define PERI_MS_PPU_FX_LIN0_CH15_CH             ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[568])                    /* 0x40029600 */
#define PERI_MS_PPU_FX_LIN0_CH16_CH             ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[569])                    /* 0x40029640 */
#define PERI_MS_PPU_FX_LIN0_CH17_CH             ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[570])                    /* 0x40029680 */
#define PERI_MS_PPU_FX_LIN0_CH18_CH             ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[571])                    /* 0x400296C0 */
#define PERI_MS_PPU_FX_LIN0_CH19_CH             ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[572])                    /* 0x40029700 */
#define PERI_MS_PPU_FX_CANFD0_CH0_CH            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[573])                    /* 0x40029740 */
#define PERI_MS_PPU_FX_CANFD0_CH1_CH            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[574])                    /* 0x40029780 */
#define PERI_MS_PPU_FX_CANFD0_CH2_CH            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[575])                    /* 0x400297C0 */
#define PERI_MS_PPU_FX_CANFD0_CH3_CH            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[576])                    /* 0x40029800 */
#define PERI_MS_PPU_FX_CANFD0_CH4_CH            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[577])                    /* 0x40029840 */
#define PERI_MS_PPU_FX_CANFD1_CH0_CH            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[578])                    /* 0x40029880 */
#define PERI_MS_PPU_FX_CANFD1_CH1_CH            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[579])                    /* 0x400298C0 */
#define PERI_MS_PPU_FX_CANFD1_CH2_CH            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[580])                    /* 0x40029900 */
#define PERI_MS_PPU_FX_CANFD1_CH3_CH            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[581])                    /* 0x40029940 */
#define PERI_MS_PPU_FX_CANFD1_CH4_CH            ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[582])                    /* 0x40029980 */
#define PERI_MS_PPU_FX_CANFD0_MAIN              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[583])                    /* 0x400299C0 */
#define PERI_MS_PPU_FX_CANFD1_MAIN              ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[584])                    /* 0x40029A00 */
#define PERI_MS_PPU_FX_CANFD0_BUF               ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[585])                    /* 0x40029A40 */
#define PERI_MS_PPU_FX_CANFD1_BUF               ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[586])                    /* 0x40029A80 */
#define PERI_MS_PPU_FX_FLEXRAY0                 ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[587])                    /* 0x40029AC0 */
#define PERI_MS_PPU_FX_SCB0                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[588])                    /* 0x40029B00 */
#define PERI_MS_PPU_FX_SCB1                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[589])                    /* 0x40029B40 */
#define PERI_MS_PPU_FX_SCB2                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[590])                    /* 0x40029B80 */
#define PERI_MS_PPU_FX_SCB3                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[591])                    /* 0x40029BC0 */
#define PERI_MS_PPU_FX_SCB4                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[592])                    /* 0x40029C00 */
#define PERI_MS_PPU_FX_SCB5                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[593])                    /* 0x40029C40 */
#define PERI_MS_PPU_FX_SCB6                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[594])                    /* 0x40029C80 */
#define PERI_MS_PPU_FX_SCB7                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[595])                    /* 0x40029CC0 */
#define PERI_MS_PPU_FX_SCB8                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[596])                    /* 0x40029D00 */
#define PERI_MS_PPU_FX_SCB9                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[597])                    /* 0x40029D40 */
#define PERI_MS_PPU_FX_SCB10                    ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[598])                    /* 0x40029D80 */
#define PERI_MS_PPU_FX_I2S0                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[599])                    /* 0x40029DC0 */
#define PERI_MS_PPU_FX_I2S1                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[600])                    /* 0x40029E00 */
#define PERI_MS_PPU_FX_I2S2                     ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[601])                    /* 0x40029E40 */
#define PERI_MS_PPU_FX_PASS0_SAR0_SAR           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[602])                    /* 0x40029E80 */
#define PERI_MS_PPU_FX_PASS0_SAR1_SAR           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[603])                    /* 0x40029EC0 */
#define PERI_MS_PPU_FX_PASS0_SAR2_SAR           ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[604])                    /* 0x40029F00 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH0_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[605])                    /* 0x40029F40 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH1_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[606])                    /* 0x40029F80 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH2_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[607])                    /* 0x40029FC0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH3_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[608])                    /* 0x4002A000 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH4_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[609])                    /* 0x4002A040 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH5_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[610])                    /* 0x4002A080 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH6_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[611])                    /* 0x4002A0C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH7_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[612])                    /* 0x4002A100 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH8_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[613])                    /* 0x4002A140 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH9_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[614])                    /* 0x4002A180 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH10_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[615])                    /* 0x4002A1C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH11_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[616])                    /* 0x4002A200 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH12_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[617])                    /* 0x4002A240 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH13_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[618])                    /* 0x4002A280 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH14_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[619])                    /* 0x4002A2C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH15_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[620])                    /* 0x4002A300 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH16_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[621])                    /* 0x4002A340 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH17_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[622])                    /* 0x4002A380 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH18_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[623])                    /* 0x4002A3C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH19_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[624])                    /* 0x4002A400 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH20_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[625])                    /* 0x4002A440 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH21_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[626])                    /* 0x4002A480 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH22_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[627])                    /* 0x4002A4C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH23_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[628])                    /* 0x4002A500 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH24_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[629])                    /* 0x4002A540 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH25_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[630])                    /* 0x4002A580 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH26_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[631])                    /* 0x4002A5C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH27_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[632])                    /* 0x4002A600 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH28_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[633])                    /* 0x4002A640 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH29_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[634])                    /* 0x4002A680 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH30_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[635])                    /* 0x4002A6C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH31_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[636])                    /* 0x4002A700 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH0_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[637])                    /* 0x4002A740 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH1_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[638])                    /* 0x4002A780 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH2_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[639])                    /* 0x4002A7C0 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH3_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[640])                    /* 0x4002A800 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH4_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[641])                    /* 0x4002A840 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH5_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[642])                    /* 0x4002A880 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH6_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[643])                    /* 0x4002A8C0 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH7_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[644])                    /* 0x4002A900 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH8_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[645])                    /* 0x4002A940 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH9_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[646])                    /* 0x4002A980 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH10_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[647])                    /* 0x4002A9C0 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH11_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[648])                    /* 0x4002AA00 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH12_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[649])                    /* 0x4002AA40 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH13_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[650])                    /* 0x4002AA80 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH14_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[651])                    /* 0x4002AAC0 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH15_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[652])                    /* 0x4002AB00 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH16_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[653])                    /* 0x4002AB40 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH17_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[654])                    /* 0x4002AB80 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH18_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[655])                    /* 0x4002ABC0 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH19_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[656])                    /* 0x4002AC00 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH20_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[657])                    /* 0x4002AC40 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH21_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[658])                    /* 0x4002AC80 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH22_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[659])                    /* 0x4002ACC0 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH23_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[660])                    /* 0x4002AD00 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH24_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[661])                    /* 0x4002AD40 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH25_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[662])                    /* 0x4002AD80 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH26_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[663])                    /* 0x4002ADC0 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH27_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[664])                    /* 0x4002AE00 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH28_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[665])                    /* 0x4002AE40 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH29_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[666])                    /* 0x4002AE80 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH30_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[667])                    /* 0x4002AEC0 */
#define PERI_MS_PPU_FX_PASS0_SAR1_CH31_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[668])                    /* 0x4002AF00 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH0_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[669])                    /* 0x4002AF40 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH1_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[670])                    /* 0x4002AF80 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH2_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[671])                    /* 0x4002AFC0 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH3_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[672])                    /* 0x4002B000 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH4_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[673])                    /* 0x4002B040 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH5_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[674])                    /* 0x4002B080 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH6_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[675])                    /* 0x4002B0C0 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH7_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[676])                    /* 0x4002B100 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH8_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[677])                    /* 0x4002B140 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH9_CH        ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[678])                    /* 0x4002B180 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH10_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[679])                    /* 0x4002B1C0 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH11_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[680])                    /* 0x4002B200 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH12_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[681])                    /* 0x4002B240 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH13_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[682])                    /* 0x4002B280 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH14_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[683])                    /* 0x4002B2C0 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH15_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[684])                    /* 0x4002B300 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH16_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[685])                    /* 0x4002B340 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH17_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[686])                    /* 0x4002B380 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH18_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[687])                    /* 0x4002B3C0 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH19_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[688])                    /* 0x4002B400 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH20_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[689])                    /* 0x4002B440 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH21_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[690])                    /* 0x4002B480 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH22_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[691])                    /* 0x4002B4C0 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH23_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[692])                    /* 0x4002B500 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH24_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[693])                    /* 0x4002B540 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH25_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[694])                    /* 0x4002B580 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH26_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[695])                    /* 0x4002B5C0 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH27_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[696])                    /* 0x4002B600 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH28_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[697])                    /* 0x4002B640 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH29_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[698])                    /* 0x4002B680 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH30_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[699])                    /* 0x4002B6C0 */
#define PERI_MS_PPU_FX_PASS0_SAR2_CH31_CH       ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[700])                    /* 0x4002B700 */
#define PERI_MS_PPU_FX_PASS0_TOP                ((PERI_MS_PPU_FX_Type*) &PERI_MS->PPU_FX[701])                    /* 0x4002B740 */
...
#define DW0_CH_STRUCT100                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[100])                       /* 0x40289900 */
#define DW0_CH_STRUCT101                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[101])                       /* 0x40289940 */
#define DW0_CH_STRUCT102                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[102])                       /* 0x40289980 */
#define DW0_CH_STRUCT103                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[103])                       /* 0x402899C0 */
#define DW0_CH_STRUCT104                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[104])                       /* 0x40289A00 */
#define DW0_CH_STRUCT105                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[105])                       /* 0x40289A40 */
#define DW0_CH_STRUCT106                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[106])                       /* 0x40289A80 */
#define DW0_CH_STRUCT107                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[107])                       /* 0x40289AC0 */
#define DW0_CH_STRUCT108                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[108])                       /* 0x40289B00 */
#define DW0_CH_STRUCT109                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[109])                       /* 0x40289B40 */
#define DW0_CH_STRUCT110                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[110])                       /* 0x40289B80 */
#define DW0_CH_STRUCT111                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[111])                       /* 0x40289BC0 */
#define DW0_CH_STRUCT112                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[112])                       /* 0x40289C00 */
#define DW0_CH_STRUCT113                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[113])                       /* 0x40289C40 */
#define DW0_CH_STRUCT114                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[114])                       /* 0x40289C80 */
#define DW0_CH_STRUCT115                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[115])                       /* 0x40289CC0 */
#define DW0_CH_STRUCT116                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[116])                       /* 0x40289D00 */
#define DW0_CH_STRUCT117                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[117])                       /* 0x40289D40 */
#define DW0_CH_STRUCT118                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[118])                       /* 0x40289D80 */
#define DW0_CH_STRUCT119                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[119])                       /* 0x40289DC0 */
#define DW0_CH_STRUCT120                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[120])                       /* 0x40289E00 */
#define DW0_CH_STRUCT121                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[121])                       /* 0x40289E40 */
#define DW0_CH_STRUCT122                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[122])                       /* 0x40289E80 */
#define DW0_CH_STRUCT123                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[123])                       /* 0x40289EC0 */
#define DW0_CH_STRUCT124                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[124])                       /* 0x40289F00 */
#define DW0_CH_STRUCT125                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[125])                       /* 0x40289F40 */
#define DW0_CH_STRUCT126                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[126])                       /* 0x40289F80 */
#define DW0_CH_STRUCT127                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[127])                       /* 0x40289FC0 */
#define DW0_CH_STRUCT128                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[128])                       /* 0x4028A000 */
#define DW0_CH_STRUCT129                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[129])                       /* 0x4028A040 */
#define DW0_CH_STRUCT130                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[130])                       /* 0x4028A080 */
#define DW0_CH_STRUCT131                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[131])                       /* 0x4028A0C0 */
#define DW0_CH_STRUCT132                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[132])                       /* 0x4028A100 */
#define DW0_CH_STRUCT133                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[133])                       /* 0x4028A140 */
#define DW0_CH_STRUCT134                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[134])                       /* 0x4028A180 */
#define DW0_CH_STRUCT135                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[135])                       /* 0x4028A1C0 */
#define DW0_CH_STRUCT136                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[136])                       /* 0x4028A200 */
#define DW0_CH_STRUCT137                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[137])                       /* 0x4028A240 */
#define DW0_CH_STRUCT138                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[138])                       /* 0x4028A280 */
#define DW0_CH_STRUCT139                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[139])                       /* 0x4028A2C0 */
#define DW0_CH_STRUCT140                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[140])                       /* 0x4028A300 */
#define DW0_CH_STRUCT141                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[141])                       /* 0x4028A340 */
#define DW0_CH_STRUCT142                        ((DW_CH_STRUCT_Type*) &DW0->CH_STRUCT[142])                       /* 0x4028A380 */
...
#define HSIOM_PRT33                             ((HSIOM_PRT_Type*) &HSIOM->PRT[33])                               /* 0x40300210 */
#define HSIOM_PRT34                             ((HSIOM_PRT_Type*) &HSIOM->PRT[34])                               /* 0x40300220 */
...
#define GPIO_PRT33                              ((GPIO_PRT_Type*) &GPIO->PRT[33])                                 /* 0x40311080 */
#define GPIO_PRT34                              ((GPIO_PRT_Type*) &GPIO->PRT[34])                                 /* 0x40311100 */
...
#define TCPWM1                                  ((TCPWM_Type*) TCPWM1_BASE)                                       /* 0x40580000 */
...
#define TCPWM1_GRP0                             ((TCPWM_GRP_Type*) &TCPWM1->GRP[0])                               /* 0x40580000 */
#define TCPWM1_GRP1                             ((TCPWM_GRP_Type*) &TCPWM1->GRP[1])                               /* 0x40588000 */
#define TCPWM1_GRP2                             ((TCPWM_GRP_Type*) &TCPWM1->GRP[2])                               /* 0x40590000 */
...
#define TCPWM1_GRP0_CNT0                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[0])                    /* 0x40580000 */
#define TCPWM1_GRP0_CNT1                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[1])                    /* 0x40580080 */
#define TCPWM1_GRP0_CNT2                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[2])                    /* 0x40580100 */
#define TCPWM1_GRP0_CNT3                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[3])                    /* 0x40580180 */
#define TCPWM1_GRP0_CNT4                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[4])                    /* 0x40580200 */
#define TCPWM1_GRP0_CNT5                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[5])                    /* 0x40580280 */
#define TCPWM1_GRP0_CNT6                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[6])                    /* 0x40580300 */
#define TCPWM1_GRP0_CNT7                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[7])                    /* 0x40580380 */
#define TCPWM1_GRP0_CNT8                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[8])                    /* 0x40580400 */
#define TCPWM1_GRP0_CNT9                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[9])                    /* 0x40580480 */
#define TCPWM1_GRP0_CNT10                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[10])                   /* 0x40580500 */
#define TCPWM1_GRP0_CNT11                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[11])                   /* 0x40580580 */
#define TCPWM1_GRP0_CNT12                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[12])                   /* 0x40580600 */
#define TCPWM1_GRP0_CNT13                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[13])                   /* 0x40580680 */
#define TCPWM1_GRP0_CNT14                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[14])                   /* 0x40580700 */
#define TCPWM1_GRP0_CNT15                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[15])                   /* 0x40580780 */
#define TCPWM1_GRP0_CNT16                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[16])                   /* 0x40580800 */
#define TCPWM1_GRP0_CNT17                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[17])                   /* 0x40580880 */
#define TCPWM1_GRP0_CNT18                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[18])                   /* 0x40580900 */
#define TCPWM1_GRP0_CNT19                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[19])                   /* 0x40580980 */
#define TCPWM1_GRP0_CNT20                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[20])                   /* 0x40580A00 */
#define TCPWM1_GRP0_CNT21                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[21])                   /* 0x40580A80 */
#define TCPWM1_GRP0_CNT22                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[22])                   /* 0x40580B00 */
#define TCPWM1_GRP0_CNT23                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[23])                   /* 0x40580B80 */
#define TCPWM1_GRP0_CNT24                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[24])                   /* 0x40580C00 */
#define TCPWM1_GRP0_CNT25                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[25])                   /* 0x40580C80 */
#define TCPWM1_GRP0_CNT26                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[26])                   /* 0x40580D00 */
#define TCPWM1_GRP0_CNT27                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[27])                   /* 0x40580D80 */
#define TCPWM1_GRP0_CNT28                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[28])                   /* 0x40580E00 */
#define TCPWM1_GRP0_CNT29                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[29])                   /* 0x40580E80 */
#define TCPWM1_GRP0_CNT30                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[30])                   /* 0x40580F00 */
#define TCPWM1_GRP0_CNT31                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[31])                   /* 0x40580F80 */
#define TCPWM1_GRP0_CNT32                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[32])                   /* 0x40581000 */
#define TCPWM1_GRP0_CNT33                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[33])                   /* 0x40581080 */
#define TCPWM1_GRP0_CNT34                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[34])                   /* 0x40581100 */
#define TCPWM1_GRP0_CNT35                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[35])                   /* 0x40581180 */
#define TCPWM1_GRP0_CNT36                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[36])                   /* 0x40581200 */
#define TCPWM1_GRP0_CNT37                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[37])                   /* 0x40581280 */
#define TCPWM1_GRP0_CNT38                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[38])                   /* 0x40581300 */
#define TCPWM1_GRP0_CNT39                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[39])                   /* 0x40581380 */
#define TCPWM1_GRP0_CNT40                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[40])                   /* 0x40581400 */
#define TCPWM1_GRP0_CNT41                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[41])                   /* 0x40581480 */
#define TCPWM1_GRP0_CNT42                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[42])                   /* 0x40581500 */
#define TCPWM1_GRP0_CNT43                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[43])                   /* 0x40581580 */
#define TCPWM1_GRP0_CNT44                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[44])                   /* 0x40581600 */
#define TCPWM1_GRP0_CNT45                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[45])                   /* 0x40581680 */
#define TCPWM1_GRP0_CNT46                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[46])                   /* 0x40581700 */
#define TCPWM1_GRP0_CNT47                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[47])                   /* 0x40581780 */
#define TCPWM1_GRP0_CNT48                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[48])                   /* 0x40581800 */
#define TCPWM1_GRP0_CNT49                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[49])                   /* 0x40581880 */
#define TCPWM1_GRP0_CNT50                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[50])                   /* 0x40581900 */
#define TCPWM1_GRP0_CNT51                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[51])                   /* 0x40581980 */
#define TCPWM1_GRP0_CNT52                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[52])                   /* 0x40581A00 */
#define TCPWM1_GRP0_CNT53                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[53])                   /* 0x40581A80 */
#define TCPWM1_GRP0_CNT54                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[54])                   /* 0x40581B00 */
#define TCPWM1_GRP0_CNT55                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[55])                   /* 0x40581B80 */
#define TCPWM1_GRP0_CNT56                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[56])                   /* 0x40581C00 */
#define TCPWM1_GRP0_CNT57                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[57])                   /* 0x40581C80 */
#define TCPWM1_GRP0_CNT58                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[58])                   /* 0x40581D00 */
#define TCPWM1_GRP0_CNT59                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[59])                   /* 0x40581D80 */
#define TCPWM1_GRP0_CNT60                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[60])                   /* 0x40581E00 */
#define TCPWM1_GRP0_CNT61                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[61])                   /* 0x40581E80 */
#define TCPWM1_GRP0_CNT62                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[62])                   /* 0x40581F00 */
#define TCPWM1_GRP0_CNT63                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[63])                   /* 0x40581F80 */
#define TCPWM1_GRP0_CNT64                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[64])                   /* 0x40582000 */
#define TCPWM1_GRP0_CNT65                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[65])                   /* 0x40582080 */
#define TCPWM1_GRP0_CNT66                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[66])                   /* 0x40582100 */
#define TCPWM1_GRP0_CNT67                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[67])                   /* 0x40582180 */
#define TCPWM1_GRP0_CNT68                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[68])                   /* 0x40582200 */
#define TCPWM1_GRP0_CNT69                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[69])                   /* 0x40582280 */
#define TCPWM1_GRP0_CNT70                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[70])                   /* 0x40582300 */
#define TCPWM1_GRP0_CNT71                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[71])                   /* 0x40582380 */
#define TCPWM1_GRP0_CNT72                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[72])                   /* 0x40582400 */
#define TCPWM1_GRP0_CNT73                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[73])                   /* 0x40582480 */
#define TCPWM1_GRP0_CNT74                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[74])                   /* 0x40582500 */
#define TCPWM1_GRP0_CNT75                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[75])                   /* 0x40582580 */
#define TCPWM1_GRP0_CNT76                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[76])                   /* 0x40582600 */
#define TCPWM1_GRP0_CNT77                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[77])                   /* 0x40582680 */
#define TCPWM1_GRP0_CNT78                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[78])                   /* 0x40582700 */
#define TCPWM1_GRP0_CNT79                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[79])                   /* 0x40582780 */
#define TCPWM1_GRP0_CNT80                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[80])                   /* 0x40582800 */
#define TCPWM1_GRP0_CNT81                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[81])                   /* 0x40582880 */
#define TCPWM1_GRP0_CNT82                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[82])                   /* 0x40582900 */
#define TCPWM1_GRP0_CNT83                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[0].CNT[83])                   /* 0x40582980 */
#define TCPWM1_GRP1_CNT0                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[1].CNT[0])                    /* 0x40588000 */
#define TCPWM1_GRP1_CNT1                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[1].CNT[1])                    /* 0x40588080 */
#define TCPWM1_GRP1_CNT2                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[1].CNT[2])                    /* 0x40588100 */
#define TCPWM1_GRP1_CNT3                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[1].CNT[3])                    /* 0x40588180 */
#define TCPWM1_GRP1_CNT4                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[1].CNT[4])                    /* 0x40588200 */
#define TCPWM1_GRP1_CNT5                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[1].CNT[5])                    /* 0x40588280 */
#define TCPWM1_GRP1_CNT6                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[1].CNT[6])                    /* 0x40588300 */
#define TCPWM1_GRP1_CNT7                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[1].CNT[7])                    /* 0x40588380 */
#define TCPWM1_GRP1_CNT8                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[1].CNT[8])                    /* 0x40588400 */
#define TCPWM1_GRP1_CNT9                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[1].CNT[9])                    /* 0x40588480 */
#define TCPWM1_GRP1_CNT10                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[1].CNT[10])                   /* 0x40588500 */
#define TCPWM1_GRP1_CNT11                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[1].CNT[11])                   /* 0x40588580 */
#define TCPWM1_GRP2_CNT0                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[2].CNT[0])                    /* 0x40590000 */
#define TCPWM1_GRP2_CNT1                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[2].CNT[1])                    /* 0x40590080 */
#define TCPWM1_GRP2_CNT2                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[2].CNT[2])                    /* 0x40590100 */
#define TCPWM1_GRP2_CNT3                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[2].CNT[3])                    /* 0x40590180 */
#define TCPWM1_GRP2_CNT4                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[2].CNT[4])                    /* 0x40590200 */
#define TCPWM1_GRP2_CNT5                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[2].CNT[5])                    /* 0x40590280 */
#define TCPWM1_GRP2_CNT6                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[2].CNT[6])                    /* 0x40590300 */
#define TCPWM1_GRP2_CNT7                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[2].CNT[7])                    /* 0x40590380 */
#define TCPWM1_GRP2_CNT8                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[2].CNT[8])                    /* 0x40590400 */
#define TCPWM1_GRP2_CNT9                        ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[2].CNT[9])                    /* 0x40590480 */
#define TCPWM1_GRP2_CNT10                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[2].CNT[10])                   /* 0x40590500 */
#define TCPWM1_GRP2_CNT11                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[2].CNT[11])                   /* 0x40590580 */
#define TCPWM1_GRP2_CNT12                       ((TCPWM_GRP_CNT_Type*) &TCPWM1->GRP[2].CNT[12])                   /* 0x40590600 */
...
#define CANFD0_CH4                              ((CANFD_CH_Type*) &CANFD0->CH[4])                                 /* 0x40520800 */
...
#define CANFD1_CH4                              ((CANFD_CH_Type*) &CANFD1->CH[4])                                 /* 0x40540800 */
...
#define CANFD0_CH4_M_TTCAN                      ((CANFD_CH_M_TTCAN_Type*) &CANFD0->CH[4].M_TTCAN)                 /* 0x40520800 */
...
#define PASS0_SAR2_CH8                          ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[8])                        /* 0x40902A00 */
#define PASS0_SAR2_CH9                          ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[9])                        /* 0x40902A40 */
#define PASS0_SAR2_CH10                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[10])                       /* 0x40902A80 */
#define PASS0_SAR2_CH11                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[11])                       /* 0x40902AC0 */
#define PASS0_SAR2_CH12                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[12])                       /* 0x40902B00 */
#define PASS0_SAR2_CH13                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[13])                       /* 0x40902B40 */
#define PASS0_SAR2_CH14                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[14])                       /* 0x40902B80 */
#define PASS0_SAR2_CH15                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[15])                       /* 0x40902BC0 */
#define PASS0_SAR2_CH16                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[16])                       /* 0x40902C00 */
#define PASS0_SAR2_CH17                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[17])                       /* 0x40902C40 */
#define PASS0_SAR2_CH18                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[18])                       /* 0x40902C80 */
#define PASS0_SAR2_CH19                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[19])                       /* 0x40902CC0 */
#define PASS0_SAR2_CH20                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[20])                       /* 0x40902D00 */
#define PASS0_SAR2_CH21                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[21])                       /* 0x40902D40 */
#define PASS0_SAR2_CH22                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[22])                       /* 0x40902D80 */
#define PASS0_SAR2_CH23                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[23])                       /* 0x40902DC0 */
#define PASS0_SAR2_CH24                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[24])                       /* 0x40902E00 */
#define PASS0_SAR2_CH25                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[25])                       /* 0x40902E40 */
#define PASS0_SAR2_CH26                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[26])                       /* 0x40902E80 */
#define PASS0_SAR2_CH27                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[27])                       /* 0x40902EC0 */
#define PASS0_SAR2_CH28                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[28])                       /* 0x40902F00 */
#define PASS0_SAR2_CH29                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[29])                       /* 0x40902F40 */
#define PASS0_SAR2_CH30                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[30])                       /* 0x40902F80 */
#define PASS0_SAR2_CH31                         ((PASS_SAR_CH_Type*) &PASS0->SAR[2].CH[31])                       /* 0x40902FC0 */
#define PASS0_EPASS_MMIO                        ((PASS_EPASS_MMIO_Type*) &PASS0->EPASS_MMIO)                      /* 0x409F0000 */

/** \} XMC7200D-E272K8384 */

#endif /* _XMC7200D_E272K8384_H_ */

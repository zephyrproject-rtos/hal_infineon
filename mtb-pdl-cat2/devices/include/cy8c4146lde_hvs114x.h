/***************************************************************************//**
* \file cy8c4146lde_hvs114x.h
*
* \brief
* CY8C4146LDE-HVS114X device header
*
********************************************************************************
* \copyright
...
#ifndef _CY8C4146LDE_HVS114X_H_
#define _CY8C4146LDE_HVS114X_H_

/**
* \addtogroup group_device CY8C4146LDE-HVS114X
* \{
*/
...
typedef enum {
  ...
  /* CY8C4146LDE-HVS114X Peripheral Interrupt Numbers */
  ...
  ioss_interrupts_gpio_3_IRQn       =   6,      /*!<   6 [DeepSleep] GPIO P3 */
  ioss_interrupts_gpio_4_IRQn       =   7,      /*!<   7 [DeepSleep] GPIO P4 */
  ioss_interrupts_gpio_5_IRQn       =   8,      /*!<   8 [DeepSleep] GPIO P5 */
  ioss_interrupts_gpio_6_IRQn       =   9,      /*!<   9 [DeepSleep] GPIO P6 */
  ioss_interrupts_gpio_7_IRQn       =  10,      /*!<  10 [DeepSleep] GPIO P7 */
  hvss_interrupt_hvss_IRQn          =  11,      /*!<  11 [DeepSleep] HVSS interface interrupt */
  lpcomp_0_interrupt_IRQn           =  12,      /*!<  12 [DeepSleep] LPCOMP#0 trigger interrupt */
  lpcomp_1_interrupt_IRQn           =  13,      /*!<  13 [DeepSleep] LPCOMP#1 trigger interrupt */
  scb_0_interrupt_IRQn              =  14,      /*!<  14 [DeepSleep] SCB #0 interrupt */
  scb_1_interrupt_IRQn              =  15,      /*!<  15 [DeepSleep] SCB #1 interrupt */
  cpuss_interrupt_dma_IRQn          =  16,      /*!<  16 [Active] DMA Interrupt */
  cpuss_interrupt_spcif_IRQn        =  17,      /*!<  17 [Active] SPCIF interrupt */
  cpuss_interrupt_fault_0_IRQn      =  18,      /*!<  18 [Active] Fault structure 0 interrupt */
  cpuss_interrupt_fault_1_IRQn      =  19,      /*!<  19 [Active] Fault structure 1 interrupt */
  lin_interrupts_0_IRQn             =  20,      /*!<  20 [Active] LIN interrupt, channel #0 */
  lin_interrupts_1_IRQn             =  21,      /*!<  21 [Active] LIN interrupt, channel #1 */
  tcpwm_interrupts_0_IRQn           =  22,      /*!<  22 [Active] TCPWM #0, Counter #0 */
  tcpwm_interrupts_1_IRQn           =  23,      /*!<  23 [Active] TCPWM #0, Counter #1 */
  tcpwm_interrupts_2_IRQn           =  24,      /*!<  24 [Active] TCPWM #0, Counter #2 */
  tcpwm_interrupts_3_IRQn           =  25,      /*!<  25 [Active] TCPWM #0, Counter #3 */
  tcpwm_interrupts_4_IRQn           =  26,      /*!<  26 [Active] TCPWM #0, Counter #4 */
  pass_0_interrupt_sar_IRQn         =  27,      /*!<  27 [Active] SAR */
  msc_0_interrupt_IRQn              =  28,      /*!<  28 [Active] CSD */
  cxpi_interrupts_0_IRQn            =  29,      /*!<  29 [Active] CXPI interrupt, channel #0 */
  cxpi_interrupts_1_IRQn            =  30,      /*!<  30 [Active] CXPI interrupt, channel #1 */
...
#define CY_DEVICE_PSOC4HVMS64K
#define CY_DEVICE_SERIES_PSOC_4_HV_MS_64K
#define CY_SILICON_ID                   0x394311C9UL
#define CY_HF_CLK_MAX_FREQ              48000000UL


#include "system_cat2.h"

#include "psoc4hvms64k_config.h"
#include "gpio_psoc4hvms64k_48_qfn.h"

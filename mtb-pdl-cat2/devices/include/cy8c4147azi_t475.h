/***************************************************************************//**
* \file cy8c4147azi_t475.h
*
* \brief
* CY8C4147AZI-T475 device header
*
********************************************************************************
* \copyright
...
#ifndef _CY8C4147AZI_T475_H_
#define _CY8C4147AZI_T475_H_

/**
* \addtogroup group_device CY8C4147AZI-T475
* \{
*/
...
typedef enum {
  ...
  /* CY8C4147AZI-T475 Peripheral Interrupt Numbers */
  ...
  scb_2_interrupt_IRQn              =   8,      /*!<   8 [DeepSleep] SCB #2 */
  scb_3_interrupt_IRQn              =   9,      /*!<   9 [DeepSleep] SCB #3 */
  scb_4_interrupt_IRQn              =  10,      /*!<  10 [DeepSleep] SCB #4 */
  wco_interrupt_IRQn                =  11,      /*!<  11 [DeepSleep] WCO WDT Interrupt */
  msclp_interrupt_lp_IRQn           =  12,      /*!<  12 [DeepSleep] MSCv3LP interrupt */
  msclp_interrupt_IRQn              =  13,      /*!<  13 [Active] MSCv3 Interrupt */
  cpuss_interrupt_dma_IRQn          =  14,      /*!<  14 [Active] DMA Interrupt */
  cpuss_interrupt_spcif_IRQn        =  15,      /*!<  15 [Active] SPCIF interrupt */
  tcpwm_interrupts_0_IRQn           =  16,      /*!<  16 [Active] TCPWM #0, Counter #0 */
  tcpwm_interrupts_1_IRQn           =  17,      /*!<  17 [Active] TCPWM #0, Counter #1 */
  tcpwm_interrupts_2_IRQn           =  18,      /*!<  18 [Active] TCPWM #0, Counter #2 */
  tcpwm_interrupts_3_IRQn           =  19,      /*!<  19 [Active] TCPWM #0, Counter #3 */
  tcpwm_interrupts_4_IRQn           =  20,      /*!<  20 [Active] TCPWM #0, Counter #4 */
  tcpwm_interrupts_5_IRQn           =  21,      /*!<  21 [Active] TCPWM #0, Counter #5 */
  pass_0_interrupt_sar_IRQn         =  22,      /*!<  22 [Active] SAR */
...
#define CY_IP_M0S8IOSS_SMARTIO_INSTANCES 1u
...
#define CY_DEVICE_PSOC4NEXT
#define CY_DEVICE_SERIES_PSOC_4100T_PLUS
#define CY_SILICON_ID                   0x402311D0UL
#define CY_HF_CLK_MAX_FREQ              48000000UL


#include "system_cat2.h"

#include "psoc4100tp_config.h"
#include "gpio_psoc4100tp_64_tqfp.h"

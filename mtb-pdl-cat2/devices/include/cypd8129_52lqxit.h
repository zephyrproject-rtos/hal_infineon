/***************************************************************************//**
* \file cypd8129_52lqxit.h
*
* \brief
* CYPD8129-52LQXIT device header
*
********************************************************************************
* \copyright
...
#ifndef _CYPD8129_52LQXIT_H_
#define _CYPD8129_52LQXIT_H_

/**
* \addtogroup group_device CYPD8129-52LQXIT
* \{
*/
...
typedef enum {
  ...
  /* CYPD8129-52LQXIT Peripheral Interrupt Numbers */
  ...
  ioss_interrupts_gpio_4_IRQn       =   4,      /*!<   4 [DeepSleep] GPIO P4 */
  ioss_interrupt_gpio_IRQn          =   5,      /*!<   5 [DeepSleep] GPIO All ports */
  usbpd_0_interrupt_wakeup_IRQn     =   6,      /*!<   6 [DeepSleep] Ganged USBPD[0] Interrupt */
  usbpd_1_interrupt_wakeup_IRQn     =   7,      /*!<   7 [DeepSleep] Ganged USBPD[1] Interrupt */
  srss_interrupt_wdt_IRQn           =   8,      /*!<   8 [DeepSleep] WDT or Temp (WDT only in DeepSleep) */
  scb_0_interrupt_IRQn              =   9,      /*!<   9 [DeepSleep] SCB[0] */
  scb_1_interrupt_IRQn              =  10,      /*!<  10 [DeepSleep] SCB[1] */
  scb_2_interrupt_IRQn              =  11,      /*!<  11 [DeepSleep] SCB[2] */
  ...
  cpuss_interrupt_dma_IRQn          =  18,      /*!<  18 [Active] DMA Interrupt */
  cpuss_interrupt_fpu_IRQn          =  19,      /*!<  19 [Active] FPU Interrupt */
...
#define CY_IP_M0S8CPUSSV3_VERSION       6u
#define CY_IP_M0S8CPUSSV3_DMAC          1u
#define CY_IP_M0S8CPUSSV3_DMAC_INSTANCES 1u
#define CY_IP_M0S8CPUSSV3_DMAC_VERSION  6u
...
#define CY_IP_M0S8IOSS_VERSION          2u
...
#define CY_IP_MXUSBPD_VERSION           3u

#define CY_DEVICE_CCG6DF_CFP
#define CY_DEVICE_SERIES_CCG8DF_CFP
#define CY_SILICON_ID                   0x3E8011CEUL
#define CY_HF_CLK_MAX_FREQ              48000000UL


#include "system_cat2.h"

#include "ccg6df_cfp_config.h"
#include "gpio_ccg6df_cfp_52_qfn_1_port_sw.h"
...
#define CRYPTOLITE_BASE                         0x400C0000UL
#define CRYPTOLITE                              ((CRYPTOLITE_Type*) CRYPTOLITE_BASE)                              /* 0x400C0000 */
...
#define FPU_BASE                                0x40130000UL
#define FPU                                     ((FPU_Type*) FPU_BASE)                                            /* 0x40130000 */

/** \} CYPD8129-52LQXIT */

#endif /* _CYPD8129_52LQXIT_H_ */

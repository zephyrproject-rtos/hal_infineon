/***************************************************************************//**
* \file cypm1111_40lqxit.h
*
* \brief
* CYPM1111-40LQXIT device header
*
********************************************************************************
* \copyright
...
#ifndef _CYPM1111_40LQXIT_H_
#define _CYPM1111_40LQXIT_H_

/**
* \addtogroup group_device CYPM1111-40LQXIT
* \{
*/
...
typedef enum {
  ...
  /* CYPM1111-40LQXIT Peripheral Interrupt Numbers */
  ...
  ioss_interrupts_gpio_5_IRQn       =   5,      /*!<   5 [DeepSleep] GPIO P5 */
  ioss_interrupt_gpio_IRQn          =   6,      /*!<   6 [DeepSleep] GPIO All ports */
  usbpd_0_interrupt_wakeup_IRQn     =   7,      /*!<   7 [DeepSleep] Ganged USBPD Interrupt */
  ...
  scb_3_interrupt_IRQn              =  12,      /*!<  12 [DeepSleep] SCB[3] */
  cpuss_interrupt_spcif_IRQn        =  13,      /*!<  13 [Active] SPC */
  usbpd_0_interrupt_IRQn            =  14,      /*!<  14 [Active] Synchronous USBPD Interrupts */
  tcpwm_interrupts_0_IRQn           =  15,      /*!<  15 [Active] TCPWM counter #0 */
  tcpwm_interrupts_1_IRQn           =  16,      /*!<  16 [Active] TCPWM counter #1 */
  crypto_interrupt_IRQn             =  17,      /*!<  17 [Active] Crypto block */
...
#define CY_SRAM_SIZE                    0x00003000UL
...
#define CY_DEVICE_CCG6
#define CY_DEVICE_SERIES_PMG1S1
#define CY_SILICON_ID                   0x2A2011BAUL
#define CY_HF_CLK_MAX_FREQ              48000000UL


#include "system_cat2.h"

#include "pmg1s1_config.h"
#include "gpio_pmg1s1_40_qfn_pmg1_s1.h"

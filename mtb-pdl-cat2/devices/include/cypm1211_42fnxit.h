/***************************************************************************//**
* \file cypm1211_42fnxit.h
*
* \brief
* CYPM1211-42FNXIT device header
*
********************************************************************************
* \copyright
...
#ifndef _CYPM1211_42FNXIT_H_
#define _CYPM1211_42FNXIT_H_

/**
* \addtogroup group_device CYPM1211-42FNXIT
* \{
*/
...
typedef enum {
  ...
  /* CYPM1211-42FNXIT Peripheral Interrupt Numbers */
  ...
  ioss_interrupts_gpio_4_IRQn       =   4,      /*!<   4 [DeepSleep] GPIO P4 USB Wakeup */
  ioss_interrupt_gpio_IRQn          =   5,      /*!<   5 [DeepSleep] GPIO All ports */
  usbpd_0_interrupt_wakeup_IRQn     =   6,      /*!<   6 [DeepSleep] Ganged USBPD Interrupt */
  ...
  usbpd_0_interrupt_IRQn            =  13,      /*!<  13 [Active] Synchronous USBPD Interrupts */
  tcpwm_interrupts_0_IRQn           =  14,      /*!<  14 [Active] TCPWM counter #0 */
  tcpwm_interrupts_1_IRQn           =  15,      /*!<  15 [Active] TCPWM counter #1 */
  tcpwm_interrupts_2_IRQn           =  16,      /*!<  16 [Active] TCPWM counter #2 */
  tcpwm_interrupts_3_IRQn           =  17,      /*!<  17 [Active] TCPWM counter #3 */
  usb_interrupt_hi_IRQn             =  18,      /*!<  18 [Active] USB Start of Frame */
  usb_interrupt_med_IRQn            =  19,      /*!<  19 [Active] USB EP1-EP8 data */
  usb_interrupt_lo_IRQn             =  20,      /*!<  20 [Active] USB EP1-EP8 data */
  crypto_interrupt_IRQn             =  21,      /*!<  21 [Active] Crypto block */
...
#define CY_IP_M0S8USBPD                 1u
#define CY_IP_M0S8USBPD_INSTANCES       1u
#define CY_IP_M0S8USBPD_VERSION         2u

#define CY_DEVICE_CCG3
#define CY_DEVICE_SERIES_PMG1S2
#define CY_SILICON_ID                   0x1D2111ADUL
#define CY_HF_CLK_MAX_FREQ              48000000UL


#include "system_cat2.h"

#include "pmg1s2_config.h"
#include "gpio_pmg1s2_42_csp_pmg1_s2.h"
...
#define CRYPTO_BASE                             0x400B0000UL

...
#ifndef _CYPM1322_97BZXIT_H_
#define _CYPM1322_97BZXIT_H_

/**
* \addtogroup group_device CYPM1322-97BZXIT
* \{
*/
...
typedef enum {
  ...
  /* CYPM1322-97BZXIT Peripheral Interrupt Numbers */

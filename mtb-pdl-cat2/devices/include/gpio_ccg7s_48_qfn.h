/***************************************************************************//**
* \file gpio_ccg7s_48_qfn.h
*
* \brief
* CCG7S device GPIO header for 48-QFN package
*
********************************************************************************
* \copyright
...
#ifndef _GPIO_CCG7S_48_QFN_H_
#define _GPIO_CCG7S_48_QFN_H_
...
#define PASS0_SARMUX_PADS5_PORT         1u
#define PASS0_SARMUX_PADS5_PIN          5u
#define PASS0_SARMUX_PADS6_PORT         1u
#define PASS0_SARMUX_PADS6_PIN          6u
#define PASS0_SARMUX_PADS7_PORT         1u
...
typedef enum
{
    ...
    P0_6_TCPWM_LINE0                =  8,       /* Digital Active - tcpwm.line[0]:1 */
    P0_6_TCPWM_TR_COMPARE_MATCH0    =  9,       /* Digital Active - tcpwm.tr_compare_match[0]:1 */
    P0_6_PASS0_DSI_SAR_DATA9        = 11,       /* Digital Active - pass[0].dsi_sar_data[9] */
    P0_6_TCPWM_TR_IN3               = 12,       /* Digital Deep Sleep - tcpwm.tr_in[3] */
    P0_6_PASS0_DSI_SAR_DATA_VALID   = 13,       /* Digital Deep Sleep - pass[0].dsi_sar_data_valid */

    /* P0.7 */
    P0_7_GPIO                       =  0,       /* SW controlled GPIO. */
    P0_7_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P0_7_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P0_7_TCPWM_LINE1                =  8,       /* Digital Active - tcpwm.line[1]:1 */
    P0_7_TCPWM_TR_COMPARE_MATCH1    =  9,       /* Digital Active - tcpwm.tr_compare_match[1]:1 */
    P0_7_PASS0_DSI_SAR_DATA8        = 11,       /* Digital Active - pass[0].dsi_sar_data[8] */
    P0_7_TCPWM_TR_IN4               = 12,       /* Digital Deep Sleep - tcpwm.tr_in[4] */
    P0_7_PASS0_DSI_SAR_SAMPLE_DONE  = 13,       /* Digital Deep Sleep - pass[0].dsi_sar_sample_done */
    ...
    P1_5_TCPWM_LINE3                =  8,       /* Digital Active - tcpwm.line[3]:1 */
    P1_5_TCPWM_TR_COMPARE_MATCH3    =  9,       /* Digital Active - tcpwm.tr_compare_match[3]:1 */
    P1_5_SCB2_UART_TX               = 10,       /* Digital Active - scb[2].uart_tx:0 */
    P1_5_PASS0_DSI_SAR_DATA6        = 11,       /* Digital Active - pass[0].dsi_sar_data[6] */
    P1_5_USBPD0_EXT_HS1             = 13,       /* Digital Deep Sleep - usbpd[0].ext_hs1:1 */

    /* P1.6 */
    P1_6_GPIO                       =  0,       /* SW controlled GPIO. */
    P1_6_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P1_6_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P1_6_TCPWM_LINE4                =  8,       /* Digital Active - tcpwm.line[4]:1 */
    P1_6_TCPWM_TR_COMPARE_MATCH4    =  9,       /* Digital Active - tcpwm.tr_compare_match[4]:1 */
    P1_6_SCB2_UART_RX               = 10,       /* Digital Active - scb[2].uart_rx:0 */
    P1_6_PASS0_DSI_SAR_DATA5        = 11,       /* Digital Active - pass[0].dsi_sar_data[5] */
    P1_6_USBPD0_EXT_LS1             = 13,       /* Digital Deep Sleep - usbpd[0].ext_ls1:1 */

    /* P1.7 */
    P1_7_GPIO                       =  0,       /* SW controlled GPIO. */
    P1_7_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P1_7_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P1_7_TCPWM_LINE5                =  8,       /* Digital Active - tcpwm.line[5]:1 */
    P1_7_TCPWM_TR_COMPARE_MATCH5    =  9,       /* Digital Active - tcpwm.tr_compare_match[5]:1 */
    P1_7_SCB2_UART_RTS              = 10,       /* Digital Active - scb[2].uart_rts:0 */
    P1_7_PASS0_DSI_SAR_DATA4        = 11,       /* Digital Active - pass[0].dsi_sar_data[4] */
    P1_7_USBPD0_EXT_HS2             = 13,       /* Digital Deep Sleep - usbpd[0].ext_hs2:1 */

    /* P2.0 */
    P2_0_GPIO                       =  0,       /* SW controlled GPIO. */
    P2_0_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P2_0_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P2_0_TCPWM_LINE2                =  8,       /* Digital Active - tcpwm.line[2]:1 */
    P2_0_TCPWM_TR_COMPARE_MATCH2    =  9,       /* Digital Active - tcpwm.tr_compare_match[2]:1 */
    P2_0_PASS0_DSI_SAR_DATA7        = 11,       /* Digital Active - pass[0].dsi_sar_data[7] */
    P2_0_TCPWM_TR_IN5               = 12,       /* Digital Deep Sleep - tcpwm.tr_in[5] */
    P2_0_PASS0_TR_SAR_OUT           = 13,       /* Digital Deep Sleep - pass[0].tr_sar_out */

    /* P2.1 */
    P2_1_GPIO                       =  0,       /* SW controlled GPIO. */
    P2_1_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P2_1_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P2_1_TCPWM_LINE6                =  8,       /* Digital Active - tcpwm.line[6]:1 */
    P2_1_TCPWM_TR_COMPARE_MATCH6    =  9,       /* Digital Active - tcpwm.tr_compare_match[6]:1 */
    P2_1_SCB2_UART_CTS              = 10,       /* Digital Active - scb[2].uart_cts:0 */
    P2_1_PASS0_DSI_SAR_DATA3        = 11,       /* Digital Active - pass[0].dsi_sar_data[3] */
    P2_1_USBPD0_EXT_LS2             = 13,       /* Digital Deep Sleep - usbpd[0].ext_ls2:1 */
    ...
    P2_3_TCPWM_LINE7                =  8,       /* Digital Active - tcpwm.line[7]:1 */
    P2_3_TCPWM_TR_COMPARE_MATCH7    =  9,       /* Digital Active - tcpwm.tr_compare_match[7]:1 */

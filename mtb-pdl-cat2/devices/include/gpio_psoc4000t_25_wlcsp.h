...
#ifndef _GPIO_PSOC4000T_25_WLCSP_H_
#define _GPIO_PSOC4000T_25_WLCSP_H_
...
#define P1_0_MSCLP_MSC_GPIO_CTRL_SNS    6u
#define P2_0_MSCLP_MSC_GPIO_CTRL_SNS    7u
#define P2_1_MSCLP_MSC_GPIO_CTRL_SNS    8u
...
#define P3_0_MSCLP_MSC_GPIO_CTRL_SNS    13u
#define P3_1_MSCLP_MSC_GPIO_CTRL_SNS    14u
#define P3_2_MSCLP_MSC_GPIO_CTRL_SNS    15u
#define P3_3_MSCLP_MSC_GPIO_CTRL_SNS    16u
#define P4_0_MSCLP_MSC_GPIO_CTRL_SNS    17u
#define P4_1_MSCLP_MSC_GPIO_CTRL_SNS    18u
...
typedef enum
{
    ...
    P0_2_SCB0_UART_RX               =  9,       /* Digital Active - scb[0].uart_rx:2 */
    P0_2_MSCLP_MSC_DDRV2            = 12,       /* Digital Deep Sleep - msclp.msc_ddrv[2] */
    P0_2_SCB0_I2C_SCL               = 14,       /* Digital Deep Sleep - scb[0].i2c_scl:2 */
    P0_2_SCB0_SPI_MOSI              = 15,       /* Digital Deep Sleep - scb[0].spi_mosi:0 */
    ...
    P0_3_SCB0_UART_TX               =  9,       /* Digital Active - scb[0].uart_tx:2 */
    P0_3_MSCLP_MSC_DDRV3            = 12,       /* Digital Deep Sleep - msclp.msc_ddrv[3] */
    P0_3_SCB0_I2C_SDA               = 14,       /* Digital Deep Sleep - scb[0].i2c_sda:2 */
    P0_3_SCB0_SPI_MISO              = 15,       /* Digital Deep Sleep - scb[0].spi_miso:0 */
    ...
    P0_5_SCB0_UART_RTS              =  9,       /* Digital Active - scb[0].uart_rts:2 */
    P0_5_MSCLP_MSC_DDRV5            = 12,       /* Digital Deep Sleep - msclp.msc_ddrv[5] */
    P0_5_SCB0_SPI_SELECT0           = 15,       /* Digital Deep Sleep - scb[0].spi_select0:0 */

    /* P1.0 */
    P1_0_GPIO                       =  0,       /* SW controlled GPIO. */
    P1_0_MSCLP_SENSE                =  4,       /* msclp.sense:6 */
    P1_0_MSCLP_SHIELD               =  5,       /* msclp.shield:6 */
    P1_0_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P1_0_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P1_0_TCPWM_LINE1                =  8,       /* Digital Active - tcpwm.line[1]:2 */
    P1_0_TCPWM_TR_IN2               = 11,       /* Digital Active - tcpwm.tr_in[2] */
    P1_0_MSCLP_MSC_DDRV6            = 12,       /* Digital Deep Sleep - msclp.msc_ddrv[6] */
    P1_0_SCB0_SPI_SELECT3           = 15,       /* Digital Deep Sleep - scb[0].spi_select3:0 */

    /* P2.0 */
    P2_0_GPIO                       =  0,       /* SW controlled GPIO. */
    P2_0_MSCLP_SENSE                =  4,       /* msclp.sense:7 */
    P2_0_MSCLP_SHIELD               =  5,       /* msclp.shield:7 */
    P2_0_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P2_0_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P2_0_TCPWM_LINE_COMPL1          =  8,       /* Digital Active - tcpwm.line_compl[1]:2 */
    P2_0_TCPWM_TR_IN3               = 11,       /* Digital Active - tcpwm.tr_in[3] */
    P2_0_MSCLP_MSC_DDRV7            = 12,       /* Digital Deep Sleep - msclp.msc_ddrv[7] */
    P2_0_MSCLP_OBS_DATA3            = 13,       /* Digital Deep Sleep - msclp.obs_data[3] */

    /* P2.1 */
    P2_1_GPIO                       =  0,       /* SW controlled GPIO. */
    P2_1_MSCLP_SENSE                =  4,       /* msclp.sense:8 */
    P2_1_MSCLP_SHIELD               =  5,       /* msclp.shield:8 */
    P2_1_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P2_1_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P2_1_MSCLP_MSC_DDRV8            = 12,       /* Digital Deep Sleep - msclp.msc_ddrv[8] */
    ...
    P3_0_MSCLP_SENSE                =  4,       /* msclp.sense:13 */
    P3_0_MSCLP_SHIELD               =  5,       /* msclp.shield:13 */
    P3_0_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P3_0_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P3_0_TCPWM_LINE0                =  8,       /* Digital Active - tcpwm.line[0]:0 */
    P3_0_SCB0_UART_RX               =  9,       /* Digital Active - scb[0].uart_rx:1 */
    P3_0_MSCLP_MSC_DDRV13           = 12,       /* Digital Deep Sleep - msclp.msc_ddrv[13] */
    P3_0_MSCLP_EXT_FRM_START        = 13,       /* Digital Deep Sleep - msclp.ext_frm_start:1 */
    P3_0_SCB0_I2C_SCL               = 14,       /* Digital Deep Sleep - scb[0].i2c_scl:1 */
    P3_0_SCB0_SPI_MOSI              = 15,       /* Digital Deep Sleep - scb[0].spi_mosi:1 */

    /* P3.1 */
    P3_1_GPIO                       =  0,       /* SW controlled GPIO. */
    P3_1_MSCLP_SENSE                =  4,       /* msclp.sense:14 */
    P3_1_MSCLP_SHIELD               =  5,       /* msclp.shield:14 */
    ...
    P3_1_SCB0_UART_TX               =  9,       /* Digital Active - scb[0].uart_tx:1 */
    P3_1_MSCLP_MSC_DDRV14           = 12,       /* Digital Deep Sleep - msclp.msc_ddrv[14] */
    P3_1_SCB0_I2C_SDA               = 14,       /* Digital Deep Sleep - scb[0].i2c_sda:1 */
    P3_1_SCB0_SPI_MISO              = 15,       /* Digital Deep Sleep - scb[0].spi_miso:1 */
    ...
    P4_0_MSCLP_SENSE                =  4,       /* msclp.sense:17 */
    P4_0_MSCLP_SHIELD               =  5,       /* msclp.shield:17 */
    P4_0_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P4_0_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P4_0_SCB0_UART_RX               =  9,       /* Digital Active - scb[0].uart_rx:0 */
    P4_0_TCPWM_TR_IN6               = 11,       /* Digital Active - tcpwm.tr_in[6] */
    P4_0_MSCLP_MSC_DDRV17           = 12,       /* Digital Deep Sleep - msclp.msc_ddrv[17] */
    P4_0_SCB0_I2C_SCL               = 14,       /* Digital Deep Sleep - scb[0].i2c_scl:0 */
    P4_0_SCB0_SPI_MOSI              = 15,       /* Digital Deep Sleep - scb[0].spi_mosi:2 */

    /* P4.1 */
    P4_1_GPIO                       =  0,       /* SW controlled GPIO. */
    P4_1_MSCLP_SENSE                =  4,       /* msclp.sense:18 */
    P4_1_MSCLP_SHIELD               =  5,       /* msclp.shield:18 */
    P4_1_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P4_1_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P4_1_SCB0_UART_TX               =  9,       /* Digital Active - scb[0].uart_tx:0 */
    P4_1_MSCLP_MSC_DDRV18           = 12,       /* Digital Deep Sleep - msclp.msc_ddrv[18] */
    P4_1_SCB0_I2C_SDA               = 14,       /* Digital Deep Sleep - scb[0].i2c_sda:0 */
    P4_1_SCB0_SPI_MISO              = 15,       /* Digital Deep Sleep - scb[0].spi_miso:2 */
...
#endif /* _GPIO_PSOC4000T_25_WLCSP_H_ */

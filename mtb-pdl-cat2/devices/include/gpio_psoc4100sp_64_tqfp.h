/***************************************************************************//**
* \file gpio_psoc4100sp_64_tqfp.h
*
* \brief
* PSOC4100Sp device GPIO header for 64-TQFP package
*
********************************************************************************
* \copyright
...
#ifndef _GPIO_PSOC4100SP_64_TQFP_H_
#define _GPIO_PSOC4100SP_64_TQFP_H_
...
#define P6_0_PIN                        0u
#define P6_0_NUM                        0u
#define P6_0_AMUXSEGMENT                AMUXBUS_CSD
#define P6_1_PORT                       GPIO_PRT6
#define P6_1_PIN                        1u
#define P6_1_NUM                        1u
#define P6_1_AMUXSEGMENT                AMUXBUS_CSD
#define P6_2_PORT                       GPIO_PRT6
#define P6_2_PIN                        2u
#define P6_2_NUM                        2u
#define P6_2_AMUXSEGMENT                AMUXBUS_CSD
#define P6_4_PORT                       GPIO_PRT6
#define P6_4_PIN                        4u
#define P6_4_NUM                        4u
#define P6_4_AMUXSEGMENT                AMUXBUS_CSD
#define P6_5_PORT                       GPIO_PRT6
#define P6_5_PIN                        5u
#define P6_5_NUM                        5u
#define P6_5_AMUXSEGMENT                AMUXBUS_CSD
...
typedef enum
{
    ...
    P6_0_CAN_CAN_TX_ENB_N           = 11,       /* Digital Active - can.can_tx_enb_n:0 */
    ...
    P6_1_CAN_CAN_RX                 = 11,       /* Digital Active - can.can_rx:0 */
    ...
    P6_2_CAN_CAN_TX                 = 11,       /* Digital Active - can.can_tx:0 */
...
#endif /* _GPIO_PSOC4100SP_64_TQFP_H_ */

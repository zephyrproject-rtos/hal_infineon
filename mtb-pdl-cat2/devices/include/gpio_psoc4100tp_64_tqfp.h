/***************************************************************************//**
* \file gpio_psoc4100tp_64_tqfp.h
*
* \brief
* PSOC4100Tp device GPIO header for 64-TQFP package
*
********************************************************************************
* \copyright
...
#ifndef _GPIO_PSOC4100TP_64_TQFP_H_
#define _GPIO_PSOC4100TP_64_TQFP_H_
...
#define P3_4_PIN                        4u
#define P3_4_NUM                        4u
#define P3_4_AMUXSEGMENT                AMUXBUS_MSC
#define P3_5_PORT                       GPIO_PRT3
#define P3_5_PIN                        5u
#define P3_5_NUM                        5u
#define P3_5_AMUXSEGMENT                AMUXBUS_MSC
#define P3_6_PORT                       GPIO_PRT3
#define P3_6_PIN                        6u
#define P3_6_NUM                        6u
#define P3_6_AMUXSEGMENT                AMUXBUS_MSC
#define P3_7_PORT                       GPIO_PRT3
#define P3_7_PIN                        7u
#define P3_7_NUM                        7u
#define P3_7_AMUXSEGMENT                AMUXBUS_MSC
...
#define P6_3_PIN                        3u
#define P6_3_NUM                        3u
#define P6_3_AMUXSEGMENT                AMUXBUS_MSC
#define P6_4_PORT                       GPIO_PRT6
#define P6_4_PIN                        4u
#define P6_4_NUM                        4u
#define P6_4_AMUXSEGMENT                AMUXBUS_MSC
...
typedef enum
{
    ...
    P3_0_SCB3_UART_CTS              =  9,       /* Digital Active - scb[3].uart_cts:0 */
    P3_0_SCB0_SPI_SELECT0           = 15,       /* Digital Deep Sleep - scb[0].spi_select0:2 */
    ...
    P4_7_TCPWM_LINE_COMPL4          =  8,       /* Digital Active - tcpwm.line_compl[4]:1 */
    ...
    P5_5_TCPWM_LINE1                =  8,       /* Digital Active - tcpwm.line[1]:2 */
    P5_5_SCB1_SPI_SELECT1           = 15,       /* Digital Deep Sleep - scb[1].spi_select1:2 */

    /* P5.6 */
    P5_6_GPIO                       =  0,       /* SW controlled GPIO. */
    P5_6_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P5_6_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P5_6_TCPWM_LINE_COMPL1          =  8,       /* Digital Active - tcpwm.line_compl[1]:2 */
    P5_6_SCB1_SPI_SELECT2           = 15,       /* Digital Deep Sleep - scb[1].spi_select2:1 */

    /* P5.7 */
    P5_7_GPIO                       =  0,       /* SW controlled GPIO. */
    P5_7_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P5_7_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P5_7_SCB1_SPI_SELECT3           = 15,       /* Digital Deep Sleep - scb[1].spi_select3:1 */

    /* P6.0 */
    P6_0_GPIO                       =  0,       /* SW controlled GPIO. */
    P6_0_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P6_0_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P6_0_TCPWM_LINE2                =  8,       /* Digital Active - tcpwm.line[2]:2 */
    P6_0_SCB1_UART_RX               =  9,       /* Digital Active - scb[1].uart_rx:1 */
    P6_0_TCPWM_TR_IN4               = 11,       /* Digital Active - tcpwm.tr_in[4]:2 */
    P6_0_SCB0_I2C_SCL               = 14,       /* Digital Deep Sleep - scb[0].i2c_scl:3 */
    P6_0_SCB0_SPI_SELECT0           = 15,       /* Digital Deep Sleep - scb[0].spi_select0:3 */

    /* P6.1 */
    P6_1_GPIO                       =  0,       /* SW controlled GPIO. */
    P6_1_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P6_1_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P6_1_TCPWM_LINE_COMPL2          =  8,       /* Digital Active - tcpwm.line_compl[2]:2 */
    P6_1_SCB1_UART_TX               =  9,       /* Digital Active - scb[1].uart_tx:1 */
    P6_1_TCPWM_TR_IN5               = 11,       /* Digital Active - tcpwm.tr_in[5]:2 */
    P6_1_SCB0_I2C_SDA               = 14,       /* Digital Deep Sleep - scb[0].i2c_sda:3 */
    P6_1_SCB0_SPI_SELECT1           = 15,       /* Digital Deep Sleep - scb[0].spi_select1:3 */

    /* P6.2 */
    P6_2_GPIO                       =  0,       /* SW controlled GPIO. */
    P6_2_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P6_2_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P6_2_TCPWM_LINE3                =  8,       /* Digital Active - tcpwm.line[3]:2 */
    P6_2_SCB1_UART_CTS              =  9,       /* Digital Active - scb[1].uart_cts:1 */
    P6_2_TCPWM_TR_IN6               = 11,       /* Digital Active - tcpwm.tr_in[6]:2 */
    P6_2_SCB0_SPI_MOSI              = 15,       /* Digital Deep Sleep - scb[0].spi_mosi:3 */

    /* P6.3 */
    P6_3_GPIO                       =  0,       /* SW controlled GPIO. */
    P6_3_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P6_3_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P6_3_TCPWM_LINE_COMPL3          =  8,       /* Digital Active - tcpwm.line_compl[3]:2 */
    P6_3_SCB1_UART_RTS              =  9,       /* Digital Active - scb[1].uart_rts:1 */
    P6_3_SCB1_I2C_SCL               = 14,       /* Digital Deep Sleep - scb[1].i2c_scl:3 */
    P6_3_SCB0_SPI_MISO              = 15,       /* Digital Deep Sleep - scb[0].spi_miso:3 */

    /* P6.4 */
    P6_4_GPIO                       =  0,       /* SW controlled GPIO. */
    P6_4_AMUXA                      =  6,       /* AMUXBUS A connection. */
    P6_4_AMUXB                      =  7,       /* AMUXBUS B connection. */
    P6_4_TCPWM_LINE4                =  8,       /* Digital Active - tcpwm.line[4]:2 */
    P6_4_SCB1_I2C_SDA               = 14,       /* Digital Deep Sleep - scb[1].i2c_sda:3 */
    P6_4_SCB0_SPI_CLK               = 15        /* Digital Deep Sleep - scb[0].spi_clk:3 */
} en_hsiom_sel_t;

#endif /* _GPIO_PSOC4100TP_64_TQFP_H_ */

/***************************************************************************//**
* \file gpio_psoc4hvms64k_56_qfn.h
*
* \brief
* PSOC4HVMS64K device GPIO header for 56-QFN package
*
********************************************************************************
* \copyright
...
#ifndef _GPIO_PSOC4HVMS64K_56_QFN_H_
#define _GPIO_PSOC4HVMS64K_56_QFN_H_
...
typedef enum
{
    ...
    P0_4_MSC0_SENSE                 =  4,       /* msc[0].sense:27 */
    P0_4_MSC0_SHIELD                =  5,       /* msc[0].shield:27 */
    ...
    P0_5_MSC0_SENSE                 =  4,       /* msc[0].sense:26 */
    P0_5_MSC0_SHIELD                =  5,       /* msc[0].shield:26 */
    ...
    P0_6_MSC0_SENSE                 =  4,       /* msc[0].sense:25 */
    P0_6_MSC0_SHIELD                =  5,       /* msc[0].shield:25 */
    ...
    P0_7_MSC0_SENSE                 =  4,       /* msc[0].sense:24 */
    P0_7_MSC0_SHIELD                =  5,       /* msc[0].shield:24 */
    ...
    P3_1_LPCOMP1_COMP0              = 13,       /* Digital Deep Sleep - lpcomp[1].comp[0]:2 */
    ...
    P3_2_LPCOMP1_COMP1              = 13,       /* Digital Deep Sleep - lpcomp[1].comp[1]:2 */
    ...
    P4_3_MSC0_SENSE                 =  4,       /* msc[0].sense:36 */
    P4_3_MSC0_SHIELD                =  5,       /* msc[0].shield:36 */
    ...
    P4_4_MSC0_SENSE                 =  4,       /* msc[0].sense:35 */
    P4_4_MSC0_SHIELD                =  5,       /* msc[0].shield:35 */
    ...
    P4_5_MSC0_SENSE                 =  4,       /* msc[0].sense:34 */
    P4_5_MSC0_SHIELD                =  5,       /* msc[0].shield:34 */
    ...
    P4_5_LPCOMP0_COMP1              = 15,       /* Digital Deep Sleep - lpcomp[0].comp[1]:2 */

    /* P4.6 */
    P4_6_GPIO                       =  0,       /* SW controlled GPIO. */
    P4_6_MSC0_SENSE                 =  4,       /* msc[0].sense:33 */
    P4_6_MSC0_SHIELD                =  5,       /* msc[0].shield:33 */
    ...
    P4_6_LPCOMP0_COMP0              = 15,       /* Digital Deep Sleep - lpcomp[0].comp[0]:2 */

    /* P4.7 */
    P4_7_GPIO                       =  0,       /* SW controlled GPIO. */
    P4_7_MSC0_SENSE                 =  4,       /* msc[0].sense:32 */
    P4_7_MSC0_SHIELD                =  5,       /* msc[0].shield:32 */
    ...
    P6_0_MSC0_SENSE                 =  4,       /* msc[0].sense:40 */
    P6_0_MSC0_SHIELD                =  5,       /* msc[0].shield:40 */
...
#endif /* _GPIO_PSOC4HVMS64K_56_QFN_H_ */

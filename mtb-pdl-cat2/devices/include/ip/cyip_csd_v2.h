...
#ifndef _CYIP_CSD_V2_H_
#define _CYIP_CSD_V2_H_
...
typedef struct {
  ...
  __IOM uint32_t SW_HS_P_SEL1;                  /*!< 0x0000028C HSCMP Pos input switch Waveform selection 1 */
...
} CSD_Type;                                     /*!< Size = 836 (0x344) */


/* CSD.CONFIG */
#define CSD_CONFIG_LOW_VDDA_Pos                 3UL
#define CSD_CONFIG_LOW_VDDA_Msk                 0x8UL
#define CSD_CONFIG_FILTER_DELAY_Pos             4UL
#define CSD_CONFIG_FILTER_DELAY_Msk             0x70UL
#define CSD_CONFIG_SHIELD_DELAY_Pos             8UL
#define CSD_CONFIG_SHIELD_DELAY_Msk             0x300UL
#define CSD_CONFIG_SENSE_EN_Pos                 12UL
#define CSD_CONFIG_SENSE_EN_Msk                 0x1000UL
#define CSD_CONFIG_CHARGE_MODE_Pos              14UL
#define CSD_CONFIG_CHARGE_MODE_Msk              0x4000UL
...
/* CSD.STATUS */
#define CSD_STATUS_CSD_CHARGE_Pos               0UL
#define CSD_STATUS_CSD_CHARGE_Msk               0x1UL
...
/* CSD.SW_HS_P_SEL1 */
#define CSD_SW_HS_P_SEL1_SW_HMRE_Pos            0UL
#define CSD_SW_HS_P_SEL1_SW_HMRE_Msk            0x1UL
/* CSD.SW_AMUXBUF_SEL */
...
#define CSD_SW_DSI_SEL_DSI_CSH_TANK_Msk         0x7UL
#define CSD_SW_DSI_SEL_DSI_CMOD_Pos             4UL
#define CSD_SW_DSI_SEL_DSI_CMOD_Msk             0x70UL
/* CSD.SEQ_TIME */

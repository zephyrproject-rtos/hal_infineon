...
typedef struct {
  ...
  __IOM uint32_t TEST_CTL;                      /*!< 0x00000004 Test control */
   __IM uint32_t RESERVED[8190];
        CXPI_CH_Type CH[4];                     /*!< 0x00008000 CXPI channel structure */
} CXPI_Type;                                    /*!< Size = 33792 (0x8400) */
...
#define CXPI_CH_CTL0_PRESAMPLE_EN_Pos           9UL
#define CXPI_CH_CTL0_PRESAMPLE_EN_Msk           0x200UL
...
#define CXPI_CH_CTL2_RXTX_DELAY_Pos             22UL
#define CXPI_CH_CTL2_RXTX_DELAY_Msk             0x3FC00000UL

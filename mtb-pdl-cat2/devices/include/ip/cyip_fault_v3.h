...
#ifndef _CYIP_FAULT_V3_H_
#define _CYIP_FAULT_V3_H_
...
typedef struct {
  ...
  __IOM uint32_t DATA[2];                       /*!< 0x00000010 Fault data */
...
/**
  ...
  */
typedef struct {
        FAULT_STRUCT_Type STRUCT[2];            /*!< 0x00000000 Fault structure */
} FAULT_Type;                                   /*!< Size = 512 (0x200) */

...
typedef struct {
  ...
  __IOM uint32_t DFT_IO_TEST;                   /*!< 0x00001010 IO SELF TEST control register for DfT purposes only */
   __IM uint32_t RESERVED1[3];
   __IM uint32_t GPIOV1P2_DET;                  /*!< 0x00001020 GPIOV1P2 Detect output */
} GPIO_Type;                                    /*!< Size = 4132 (0x1024) */
...
/* GPIO.DFT_IO_TEST */
#define GPIO_DFT_IO_TEST_DFT_IO_TEST_MODE_Pos   0UL
#define GPIO_DFT_IO_TEST_DFT_IO_TEST_MODE_Msk   0x3UL
#define GPIO_DFT_IO_TEST_DFT_HLD_OVR_0_Pos      8UL
#define GPIO_DFT_IO_TEST_DFT_HLD_OVR_0_Msk      0x100UL
#define GPIO_DFT_IO_TEST_DFT_OE_N_0_Pos         9UL
#define GPIO_DFT_IO_TEST_DFT_OE_N_0_Msk         0x200UL
#define GPIO_DFT_IO_TEST_DFT_ANALOG_EN_0_Pos    10UL
#define GPIO_DFT_IO_TEST_DFT_ANALOG_EN_0_Msk    0x400UL
#define GPIO_DFT_IO_TEST_DFT_ANA_SEL_0_Pos      11UL
#define GPIO_DFT_IO_TEST_DFT_ANA_SEL_0_Msk      0x800UL
#define GPIO_DFT_IO_TEST_DFT_ANA_POL_0_Pos      12UL
#define GPIO_DFT_IO_TEST_DFT_ANA_POL_0_Msk      0x1000UL
#define GPIO_DFT_IO_TEST_DFT_HLD_OVR_1_Pos      16UL
#define GPIO_DFT_IO_TEST_DFT_HLD_OVR_1_Msk      0x10000UL
#define GPIO_DFT_IO_TEST_DFT_OE_N_1_Pos         17UL
#define GPIO_DFT_IO_TEST_DFT_OE_N_1_Msk         0x20000UL
#define GPIO_DFT_IO_TEST_DFT_ANALOG_EN_1_Pos    18UL
#define GPIO_DFT_IO_TEST_DFT_ANALOG_EN_1_Msk    0x40000UL
#define GPIO_DFT_IO_TEST_DFT_ANA_SEL_1_Pos      19UL
#define GPIO_DFT_IO_TEST_DFT_ANA_SEL_1_Msk      0x80000UL
#define GPIO_DFT_IO_TEST_DFT_ANA_POL_1_Pos      20UL
#define GPIO_DFT_IO_TEST_DFT_ANA_POL_1_Msk      0x100000UL
#define GPIO_DFT_IO_TEST_DFT_HLD_OVR_2_Pos      24UL
#define GPIO_DFT_IO_TEST_DFT_HLD_OVR_2_Msk      0x1000000UL
#define GPIO_DFT_IO_TEST_DFT_OE_N_2_Pos         25UL
#define GPIO_DFT_IO_TEST_DFT_OE_N_2_Msk         0x2000000UL
#define GPIO_DFT_IO_TEST_DFT_ANALOG_EN_2_Pos    26UL
#define GPIO_DFT_IO_TEST_DFT_ANALOG_EN_2_Msk    0x4000000UL
#define GPIO_DFT_IO_TEST_DFT_ANA_SEL_2_Pos      27UL
#define GPIO_DFT_IO_TEST_DFT_ANA_SEL_2_Msk      0x8000000UL
#define GPIO_DFT_IO_TEST_DFT_ANA_POL_2_Pos      28UL
#define GPIO_DFT_IO_TEST_DFT_ANA_POL_2_Msk      0x10000000UL
/* GPIO.GPIOV1P2_DET */

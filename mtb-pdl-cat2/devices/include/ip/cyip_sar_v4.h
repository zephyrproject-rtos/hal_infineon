...
#ifndef _CYIP_SAR_V4_H_
#define _CYIP_SAR_V4_H_
...
typedef struct {
  ...
  __IOM uint32_t CHAN_CONFIG[32];               /*!< 0x00000080 Channel configuration register. */
   __IM uint32_t CHAN_WORK[32];                 /*!< 0x00000100 Channel working data register */
   __IM uint32_t CHAN_RESULT[32];               /*!< 0x00000180 Channel result data register */
  ...
  __IOM uint32_t MUX_SWITCH2;                   /*!< 0x00000310 EXPMUX and DIAGMUX Firmware switch controls */
  __IOM uint32_t MUX_SWITCH_CLEAR2;             /*!< 0x00000314 EXPMUX and DIAGMUX Firmware switch control clear */
   __IM uint32_t RESERVED8[10];
  __IOM uint32_t MUX_SWITCH_HW_CTRL;            /*!< 0x00000340 SARMUX switch hardware control */
  __IOM uint32_t MUX_SWITCH_HW_CTRL2;           /*!< 0x00000344 EXPMUX and DIAGMUX switch hardware control */
   __IM uint32_t RESERVED9[2];
   __IM uint32_t MUX_SWITCH_STATUS;             /*!< 0x00000350 SARMUX switch status */
   __IM uint32_t MUX_SWITCH_STATUS2;            /*!< 0x00000354 EXPMUX and DIAGMUX switch status */
   __IM uint32_t RESERVED10[10];
  __IOM uint32_t PUMP_CTRL;                     /*!< 0x00000380 Switch pump control */
   __IM uint32_t RESERVED11[16095];
  __IOM uint32_t ANA_TRIM;                      /*!< 0x0000FF00 Analog trim register. */
  __IOM uint32_t WOUNDING;                      /*!< 0x0000FF04 SAR wounding register */
} SAR_Type;                                     /*!< Size = 65288 (0xFF08) */
...
#define SAR_CTRL_RESERVED_CTRL_28_Pos           28UL
#define SAR_CTRL_RESERVED_CTRL_28_Msk           0x10000000UL
#define SAR_CTRL_RESERVED_CTRL_29_Pos           29UL
#define SAR_CTRL_RESERVED_CTRL_29_Msk           0x20000000UL
...
#define SAR_CHAN_EN_CHAN_EN_Msk                 0xFFFFFFFFUL
/* SAR.START_CTRL */
#define SAR_START_CTRL_FW_TRIGGER_Pos           0UL
#define SAR_START_CTRL_FW_TRIGGER_Msk           0x1UL
/* SAR.DFT_CTRL */
#define SAR_DFT_CTRL_DLY_INC_Pos                0UL
#define SAR_DFT_CTRL_DLY_INC_Msk                0x1UL
#define SAR_DFT_CTRL_HIZ_Pos                    1UL
#define SAR_DFT_CTRL_HIZ_Msk                    0x2UL
#define SAR_DFT_CTRL_DFT_INC_Pos                16UL
#define SAR_DFT_CTRL_DFT_INC_Msk                0xF0000UL
#define SAR_DFT_CTRL_DFT_OUTC_Pos               20UL
#define SAR_DFT_CTRL_DFT_OUTC_Msk               0x700000UL
#define SAR_DFT_CTRL_SEL_CSEL_DFT_Pos           24UL
#define SAR_DFT_CTRL_SEL_CSEL_DFT_Msk           0xF000000UL
#define SAR_DFT_CTRL_EN_CSEL_DFT_Pos            28UL
#define SAR_DFT_CTRL_EN_CSEL_DFT_Msk            0x10000000UL
#define SAR_DFT_CTRL_DCEN_Pos                   29UL
#define SAR_DFT_CTRL_DCEN_Msk                   0x20000000UL
#define SAR_DFT_CTRL_ADFT_OVERRIDE_EXPMUX_Pos   30UL
#define SAR_DFT_CTRL_ADFT_OVERRIDE_EXPMUX_Msk   0x40000000UL
#define SAR_DFT_CTRL_ADFT_OVERRIDE_Pos          31UL
#define SAR_DFT_CTRL_ADFT_OVERRIDE_Msk          0x80000000UL
/* SAR.CHAN_CONFIG */
...
#define SAR_CHAN_CONFIG_DIAG_VPLUS_SOURCE_Pos   26UL
#define SAR_CHAN_CONFIG_DIAG_VPLUS_SOURCE_Msk   0x4000000UL
#define SAR_CHAN_CONFIG_DIAG_VPLUS_SINK_Pos     27UL
#define SAR_CHAN_CONFIG_DIAG_VPLUS_SINK_Msk     0x8000000UL
#define SAR_CHAN_CONFIG_DIAG_VMINUS_SOURCE_Pos  28UL
#define SAR_CHAN_CONFIG_DIAG_VMINUS_SOURCE_Msk  0x10000000UL
#define SAR_CHAN_CONFIG_DIAG_VMINUS_SINK_Pos    29UL
#define SAR_CHAN_CONFIG_DIAG_VMINUS_SINK_Msk    0x20000000UL
...
#define SAR_CHAN_WORK_UPDATED_CHAN_WORK_UPDATED_Msk 0xFFFFFFFFUL
/* SAR.CHAN_RESULT_UPDATED */
#define SAR_CHAN_RESULT_UPDATED_CHAN_RESULT_UPDATED_Pos 0UL
#define SAR_CHAN_RESULT_UPDATED_CHAN_RESULT_UPDATED_Msk 0xFFFFFFFFUL
/* SAR.INTR */
...
#define SAR_SATURATE_INTR_SATURATE_INTR_Msk     0xFFFFFFFFUL
/* SAR.SATURATE_INTR_SET */
#define SAR_SATURATE_INTR_SET_SATURATE_SET_Pos  0UL
#define SAR_SATURATE_INTR_SET_SATURATE_SET_Msk  0xFFFFFFFFUL
/* SAR.SATURATE_INTR_MASK */
#define SAR_SATURATE_INTR_MASK_SATURATE_MASK_Pos 0UL
#define SAR_SATURATE_INTR_MASK_SATURATE_MASK_Msk 0xFFFFFFFFUL
/* SAR.SATURATE_INTR_MASKED */
#define SAR_SATURATE_INTR_MASKED_SATURATE_MASKED_Pos 0UL
#define SAR_SATURATE_INTR_MASKED_SATURATE_MASKED_Msk 0xFFFFFFFFUL
/* SAR.RANGE_INTR */
#define SAR_RANGE_INTR_RANGE_INTR_Pos           0UL
#define SAR_RANGE_INTR_RANGE_INTR_Msk           0xFFFFFFFFUL
/* SAR.RANGE_INTR_SET */
#define SAR_RANGE_INTR_SET_RANGE_SET_Pos        0UL
#define SAR_RANGE_INTR_SET_RANGE_SET_Msk        0xFFFFFFFFUL
/* SAR.RANGE_INTR_MASK */
#define SAR_RANGE_INTR_MASK_RANGE_MASK_Pos      0UL
#define SAR_RANGE_INTR_MASK_RANGE_MASK_Msk      0xFFFFFFFFUL
/* SAR.RANGE_INTR_MASKED */
#define SAR_RANGE_INTR_MASKED_RANGE_MASKED_Pos  0UL
#define SAR_RANGE_INTR_MASKED_RANGE_MASKED_Msk  0xFFFFFFFFUL
/* SAR.INTR_CAUSE */
...
#define SAR_INJ_CHAN_CONFIG_INJ_NEG_PIN_ADDR_Pos 16UL
#define SAR_INJ_CHAN_CONFIG_INJ_NEG_PIN_ADDR_Msk 0x70000UL
#define SAR_INJ_CHAN_CONFIG_INJ_NEG_PORT_ADDR_Pos 20UL
#define SAR_INJ_CHAN_CONFIG_INJ_NEG_PORT_ADDR_Msk 0x700000UL
#define SAR_INJ_CHAN_CONFIG_INJ_NEG_ADDR_EN_Pos 24UL
#define SAR_INJ_CHAN_CONFIG_INJ_NEG_ADDR_EN_Msk 0x1000000UL
#define SAR_INJ_CHAN_CONFIG_INJ_DIAG_VPLUS_SOURCE_Pos 26UL
#define SAR_INJ_CHAN_CONFIG_INJ_DIAG_VPLUS_SOURCE_Msk 0x4000000UL
#define SAR_INJ_CHAN_CONFIG_INJ_DIAG_VPLUS_SINK_Pos 27UL
#define SAR_INJ_CHAN_CONFIG_INJ_DIAG_VPLUS_SINK_Msk 0x8000000UL
#define SAR_INJ_CHAN_CONFIG_INJ_DIAG_VMINUS_SOURCE_Pos 28UL
#define SAR_INJ_CHAN_CONFIG_INJ_DIAG_VMINUS_SOURCE_Msk 0x10000000UL
#define SAR_INJ_CHAN_CONFIG_INJ_DIAG_VMINUS_SINK_Pos 29UL
#define SAR_INJ_CHAN_CONFIG_INJ_DIAG_VMINUS_SINK_Msk 0x20000000UL
...
#define SAR_STATUS_CUR_CHAN_Msk                 0x3FUL
...
/* SAR.MUX_SWITCH1 */
#define SAR_MUX_SWITCH1_MUX_FW_P4_DFT_INP_Pos   0UL
#define SAR_MUX_SWITCH1_MUX_FW_P4_DFT_INP_Msk   0x1UL
#define SAR_MUX_SWITCH1_MUX_FW_P5_DFT_INM_Pos   1UL
#define SAR_MUX_SWITCH1_MUX_FW_P5_DFT_INM_Msk   0x2UL
#define SAR_MUX_SWITCH1_MUX_FW_ADFT0_SARBUS0_Pos 2UL
#define SAR_MUX_SWITCH1_MUX_FW_ADFT0_SARBUS0_Msk 0x4UL
#define SAR_MUX_SWITCH1_MUX_FW_ADFT1_SARBUS1_Pos 3UL
#define SAR_MUX_SWITCH1_MUX_FW_ADFT1_SARBUS1_Msk 0x8UL
/* SAR.MUX_SWITCH_CLEAR1 */
#define SAR_MUX_SWITCH_CLEAR1_MUX_FW_P4_DFT_INP_Pos 0UL
#define SAR_MUX_SWITCH_CLEAR1_MUX_FW_P4_DFT_INP_Msk 0x1UL
#define SAR_MUX_SWITCH_CLEAR1_MUX_FW_P5_DFT_INM_Pos 1UL
#define SAR_MUX_SWITCH_CLEAR1_MUX_FW_P5_DFT_INM_Msk 0x2UL
#define SAR_MUX_SWITCH_CLEAR1_MUX_FW_ADFT0_SARBUS0_Pos 2UL
#define SAR_MUX_SWITCH_CLEAR1_MUX_FW_ADFT0_SARBUS0_Msk 0x4UL
#define SAR_MUX_SWITCH_CLEAR1_MUX_FW_ADFT1_SARBUS1_Pos 3UL
#define SAR_MUX_SWITCH_CLEAR1_MUX_FW_ADFT1_SARBUS1_Msk 0x8UL
/* SAR.MUX_SWITCH2 */
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P0_VPLUS_Pos 0UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P0_VPLUS_Msk 0x1UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P1_VPLUS_Pos 1UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P1_VPLUS_Msk 0x2UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P2_VPLUS_Pos 2UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P2_VPLUS_Msk 0x4UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P3_VPLUS_Pos 3UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P3_VPLUS_Msk 0x8UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P4_VPLUS_Pos 4UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P4_VPLUS_Msk 0x10UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P5_VPLUS_Pos 5UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P5_VPLUS_Msk 0x20UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P6_VPLUS_Pos 6UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P6_VPLUS_Msk 0x40UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P7_VPLUS_Pos 7UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P7_VPLUS_Msk 0x80UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P0_VMINUS_Pos 8UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P0_VMINUS_Msk 0x100UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P1_VMINUS_Pos 9UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P1_VMINUS_Msk 0x200UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P2_VMINUS_Pos 10UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P2_VMINUS_Msk 0x400UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P3_VMINUS_Pos 11UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P3_VMINUS_Msk 0x800UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P4_VMINUS_Pos 12UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P4_VMINUS_Msk 0x1000UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P5_VMINUS_Pos 13UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P5_VMINUS_Msk 0x2000UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P6_VMINUS_Pos 14UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P6_VMINUS_Msk 0x4000UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P7_VMINUS_Pos 15UL
#define SAR_MUX_SWITCH2_MUX_FW_EXP_P7_VMINUS_Msk 0x8000UL
#define SAR_MUX_SWITCH2_MUX_FW_VD0_VPLUS_Pos    16UL
#define SAR_MUX_SWITCH2_MUX_FW_VD0_VPLUS_Msk    0x10000UL
#define SAR_MUX_SWITCH2_MUX_FW_VD1_VPLUS_Pos    17UL
#define SAR_MUX_SWITCH2_MUX_FW_VD1_VPLUS_Msk    0x20000UL
#define SAR_MUX_SWITCH2_MUX_FW_VD2_VPLUS_Pos    18UL
#define SAR_MUX_SWITCH2_MUX_FW_VD2_VPLUS_Msk    0x40000UL
#define SAR_MUX_SWITCH2_MUX_FW_VD3_VPLUS_Pos    19UL
#define SAR_MUX_SWITCH2_MUX_FW_VD3_VPLUS_Msk    0x80000UL
#define SAR_MUX_SWITCH2_MUX_FW_VD4_VPLUS_Pos    20UL
#define SAR_MUX_SWITCH2_MUX_FW_VD4_VPLUS_Msk    0x100000UL
#define SAR_MUX_SWITCH2_MUX_FW_VD5_VPLUS_Pos    21UL
#define SAR_MUX_SWITCH2_MUX_FW_VD5_VPLUS_Msk    0x200000UL
#define SAR_MUX_SWITCH2_MUX_FW_VD6_VPLUS_Pos    22UL
#define SAR_MUX_SWITCH2_MUX_FW_VD6_VPLUS_Msk    0x400000UL
#define SAR_MUX_SWITCH2_MUX_FW_VD7_VPLUS_Pos    23UL
#define SAR_MUX_SWITCH2_MUX_FW_VD7_VPLUS_Msk    0x800000UL
#define SAR_MUX_SWITCH2_MUX_FW_VG0_VMINUS_Pos   24UL
#define SAR_MUX_SWITCH2_MUX_FW_VG0_VMINUS_Msk   0x1000000UL
#define SAR_MUX_SWITCH2_MUX_FW_VG1_VMINUS_Pos   25UL
#define SAR_MUX_SWITCH2_MUX_FW_VG1_VMINUS_Msk   0x2000000UL
#define SAR_MUX_SWITCH2_MUX_FW_VG2_VMINUS_Pos   26UL
#define SAR_MUX_SWITCH2_MUX_FW_VG2_VMINUS_Msk   0x4000000UL
#define SAR_MUX_SWITCH2_MUX_FW_VG3_VMINUS_Pos   27UL
#define SAR_MUX_SWITCH2_MUX_FW_VG3_VMINUS_Msk   0x8000000UL
#define SAR_MUX_SWITCH2_MUX_FW_CSRC_VPLUS_Pos   28UL
#define SAR_MUX_SWITCH2_MUX_FW_CSRC_VPLUS_Msk   0x10000000UL
#define SAR_MUX_SWITCH2_MUX_FW_CSINK_VPLUS_Pos  29UL
#define SAR_MUX_SWITCH2_MUX_FW_CSINK_VPLUS_Msk  0x20000000UL
#define SAR_MUX_SWITCH2_MUX_FW_CSRC_VMINUS_Pos  30UL
#define SAR_MUX_SWITCH2_MUX_FW_CSRC_VMINUS_Msk  0x40000000UL
#define SAR_MUX_SWITCH2_MUX_FW_CSINK_VMINUS_Pos 31UL
#define SAR_MUX_SWITCH2_MUX_FW_CSINK_VMINUS_Msk 0x80000000UL
/* SAR.MUX_SWITCH_CLEAR2 */
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P0_VPLUS_Pos 0UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P0_VPLUS_Msk 0x1UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P1_VPLUS_Pos 1UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P1_VPLUS_Msk 0x2UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P2_VPLUS_Pos 2UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P2_VPLUS_Msk 0x4UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P3_VPLUS_Pos 3UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P3_VPLUS_Msk 0x8UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P4_VPLUS_Pos 4UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P4_VPLUS_Msk 0x10UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P5_VPLUS_Pos 5UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P5_VPLUS_Msk 0x20UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P6_VPLUS_Pos 6UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P6_VPLUS_Msk 0x40UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P7_VPLUS_Pos 7UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P7_VPLUS_Msk 0x80UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P0_VMINUS_Pos 8UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P0_VMINUS_Msk 0x100UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P1_VMINUS_Pos 9UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P1_VMINUS_Msk 0x200UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P2_VMINUS_Pos 10UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P2_VMINUS_Msk 0x400UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P3_VMINUS_Pos 11UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P3_VMINUS_Msk 0x800UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P4_VMINUS_Pos 12UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P4_VMINUS_Msk 0x1000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P5_VMINUS_Pos 13UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P5_VMINUS_Msk 0x2000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P6_VMINUS_Pos 14UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P6_VMINUS_Msk 0x4000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P7_VMINUS_Pos 15UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_EXP_P7_VMINUS_Msk 0x8000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD0_VPLUS_Pos 16UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD0_VPLUS_Msk 0x10000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD1_VPLUS_Pos 17UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD1_VPLUS_Msk 0x20000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD2_VPLUS_Pos 18UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD2_VPLUS_Msk 0x40000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD3_VPLUS_Pos 19UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD3_VPLUS_Msk 0x80000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD4_VPLUS_Pos 20UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD4_VPLUS_Msk 0x100000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD5_VPLUS_Pos 21UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD5_VPLUS_Msk 0x200000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD6_VPLUS_Pos 22UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD6_VPLUS_Msk 0x400000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD7_VPLUS_Pos 23UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VD7_VPLUS_Msk 0x800000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VG0_VMINUS_Pos 24UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VG0_VMINUS_Msk 0x1000000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VG1_VMINUS_Pos 25UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VG1_VMINUS_Msk 0x2000000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VG2_VMINUS_Pos 26UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VG2_VMINUS_Msk 0x4000000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VG3_VMINUS_Pos 27UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_VG3_VMINUS_Msk 0x8000000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_CSRC_VPLUS_Pos 28UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_CSRC_VPLUS_Msk 0x10000000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_CSINK_VPLUS_Pos 29UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_CSINK_VPLUS_Msk 0x20000000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_CSRC_VMINUS_Pos 30UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_CSRC_VMINUS_Msk 0x40000000UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_CSINK_VMINUS_Pos 31UL
#define SAR_MUX_SWITCH_CLEAR2_MUX_FW_CSINK_VMINUS_Msk 0x80000000UL
...
/* SAR.MUX_SWITCH_HW_CTRL2 */
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P0_Pos 0UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P0_Msk 0x1UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P1_Pos 1UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P1_Msk 0x2UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P2_Pos 2UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P2_Msk 0x4UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P3_Pos 3UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P3_Msk 0x8UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P4_Pos 4UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P4_Msk 0x10UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P5_Pos 5UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P5_Msk 0x20UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P6_Pos 6UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P6_Msk 0x40UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P7_Pos 7UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_HW_CTRL_EXP_P7_Msk 0x80UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD0_VG0_Pos 16UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD0_VG0_Msk 0x10000UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD1_VG1_Pos 17UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD1_VG1_Msk 0x20000UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD2_VG2_Pos 18UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD2_VG2_Msk 0x40000UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD3_VG3_Pos 19UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD3_VG3_Msk 0x80000UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD4_Pos  20UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD4_Msk  0x100000UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD5_Pos  21UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD5_Msk  0x200000UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD6_Pos  22UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD6_Msk  0x400000UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD7_Pos  23UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_VD7_Msk  0x800000UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_CSRC_VPLUS_Pos 28UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_CSRC_VPLUS_Msk 0x10000000UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_CSINK_VPLUS_Pos 29UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_CSINK_VPLUS_Msk 0x20000000UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_CSRC_VMINUS_Pos 30UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_CSRC_VMINUS_Msk 0x40000000UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_CSINK_VMINUS_Pos 31UL
#define SAR_MUX_SWITCH_HW_CTRL2_MUX_FW_CSINK_VMINUS_Msk 0x80000000UL
...
/* SAR.MUX_SWITCH_STATUS2 */
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P0_VPLUS_Pos 0UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P0_VPLUS_Msk 0x1UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P1_VPLUS_Pos 1UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P1_VPLUS_Msk 0x2UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P2_VPLUS_Pos 2UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P2_VPLUS_Msk 0x4UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P3_VPLUS_Pos 3UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P3_VPLUS_Msk 0x8UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P4_VPLUS_Pos 4UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P4_VPLUS_Msk 0x10UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P5_VPLUS_Pos 5UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P5_VPLUS_Msk 0x20UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P6_VPLUS_Pos 6UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P6_VPLUS_Msk 0x40UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P7_VPLUS_Pos 7UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P7_VPLUS_Msk 0x80UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P0_VMINUS_Pos 8UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P0_VMINUS_Msk 0x100UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P1_VMINUS_Pos 9UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P1_VMINUS_Msk 0x200UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P2_VMINUS_Pos 10UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P2_VMINUS_Msk 0x400UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P3_VMINUS_Pos 11UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P3_VMINUS_Msk 0x800UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P4_VMINUS_Pos 12UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P4_VMINUS_Msk 0x1000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P5_VMINUS_Pos 13UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P5_VMINUS_Msk 0x2000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P6_VMINUS_Pos 14UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P6_VMINUS_Msk 0x4000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P7_VMINUS_Pos 15UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_EXP_P7_VMINUS_Msk 0x8000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD0_VPLUS_Pos 16UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD0_VPLUS_Msk 0x10000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD1_VPLUS_Pos 17UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD1_VPLUS_Msk 0x20000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD2_VPLUS_Pos 18UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD2_VPLUS_Msk 0x40000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD3_VPLUS_Pos 19UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD3_VPLUS_Msk 0x80000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD4_VPLUS_Pos 20UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD4_VPLUS_Msk 0x100000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD5_VPLUS_Pos 21UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD5_VPLUS_Msk 0x200000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD6_VPLUS_Pos 22UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD6_VPLUS_Msk 0x400000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD7_VPLUS_Pos 23UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VD7_VPLUS_Msk 0x800000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VG0_VMINUS_Pos 24UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VG0_VMINUS_Msk 0x1000000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VG1_VMINUS_Pos 25UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VG1_VMINUS_Msk 0x2000000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VG2_VMINUS_Pos 26UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VG2_VMINUS_Msk 0x4000000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VG3_VMINUS_Pos 27UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_VG3_VMINUS_Msk 0x8000000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_CSRC_VPLUS_Pos 28UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_CSRC_VPLUS_Msk 0x10000000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_CSINK_VPLUS_Pos 29UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_CSINK_VPLUS_Msk 0x20000000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_CSRC_VMINUS_Pos 30UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_CSRC_VMINUS_Msk 0x40000000UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_CSINK_VMINUS_Pos 31UL
#define SAR_MUX_SWITCH_STATUS2_MUX_FW_CSINK_VMINUS_Msk 0x80000000UL
/* SAR.PUMP_CTRL */
#define SAR_PUMP_CTRL_CLOCK_SEL_Pos             0UL
#define SAR_PUMP_CTRL_CLOCK_SEL_Msk             0x1UL
#define SAR_PUMP_CTRL_ENABLED_Pos               31UL
#define SAR_PUMP_CTRL_ENABLED_Msk               0x80000000UL
/* SAR.ANA_TRIM */
#define SAR_ANA_TRIM_CAP_TRIM_Pos               0UL
#define SAR_ANA_TRIM_CAP_TRIM_Msk               0x7UL
#define SAR_ANA_TRIM_TRIMUNIT_Pos               3UL
#define SAR_ANA_TRIM_TRIMUNIT_Msk               0x8UL
/* SAR.WOUNDING */
#define SAR_WOUNDING_WOUND_RESOLUTION_Pos       0UL
#define SAR_WOUNDING_WOUND_RESOLUTION_Msk       0x3UL


#endif /* _CYIP_SAR_V4_H_ */

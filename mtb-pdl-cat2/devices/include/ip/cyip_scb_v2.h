...
/* SCB.SPI_CTRL */
#define SCB_SPI_CTRL_CONTINUOUS_Pos             0UL
#define SCB_SPI_CTRL_CONTINUOUS_Msk             0x1UL
...
#define SCB_SPI_CTRL_SLAVE_SELECT_Pos           26UL
#define SCB_SPI_CTRL_SLAVE_SELECT_Msk           0xC000000UL

...
#ifndef _CYIP_SPCIF_V3_VER3_H_
#define _CYIP_SPCIF_V3_VER3_H_
...
/* SPCIF.FLASH_LOCK */
#define SPCIF_FLASH_LOCK_KEY_Pos                0UL
#define SPCIF_FLASH_LOCK_KEY_Msk                0xFFFFFFFFUL
/* SPCIF.FLASH_MACRO_WE */
#define SPCIF_FLASH_MACRO_WE_MAC_WRITE_EN_Pos   0UL
#define SPCIF_FLASH_MACRO_WE_MAC_WRITE_EN_Msk   0xFUL
#define SPCIF_FLASH_MACRO_WE_LOCKED_Pos         31UL
#define SPCIF_FLASH_MACRO_WE_LOCKED_Msk         0x80000000UL
/* SPCIF.INTR */

/***************************************************************************//**
* \file pmg1s0_config.h
*
* \brief
* PMG1S0 device configuration header
*
********************************************************************************
* \copyright
...
#ifndef _PMG1S0_CONFIG_H_
#define _PMG1S0_CONFIG_H_
...
typedef enum
{
    ...
    PCLK_USBPD0_CLOCK_REFGEN        = 0x000Au,  /* usbpd[0].clock_refgen */
    PCLK_USBPD0_CLOCK_BCH_DET       = 0x000Bu,  /* usbpd[0].clock_bch_det */
    PCLK_USBPD0_CLOCK_FILTER1       = 0x000Cu,  /* usbpd[0].clock_filter1 */
    PCLK_USBPD0_CLOCK_FILTER2       = 0x000Du,  /* usbpd[0].clock_filter2 */
...
/* MTB SRAM Base - Value should be computed from Memory Map */
...
#define USBPD_AGNOSTIC_SBU_IEC_EN       1u
/* Number of SBU Switch hard IP is instantiated */
#define USBPD_AGNOSTIC_SBU_NUM          1u
/* Number of SBU Switches instantiated */
#define USBPD_AGNOSTIC_SBU20_NUM        0u
/* Total number of SBU20 two-bit CFG bits */
#define USBPD_AGNOSTIC_SBU20_NUM_LOG2   0u
/* Number of DPDM Switches instantiated */
#define USBPD_AGNOSTIC_DPDM_NUM         0u
/* Number of CSA hard IP is instantiated */
#define USBPD_AGNOSTIC_CSA_NUM          0u
/* Total number of CSA2,3,4 Filter CFG bits */
#define USBPD_AGNOSTIC_CSA_NUM_LOG1     0u
/* Total number of CSA2,3,4 Filter CFG bits */
#define USBPD_AGNOSTIC_CSA_NUM_LOG2     0u
/* Total number of CSA2,3,4 Filter select bits */
#define USBPD_AGNOSTIC_CSA_NUM_LOG3     0u
/* Total number of s8_esd_res250only cell for each of pad_inp/pad_inn of
   s8usbpdv2_csa_top */
#define USBPD_AGNOSTIC_CSA_ESD_NUM      0u
/* VSYS Enabled */
#define USBPD_AGNOSTIC_VSYS_EN          0u
/* Number of s8usbpd_20vreg_top Regulator hard IP is instantiated */
#define USBPD_AGNOSTIC_VREG20_NUM       0u
/* Total number of VREG20 2,3,4 Filter CFG bits */
#define USBPD_AGNOSTIC_VREG20_NUM_LOG1  0u
/* Total number of VREG20 2,3,4 Filter CFG bits */
#define USBPD_AGNOSTIC_VREG20_NUM_LOG2  0u
/* Total number of VREG20 2,3,4 Filter select bits */
#define USBPD_AGNOSTIC_VREG20_NUM_LOG3  0u
/* First regulator instatiated */
#define USBPD_AGNOSTIC_REGULATOR1_EN    1u
/* Second regulator instatiated */
#define USBPD_AGNOSTIC_REGULATOR2_EN    0u
/* Third regulator instatiated */
#define USBPD_AGNOSTIC_REGULATOR3_EN    0u
/* Forth regulator instatiated */
#define USBPD_AGNOSTIC_REGULATOR4_EN    0u
/* First 20V regulator instatiated */
#define USBPD_AGNOSTIC_REGULATOR20_1_EN 0u
/* Second 20V regulator instatiated */
#define USBPD_AGNOSTIC_REGULATOR20_2_EN 0u
/* Third 20V regulator instatiated */
#define USBPD_AGNOSTIC_REGULATOR20_3_EN 0u
/* Forth 20V regulator instatiated */
#define USBPD_AGNOSTIC_REGULATOR20_4_EN 0u
/* Regulator control is enabled */
#define USBPD_AGNOSTIC_REG_CONTROL_EN   0u
...
#define USBPD_AGNOSTIC_CSA_VBUS_NUM     0u
...
#define USBPD_AGNOSTIC_NGDO_VBUS_NUM    0u
...
#define USBPD_AGNOSTIC_VREG20_VBUS_NUM  0u
...
#define USBPD_AGNOSTIC_SHVREG_VBUS_NUM  1u
...
#define USBPD_AGNOSTIC_EA_VBUS_NUM      1u
...
#define USBPD_AGNOSTIC_VBUS_IEC_VBUS_NUM 8u
...
#define USBPD_AGNOSTIC_DISCHG_VBUS_NUM  8u
...
#define USBPD_AGNOSTIC_CLAMP_VBUS_NUM   0u
...
#define USBPD_AGNOSTIC_PGDO_PU_VBUS_NUM 1u
/* PGDO hard IP VBUS number: 2:0 For PGDO1 VBUS Number 5:3 For PGDO2 VBUS Number
   8:6 For PGDO3 VBUS Number 11:9 For PGDO4 VBUS Number 14:12 For PGDO5 VBUS
   Number 17:15 For PGDO6 VBUS Number 20:18 For PGDO7 VBUS Number 23:21 For
   PGDO8 VBUS Number i.e:
   {PGDO8[3:0],PGDO7[3:0],PGDO6[3:0],PGDO5[3:0],PGDO4[3:0],PGDO3[3:0],PGDO2[2:0],PGDO1[2:0]} */
#define USBPD_AGNOSTIC_PGDO_VBUS_NUM    0u
...
#define USBPD_AGNOSTIC_RDIV_VBUS_NUM    0u
...
#define USBPD_AGNOSTIC_RDIV_R_VBUS_NUM  8u
...
#define USBPD_AGNOSTIC_DET_SHV_VBUS_NUM 0u
/* Number of RefGen hard IP is instantiated */
#define USBPD_CCG5_TRIMS_REFGEN_NUM     1u
/* VCONN 20V enabled */
#define USBPD_CCG5_TRIMS_VCONN20_EN     0u
/* s8usbpd current/voltage reference capable (0=No, 1=Yes) */
#define USBPD_CCG5_TRIMS_DPSLP_REF_EN   1u
/* VSYS Enabled */
#define USBPD_CCG5_TRIMS_VSYS_EN        0u
/* Number of words in EZ memory */
#define SCB_EZ_DATA_NR                  32u

#endif /* _PMG1S0_CONFIG_H_ */

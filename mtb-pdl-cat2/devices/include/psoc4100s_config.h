...
#ifndef _PSOC4100S_CONFIG_H_
#define _PSOC4100S_CONFIG_H_
...
typedef enum
{
    ...
    PCLK_CSD_CLOCK                  = 0x0003u,  /* csd.clock */
    ...
    PCLK_TCPWM_CLOCKS4              = 0x0008u,  /* tcpwm.clocks[4] */
    PCLK_PRGIO_CLOCK_PRGIO_2        = 0x0009u,  /* prgio.clock_prgio_2 */
    PCLK_PRGIO_CLOCK_PRGIO_3        = 0x000Au,  /* prgio.clock_prgio_3 */
    PCLK_LCD_CLOCK                  = 0x000Bu,  /* lcd.clock */
...
typedef enum
{
    ...
    TRIG0_IN_PASS0_DSI_SAR_SAMPLE_DONE = 0x00000010u, /* pass[0].dsi_sar_sample_done */
    TRIG0_IN_PASS0_TR_SAR_OUT       = 0x00000011u, /* pass[0].tr_sar_out */
    TRIG0_IN_PASS0_DSI_CTB_CMP0     = 0x00000012u, /* pass[0].dsi_ctb_cmp0 */
    TRIG0_IN_PASS0_DSI_CTB_CMP1     = 0x00000013u, /* pass[0].dsi_ctb_cmp1 */
    TRIG0_IN_LPCOMP_COMP_OUT0       = 0x00000014u, /* lpcomp.comp_out[0] */
    TRIG0_IN_LPCOMP_COMP_OUT1       = 0x00000015u /* lpcomp.comp_out[1] */
...
typedef enum
{
    ...
    TRIG1_IN_TCPWM_TR_COMPARE_MATCH0 = 0x00000106u, /* tcpwm.tr_compare_match[0] */
    TRIG1_IN_TCPWM_TR_COMPARE_MATCH1 = 0x00000107u, /* tcpwm.tr_compare_match[1] */
    TRIG1_IN_TCPWM_TR_COMPARE_MATCH2 = 0x00000108u, /* tcpwm.tr_compare_match[2] */
    TRIG1_IN_TCPWM_TR_COMPARE_MATCH3 = 0x00000109u, /* tcpwm.tr_compare_match[3] */
    TRIG1_IN_TCPWM_TR_COMPARE_MATCH4 = 0x0000010Au, /* tcpwm.tr_compare_match[4] */
    TRIG1_IN_TCPWM_TR_UNDERFLOW0    = 0x0000010Bu, /* tcpwm.tr_underflow[0] */
    TRIG1_IN_TCPWM_TR_UNDERFLOW1    = 0x0000010Cu, /* tcpwm.tr_underflow[1] */
    TRIG1_IN_TCPWM_TR_UNDERFLOW2    = 0x0000010Du, /* tcpwm.tr_underflow[2] */
    TRIG1_IN_TCPWM_TR_UNDERFLOW3    = 0x0000010Eu, /* tcpwm.tr_underflow[3] */
    TRIG1_IN_TCPWM_TR_UNDERFLOW4    = 0x0000010Fu, /* tcpwm.tr_underflow[4] */
    TRIG1_IN_PASS0_DSI_SAR_SAMPLE_DONE = 0x00000110u, /* pass[0].dsi_sar_sample_done */
    TRIG1_IN_PASS0_TR_SAR_OUT       = 0x00000111u, /* pass[0].tr_sar_out */
    TRIG1_IN_PASS0_DSI_CTB_CMP0     = 0x00000112u, /* pass[0].dsi_ctb_cmp0 */
    TRIG1_IN_PASS0_DSI_CTB_CMP1     = 0x00000113u, /* pass[0].dsi_ctb_cmp1 */
    TRIG1_IN_LPCOMP_COMP_OUT0       = 0x00000114u, /* lpcomp.comp_out[0] */
    TRIG1_IN_LPCOMP_COMP_OUT1       = 0x00000115u /* lpcomp.comp_out[1] */

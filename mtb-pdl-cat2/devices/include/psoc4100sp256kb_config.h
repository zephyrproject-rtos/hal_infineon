...
#ifndef _PSOC4100SP256KB_CONFIG_H_
#define _PSOC4100SP256KB_CONFIG_H_
...
typedef enum
{
    ...
    PCLK_PRGIO_CLOCK_PRGIO_2        = 0x000Eu,  /* prgio.clock_prgio_2 */
    PCLK_PRGIO_CLOCK_PRGIO_3        = 0x000Fu,  /* prgio.clock_prgio_3 */
    PCLK_PASS0_CLOCK_SAR            = 0x0010u,  /* pass[0].clock_sar */
    PCLK_LCD_CLOCK                  = 0x0011u,  /* lcd.clock */
    PCLK_PASS1_CLOCK_SAR            = 0x0012u   /* pass[1].clock_sar */
} en_clk_dst_t;
...
typedef enum
{
    ...
    TRIG0_IN_PASS0_DSI_CTB_CMP0     = 0x0000002Fu, /* pass[0].dsi_ctb_cmp0 */
    TRIG0_IN_PASS0_DSI_CTB_CMP1     = 0x00000030u, /* pass[0].dsi_ctb_cmp1 */
    TRIG0_IN_PASS1_DSI_SAR_SAMPLE_DONE = 0x00000031u, /* pass[1].dsi_sar_sample_done */
    TRIG0_IN_PASS1_TR_SAR_OUT       = 0x00000032u, /* pass[1].tr_sar_out */
    TRIG0_IN_PASS1_DSI_CTB_CMP0     = 0x00000033u, /* pass[1].dsi_ctb_cmp0 */
    TRIG0_IN_PASS1_DSI_CTB_CMP1     = 0x00000034u, /* pass[1].dsi_ctb_cmp1 */
...
typedef enum
{
    ...
    TRIG1_IN_PASS1_DSI_SAR_SAMPLE_DONE = 0x00000120u, /* pass[1].dsi_sar_sample_done */
    TRIG1_IN_PASS1_TR_SAR_OUT       = 0x00000121u, /* pass[1].tr_sar_out */
    TRIG1_IN_PASS1_DSI_CTB_CMP0     = 0x00000122u, /* pass[1].dsi_ctb_cmp0 */
    TRIG1_IN_PASS1_DSI_CTB_CMP1     = 0x00000123u, /* pass[1].dsi_ctb_cmp1 */
    TRIG1_IN_EXCO_TRIGGER           = 0x00000124u /* exco.trigger */
...
typedef enum
{
    ...
    TRIG3_IN_PASS1_DSI_CTB_CMP0     = 0x0000030Du, /* pass[1].dsi_ctb_cmp0 */
    TRIG3_IN_PASS1_DSI_CTB_CMP1     = 0x0000030Eu /* pass[1].dsi_ctb_cmp1 */
...
typedef enum
{
    ...
    TRIG4_IN_PASS1_DSI_SAR_SAMPLE_DONE = 0x00000421u, /* pass[1].dsi_sar_sample_done */
    TRIG4_IN_PASS1_TR_SAR_OUT       = 0x00000422u, /* pass[1].tr_sar_out */
    TRIG4_IN_PASS1_DSI_CTB_CMP0     = 0x00000423u, /* pass[1].dsi_ctb_cmp0 */
    TRIG4_IN_PASS1_DSI_CTB_CMP1     = 0x00000424u, /* pass[1].dsi_ctb_cmp1 */
...
typedef enum
{
    TRIG4_OUT_PASS1_TR_SAR_IN       = 0x40000400u /* pass[1].tr_sar_in */
...
/* Number of CTBms in the Subsystem */
#define PASS1_NR_CTBS                   1u
/* Switch between SRSSv2 and SRSSLITE */
#define PASS1_SRSSLITE_PRESENT          1u
/* CTB0 Exists */
#define PASS1_CTB0_EXISTS               1u
/* CTB1 Exists */
#define PASS1_CTB1_EXISTS               0u
/* CTB2 Exists */
#define PASS1_CTB2_EXISTS               0u
/* CTB3 Exists */
#define PASS1_CTB3_EXISTS               0u
/* Number of slices (slice 0 = SAR) */
#define PASS1_SAR_NR_SLICES             2u
/* Number of SAR channels */
#define PASS1_SAR_SAR_CHANNELS          16u
/* Averaging logic present in SAR */
#define PASS1_SAR_SAR_AVERAGE           1u
/* Range detect logic present in SAR */
#define PASS1_SAR_SAR_RANGEDET          1u
...
/* Number of input triggers */
#define PERI_TR_GROUP_NR3_TR_GROUP_TR_IN_NR 15u
/* Number of output triggers */
...
#endif /* _PSOC4100SP256KB_CONFIG_H_ */

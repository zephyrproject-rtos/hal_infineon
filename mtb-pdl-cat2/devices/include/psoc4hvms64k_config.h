/***************************************************************************//**
* \file psoc4hvms64k_config.h
*
* \brief
* PSOC4HVMS64K device configuration header
*
********************************************************************************
* \copyright
...
#ifndef _PSOC4HVMS64K_CONFIG_H_
#define _PSOC4HVMS64K_CONFIG_H_
...
typedef enum
{
    ...
    TRIG0_IN_LPCOMP0_COMP_OUT0      = 0x00000026u, /* lpcomp[0].comp_out[0] */
    TRIG0_IN_LPCOMP0_COMP_OUT1      = 0x00000027u, /* lpcomp[0].comp_out[1] */
    TRIG0_IN_LPCOMP1_COMP_OUT0      = 0x00000028u, /* lpcomp[1].comp_out[0] */
    TRIG0_IN_LPCOMP1_COMP_OUT1      = 0x00000029u, /* lpcomp[1].comp_out[1] */
    TRIG0_IN_CXPI_TR_TX_REQ0        = 0x0000002Au, /* cxpi.tr_tx_req[0] */
    TRIG0_IN_CXPI_TR_TX_REQ1        = 0x0000002Bu, /* cxpi.tr_tx_req[1] */
    TRIG0_IN_CXPI_TR_RX_REQ0        = 0x0000002Cu, /* cxpi.tr_rx_req[0] */
    TRIG0_IN_CXPI_TR_RX_REQ1        = 0x0000002Du /* cxpi.tr_rx_req[1] */
...
typedef enum
{
    ...
    TRIG1_IN_LPCOMP0_COMP_OUT0      = 0x00000124u, /* lpcomp[0].comp_out[0] */
    TRIG1_IN_LPCOMP0_COMP_OUT1      = 0x00000125u, /* lpcomp[0].comp_out[1] */
    TRIG1_IN_LPCOMP1_COMP_OUT0      = 0x00000126u, /* lpcomp[1].comp_out[0] */
    TRIG1_IN_LPCOMP1_COMP_OUT1      = 0x00000127u, /* lpcomp[1].comp_out[1] */
    TRIG1_IN_CXPI_TR_TX_REQ0        = 0x00000128u, /* cxpi.tr_tx_req[0] */
    TRIG1_IN_CXPI_TR_TX_REQ1        = 0x00000129u, /* cxpi.tr_tx_req[1] */
    TRIG1_IN_CXPI_TR_RX_REQ0        = 0x0000012Au, /* cxpi.tr_rx_req[0] */
    TRIG1_IN_CXPI_TR_RX_REQ1        = 0x0000012Bu /* cxpi.tr_rx_req[1] */
...
typedef enum
{
    ...
    TRIG2_IN_LPCOMP0_COMP_OUT0      = 0x00000216u, /* lpcomp[0].comp_out[0] */
    TRIG2_IN_LPCOMP0_COMP_OUT1      = 0x00000217u, /* lpcomp[0].comp_out[1] */
    TRIG2_IN_LPCOMP1_COMP_OUT0      = 0x00000218u, /* lpcomp[1].comp_out[0] */
    TRIG2_IN_LPCOMP1_COMP_OUT1      = 0x00000219u /* lpcomp[1].comp_out[1] */
...
/* Indicates that pin #1 exists for this port */
#define IOSS_GPIO_GPIO_PORT_NR6_GPIO_PRT_IO1 0u
/* Indicates that pin #2 exists for this port */
#define IOSS_GPIO_GPIO_PORT_NR6_GPIO_PRT_IO2 0u
/* Indicates that pin #3 exists for this port */
#define IOSS_GPIO_GPIO_PORT_NR6_GPIO_PRT_IO3 0u
/* Indicates that pin #4 exists for this port */
...
/* Indicates that pin #1 exists for this port */
#define IOSS_HSIOM_HSIOM_PORT_NR6_HSIOM_PRT_IO1 0u
/* Indicates that pin #2 exists for this port */
#define IOSS_HSIOM_HSIOM_PORT_NR6_HSIOM_PRT_IO2 0u
/* Indicates that pin #3 exists for this port */
#define IOSS_HSIOM_HSIOM_PORT_NR6_HSIOM_PRT_IO3 0u
/* Indicates that pin #4 exists for this port */
...
/* Spare Enable 0=no spare, 1=max, 2=min */
#define LPCOMP0_SPARE_EN                0u
/* Std Lib Config 1=scs8ls, 2=scs8hd, 3=scs8hv(invalid), others=reserved */
#define LPCOMP0_SPARE_STDLIB_CFG        2u
/* Spare Enable 0=no spare, 1=max, 2=min */
#define LPCOMP1_SPARE_EN                0u
/* Std Lib Config 1=scs8ls, 2=scs8hd, 3=scs8hv(invalid), others=reserved */
#define LPCOMP1_SPARE_STDLIB_CFG        2u
...
#define PASS0_SAR_EXPMUX_PRESENT        0u
/* Number of programmable clocks (outputs) */
#define PERI_PCLK_CLOCK_NR              16u
...
#define PERI_PCLK_DIV_16_5_NR           6u
...
#define PERI_TR_GROUP_NR0_TR_GROUP_TR_IN_NR 46u

...
*
* This section describes only the CSD driver. Refer to the corresponding
* sections for documentation of middleware supported by the CSD HW block.
*
...
********************************************************************************
*
* The CSD driver is a simple wrapper driver specifically designed to be used
* by higher level middleware. Hence, is highly not recommended to use the CSD
* driver directly in the application program. To incorporate CSD HW block
* functionality in the application program, an associated middleware
* should be used.
*
* The CSD Driver can be used to implement a custom sensing solution. In such
* a case, the application program must acquire and lock the CSD HW block prior
* to accessing it.
*
...
*
* The entire solution, like CAPSENSE&trade; or CSDADC, in addition to
* the CSD HW block, incorporates the following instances:
*
* * \ref group_csd_config_clocks
* * \ref group_csd_config_vref
* * \ref group_csd_config_iref
...
* bus (AMUXBUS) can be connected to the CSD HW block as an input.
*
...
*   to \ref group_gpio driver section.
*
...
*
********************************************************************************
* \subsection group_csd_config_vref Reference Voltage Input
********************************************************************************
*
* The CSD HW block requires a reference voltage input to generate a programmable
* reference voltage within the CSD HW block. The SRSS is used as the on-chip
* source of the reference voltage.
*
********************************************************************************
* \subsection group_csd_config_iref Reference Current Input
********************************************************************************
*
* The CSD HW block requires a reference current input for the CSD IDACs operation.
* The SRSS is used as the on-chip source of the reference current.
*
********************************************************************************
* \subsection group_csd_config_interrupts Interrupts
********************************************************************************
*
* The CSD HW block has one interrupt. The CSD HW block can generate interrupts
...
* The CSD HW block is powered down in the Deep Sleep power mode.
...
* In Deep Sleep power mode, the CSD HW block is powered off.
...
* 2. Analog start up time for the CSD HW block is 10 us. Initiate
*    any kind of conversion only after 10 us from Deep Sleep exit.
*
...
#define CY_CSD_ADC_VREF_2P4                 (2400u)
/** One hundred percentage */
#define CY_CSD_PERCENTAGE_100               (100u)
/** Max deviation for trim */
#define CY_CSD_VREF_TRIM_MAX_DEVIATION      (20u)
/** 8-bit shift */
#define CY_CSD_8_BIT_SHIFT                  (8u)
/** The lowest 8-bit mask */
#define CY_CSD_LSB_MASK                     (0x000000FFu)
...
typedef enum
{
    ...
    */
    ...
    /** The CSD HW block is captured by a CAPSENSE&trade; middleware */

...
*
* \snippet scb_ezi2c_snippet.c EZI2C_CFG
*
...
*
* \snippet scb_ezi2c_snippet.c EZI2C_CFG_BUFFER
*
********************************************************************************
...
*
* \snippet scb_ezi2c_snippet.c EZI2C_CFG_PINS
*
* \note
...
*
* \snippet scb_ezi2c_snippet.c EZI2C_CFG_ASSIGN_CLOCK
*
********************************************************************************
...
*
* \snippet scb_ezi2c_snippet.c EZI2C_CFG_DATA_RATE
*
********************************************************************************
...
*
* \snippet scb_ezi2c_snippet.c EZI2C_INTR_A
* \snippet scb_ezi2c_snippet.c EZI2C_INTR_B
*
********************************************************************************
...
* \snippet scb_ezi2c_snippet.c EZI2C_ENABLE
*
********************************************************************************
...
* To trigger the callback execution, the
...
*
********************************************************************************
* \subsection group_scb_ezi2c_DsClockConfig_callback Deep Sleep Clock Config Callback
********************************************************************************
...
*
* \snippet scb_ezi2c_snippet.c EZI2C_DS_REGISTER_CLOCK_CONFIG_CALLBACK
* \snippet scb_ezi2c_snippet.c EZI2C_DS_CLOCK_CONFIG_CALLBACK
*
* \note
...
* \ref Cy_SCB_EZI2C_DeepSleepCallback to notify the user when
* going into and out of deepsleep
* \ref group_scb_ezi2c_macros_deep_sleep_callback_events.
*/
typedef void (* cy_cb_scb_ezi2c_handle_deep_sleep_mode_t)(uint32_t event);
...
__STATIC_INLINE void Cy_SCB_EZI2C_RegisterDSClockConfig(CySCB_Type const *base,
                                                    cy_cb_scb_ezi2c_handle_deep_sleep_mode_t  callback, cy_stc_scb_ezi2c_context_t *context);
#endif /* defined (CY_IP_M0S8SCB || defined (CY_DOXYGEN) */
...
*/
#define CY_SCB_EZI2C_SLAVE_DEEP_SLEEP_ENTER_EVENT (0x01UL)

/**
* Indicates on exit from Deep Sleep mode.
*/
#define CY_SCB_EZI2C_SLAVE_DEEP_SLEEP_EXIT_EVENT  (0x02UL)
...
#if defined (CY_IP_M0S8SCB) || defined (CY_DOXYGEN)
/*******************************************************************************
* Function Name: Cy_SCB_EZI2C_RegisterDSClockConfig
****************************************************************************//**
*
* Registers a callback function that will occur in \ref
* Cy_SCB_EZI2C_DeepSleepCallback when the EZI2C goes into deepsleep. In the
...
*
* \param callback
* The pointer to a callback function that will enable and disable the EZI2C
* clock divider when going into and out of deepsleep.
*
* \param context
* The pointer to context structure \ref cy_stc_scb_ezi2c_context_t allocated by
* the user. The structure is used during the EZI2C operation for internal

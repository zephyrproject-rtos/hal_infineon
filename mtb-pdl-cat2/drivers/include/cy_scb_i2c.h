...
* * Supports High-speed mode data rates up to 3.4Mbps in Slave mode only.
...
*
* \note
* I2C driver is built on top of the SCB hardware block.
*
********************************************************************************
...
*
********************************************************************************
* \section group_scb_i2c_hs_mode High-speed mode
********************************************************************************
* High-speed mode supports data rates up to 3.4Mbps in Slave mode only.
* Set up the I2C driver for High-speed transfer is similar to base I2C configuration
...
********************************************************************************
* For proper operation, in High-speed mode, create a callback function and
* register it by \ref Cy_SCB_I2C_RegisterHsModeCallback. The callback function changes
* clk_scb before entering to High-speed mode and after exiting it to support necessary
* data rate \ref group_scb_i2c_macros_hs_mode_callback_events.
*
...
* during execution of \ref Cy_SysPm_CpuEnterDeepSleep. To trigger the
...
*
* \warning The current version doesn't support the wake up from Deep-sleep
* by High-speed transfer.
*
********************************************************************************
* \subsection group_scb_i2c_DsClockConfig_callback Deep Sleep Clock Config Callback
********************************************************************************
* For proper operation, when the I2C slave is configured to be a wakeup source
* from Deep Sleep mode, create a callback function and register it by
* \ref Cy_SCB_EZI2C_RegisterDSClockConfig.
*
* The callback function can be generated by using the Device Configurator.
*
...
* Provides the typedef for the callback function called in the
* \ref Cy_SCB_I2C_Interrupt to notify the user about occurrences of
* \ref group_scb_i2c_macros_hs_mode_callback_events.
*/
...
/**
* Provides the typedef for the callback function called in the
* \ref Cy_SCB_I2C_DeepSleepCallback to notify the user when going into
* and out of deepsleep \ref group_scb_i2c_macros_deep_sleep_callback_events.
*/
typedef void (* cy_cb_scb_i2c_handle_deep_sleep_mode_t)(uint32_t event);
#endif /* defined (CY_IP_M0S8SCB || defined (CY_DOXYGEN) */
...
#ifdef CY_IP_MXSCB
    bool hsEnable;              /**< Enable High-speed mode for slave */
#endif /* CY_IP_MXSCB */
...
__STATIC_INLINE void Cy_SCB_I2C_Enable(CySCB_Type *base, cy_stc_scb_i2c_context_t const *context);
...
#if defined (CY_IP_MXSCB) || defined (CY_DOXYGEN)
uint32_t Cy_SCB_I2C_GetDataRateHS(CySCB_Type const *base, uint32_t scbClockHz);
#endif /* defined (CY_IP_MXSCB) || defined (CY_DOXYGEN) */
...
* \{
*/
cy_en_scb_i2c_status_t Cy_SCB_I2C_MasterWrite(CySCB_Type *base, cy_stc_scb_i2c_master_xfer_config_t const *xferConfig,
                                              cy_stc_scb_i2c_context_t *context);
void     Cy_SCB_I2C_MasterAbortWrite         (CySCB_Type *base, cy_stc_scb_i2c_context_t *context);
cy_en_scb_i2c_status_t Cy_SCB_I2C_MasterRead (CySCB_Type *base, cy_stc_scb_i2c_master_xfer_config_t const *xferConfig,
                                              cy_stc_scb_i2c_context_t *context);
...
__STATIC_INLINE void Cy_SCB_I2C_RegisterAddrCallback (CySCB_Type const *base, cy_cb_scb_i2c_handle_addr_t callback,
                                                      cy_stc_scb_i2c_context_t *context);
#if defined (CY_IP_MXSCB) || defined (CY_DOXYGEN)
__STATIC_INLINE void Cy_SCB_I2C_RegisterHsModeCallback(CySCB_Type const *base, cy_cb_scb_i2c_handle_hs_mode_t callback,
                                                      cy_stc_scb_i2c_context_t *context);
#endif /* defined (CY_IP_MXSCB) || defined (CY_DOXYGEN) */
...
__STATIC_INLINE void Cy_SCB_I2C_RegisterDSClockConfig(CySCB_Type const *base,
              cy_cb_scb_i2c_handle_deep_sleep_mode_t callback, cy_stc_scb_i2c_context_t *context);
#endif /* defined (CY_IP_M0S8SCB || defined (CY_DOXYGEN) */
...
*/
/**
* Indicates on enter into Deep Sleep mode.
*/
#define CY_SCB_I2C_SLAVE_DEEP_SLEEP_ENTER_EVENT (0x01UL)

/**
* Indicates on exit from Deep Sleep mode.
*/
#define CY_SCB_I2C_SLAVE_DEEP_SLEEP_EXIT_EVENT  (0x02UL)
/** \} group_scb_i2c_macros_deep_sleep_callback_events */
#endif /* defined (CY_IP_MXSCB) || defined (CY_DOXYGEN) */

#if defined (CY_IP_MXSCB) || defined (CY_DOXYGEN)
/**
* \defgroup group_scb_i2c_macros_hs_mode_callback_events I2C High-speed mode Callback Events
* Macros to check I2C HS event by \ref cy_cb_scb_i2c_handle_hs_mode_t callback.
* Each event is encoded in a separate bit and therefore it is possible to
* notify about multiple events.
* \{
*/
...
/** \endcond */
/** \} group_scb_i2c_macros_hs_mode_callback_events */
#endif /* defined (CY_IP_MXSCB) || defined (CY_DOXYGEN) */
...
#ifdef CY_IP_MXSCB
#define CY_SCB_I2C_SLAVE_INTR_HS        (CY_SCB_SLAVE_INTR_I2C_HS_ENTER | CY_SCB_SLAVE_INTR_I2C_HS_EXIT)
#endif /* CY_IP_MXSCB */
...
#ifdef CY_IP_MXSCB
#define CY_SCB_I2C_HS_DATA_RATE_1700    (1700000U)
#define CY_SCB_I2C_HS_DATA_RATE_3400    (3400000U)
#endif /* CY_IP_MXSCB */
...
#define CY_SCB_I2C_SLAVE_FSTP_CLK_MAX  (48000000U)
#ifdef CY_IP_MXSCB
#define CY_SCB_I2C_SLAVE_HS_CLK_MIN_1700    (17020000U)
#define CY_SCB_I2C_SLAVE_HS_CLK_MAX_1700    (48000000U)
#define CY_SCB_I2C_SLAVE_HS_CLK_MIN_3400    (41010000U)
#define CY_SCB_I2C_SLAVE_HS_CLK_MAX_3400    (48000000U)
#endif /* CY_IP_MXSCB */
...
#else /* CY_IP_MXSCB */
    SCB_I2C_S_CMD(base) |= _BOOL2FLD(SCB_I2C_S_CMD_S_STRETCH_HS, context->hsEnable);
#endif /* CY_IP_M0S8SCB */
}
...
#if defined (CY_IP_MXSCB) || defined (CY_DOXYGEN)
/*******************************************************************************
* Function Name: Cy_SCB_I2C_RegisterHsModeCallback
****************************************************************************//**
*
* Registers a callback function that notifies that
* \ref group_scb_i2c_macros_hs_mode_callback_events occurred in the
* \ref Cy_SCB_I2C_Interrupt.
*
* \param base
* The pointer to the I2C SCB instance.
...
* \param callback
* The pointer to a callback function.
* See \ref cy_cb_scb_i2c_handle_hs_mode_t for the function prototype.
*
* \param context
* The pointer to context structure \ref cy_stc_scb_i2c_context_t allocated by
* the user. The structure is used during the I2C operation for internal
...
__STATIC_INLINE void Cy_SCB_I2C_RegisterHsModeCallback(CySCB_Type const *base,
              cy_cb_scb_i2c_handle_hs_mode_t callback, cy_stc_scb_i2c_context_t *context)
{
    /* Suppress a compiler warning about unused variables */
    CY_UNUSED_PARAMETER(base);

    context->cbHsMode = callback;
}
#endif /* defined (CY_IP_MXSCB) || defined (CY_DOXYGEN) */
/** \} group_scb_i2c_interrupt_functions */
...
#if defined (CY_IP_M0S8SCB) || defined (CY_DOXYGEN)
/*******************************************************************************
* Function Name: Cy_SCB_I2C_RegisterDSClockConfig
****************************************************************************//**
*
* Registers a callback function that will occur \ref
* Cy_SCB_I2C_DeepSleepCallback when the I2C goes into deepsleep. In the
* configurator if Deep Sleep Callback is enabled a callback function will
* be supplied. The function will disable the clock divider when going into
* deepsleep and enable the clock divider when coming out of deepsleep. If
* Deep Sleep Callback is not enabled a user defined function must enable
* and disable the clock dividers. 
*
* \param base
* The pointer to the I2C SCB instance.
*
* \param callback
* The pointer to a callback function.
* See \ref cy_cb_scb_i2c_handle_deep_sleep_mode_t callback for the function
* prototype.
*
* \param context
* The pointer to context structure \ref cy_stc_scb_i2c_context_t allocated by

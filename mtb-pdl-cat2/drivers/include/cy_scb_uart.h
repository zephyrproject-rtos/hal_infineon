...
*
* The UART is disabled during Deep Sleep and and stops driving
...
* UART control of the pins. Copy \ref Cy_SCB_UART_DeepSleepCallback
...
* to the appropriate UART lines to keep them inactive during Deep-Sleep.
*

...
* \{
* The Segment LCD Driver provides an API to configure and operate the M0S8LCD hardware block.
* The M0S8LCD block can be flexibly configured to drive a variety of LCD glass
...
* to manage the M0S8LCD hardware or as a part of the more complex software solution
...
* an M0S8LCD block to drive your standard or custom LCD glass:
...
* * The ModusToolbox Device Configurator contains a SegLCD personality, which is an M0S8LCD block 
...
#define CY_SEGLCD_SPEED_MODE                (1UL)
...
typedef enum 
{
    ...
    CY_SEGLCD_BIAS_FOURTH = 0x2UL, /**< 1/4 Bias. */
    CY_SEGLCD_BIAS_FIFTH  = 0x3UL, /**< 1/5 Bias. */
} cy_en_seglcd_bias_t;
...
typedef struct
{
    ...
    uint32_t           clkFreq; /**< The LCD clock frequency, the valid range is 10000...48000000 (Hz)
                                 */

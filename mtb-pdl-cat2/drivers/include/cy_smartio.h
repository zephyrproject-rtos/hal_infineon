...
*     <td>Reset when going to Deep Sleep or POR</td>
*     <td>2 clock edges</td>
*     <td>The fabric will be enabled after 2 clock edges of the divided clock. Any synchronous
*         logic in the LUTs will be reset to 0 when in chip deep-sleep mode.</td>
*   </tr>
*   <tr>
*     <td>Divided Clock (Deep-Sleep)</td>
*     <td>Reset when going to POR</td>
*     <td>2 clock edges</td>
...
*     <td>Reset when going to POR</td>
*     <td>2 clock edges</td>
*     <td>The fabric will be enabled after 2 clock edges of the low frequency clock (LFCLK).</td>
*   </tr>
*   <tr>
*     <td>Asynchronous</td>
*     <td>Reset on POR</td>
...
#if defined(CY_IP_M0S8IOSS_SMARTIO)
...
typedef enum {
    ...
    CY_SMARTIO_CLK_DIVHIB = 18, /**< Clock sourced from a peripheral clock divider (Hibernate). Not supported. Reserved for future. */
...
#endif /* defined(CY_IP_M0S8IOSS_SMARTIO) */

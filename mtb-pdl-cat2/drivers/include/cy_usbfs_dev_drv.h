...
* on the EZ-PD PMG1 family of devices. The PMG1 family is a set of USB Power-Delivery
...
*   * Manual DMA mode (Mode 2). [PMG1-S3]
*   * Automatic DMA mode (Mode 3). [PMG1-S3]
...
*   The <i>epAccess and intrLevelSel </i> must be provided. All
...
*   cy_stc_usbfs_dev_drv_dma_config_t to be populated for each DMA
*   channel.
...
* * HFCLK must be 48 MHz. The accuracy of the USB clock must be
*   within -/+ 0.25%. \n
*   <b>The typical configuration is:</b> the IMO output is used to
*   generate HFCLK. To meet USB clock accuracy requirements
...
* * 16-bits: uint8_t endpointsBuffer[(63+1) + (63+1) + 8] CY_ALIGN(2); or
...
void Cy_USBFS_Dev_Drv_RegEnable(USBFS_Type *base,cy_stc_usbfs_dev_drv_context_t *context);
void Cy_USBFS_Dev_Drv_RegDisable(USBFS_Type *base,cy_stc_usbfs_dev_drv_context_t *context);
...
#define CY_USBFS_DEV_DRV_SET_SOF_LVL(level)       _VAL2FLD(USBFS_BCD_INTR_LVL_SEL_SOF_LVL_SEL, level)
/** Assigns the Bus Reset interrupt source to a trigger interrupt: Low, Medium, or High */
#define CY_USBFS_DEV_DRV_SET_BUS_RESET_LVL(level) _VAL2FLD(USBFS_BCD_INTR_LVL_SEL_BUS_RESET_LVL_SEL, level)
/** Assigns the Endpoint 0 interrupt source to a trigger interrupt Low, Medium, or High */
#define CY_USBFS_DEV_DRV_SET_EP0_LVL(level)       _VAL2FLD(USBFS_BCD_INTR_LVL_SEL_EP0_LVL_SEL, level)
/** Assigns the Resume interrupt source to a trigger interrupt: Low, Medium, or High */
#define CY_USBFS_DEV_DRV_SET_RESUME_LVL(level)    _VAL2FLD(USBFS_BCD_INTR_LVL_SEL_RESUME_LVL_SEL, level)
/** Assigns the Arbiter interrupt source to a trigger interrupt: Low, Medium, or High */
#define CY_USBFS_DEV_DRV_SET_ARB_EP_LVL(level)    _VAL2FLD(USBFS_BCD_INTR_LVL_SEL_RESUME_LVL_SEL, level)
/** Assigns the Endpoint 1 interrupt source to a trigger interrupt: Low, Medium, or High */
#define CY_USBFS_DEV_DRV_SET_EP1_LVL(level)       _VAL2FLD(USBFS_BCD_INTR_LVL_SEL_EP1_LVL_SEL, level)
/** Assigns the Endpoint 2 interrupt source to a trigger interrupt: Low, Medium, or High */
#define CY_USBFS_DEV_DRV_SET_EP2_LVL(level)       _VAL2FLD(USBFS_BCD_INTR_LVL_SEL_EP2_LVL_SEL, level)
/** Assigns the Endpoint 3 interrupt source to a trigger interrupt: Low, Medium, or High */
#define CY_USBFS_DEV_DRV_SET_EP3_LVL(level)       _VAL2FLD(USBFS_BCD_INTR_LVL_SEL_EP3_LVL_SEL, level)
/** Assigns the Endpoint 4 interrupt source to a trigger interrupt: Low, Medium, or High */
#define CY_USBFS_DEV_DRV_SET_EP4_LVL(level)       _VAL2FLD(USBFS_BCD_INTR_LVL_SEL_EP4_LVL_SEL, level)
/** Assigns the Endpoint 5 interrupt source to a trigger interrupt: Low, Medium, or High */
#define CY_USBFS_DEV_DRV_SET_EP5_LVL(level)       _VAL2FLD(USBFS_BCD_INTR_LVL_SEL_EP5_LVL_SEL, level)
/** Assigns the Endpoint 6 interrupt source to a trigger interrupt: Low, Medium, or High */
#define CY_USBFS_DEV_DRV_SET_EP6_LVL(level)       _VAL2FLD(USBFS_BCD_INTR_LVL_SEL_EP6_LVL_SEL, level)
/** Assigns the Endpoint 7 interrupt source to a trigger interrupt: Low, Medium, or High */
#define CY_USBFS_DEV_DRV_SET_EP7_LVL(level)       _VAL2FLD(USBFS_BCD_INTR_LVL_SEL_EP7_LVL_SEL, level)
/** Assigns the Endpoint 8 interrupt source to a trigger interrupt: Low, Medium, or High */
#define CY_USBFS_DEV_DRV_SET_EP8_LVL(level)       _VAL2FLD(USBFS_BCD_INTR_LVL_SEL_EP8_LVL_SEL, level)
...
* \{
*/
#define CY_USBFS_DEV_DRV_LPM_INTR        USBFS_BCD_INTR_CAUSE_HI_LPM_INTR_Msk        /**< Link Power Management request interrupt */
#define CY_USBFS_DEV_DRV_ARBITER_INTR    USBFS_BCD_INTR_CAUSE_HI_ARB_EP_INTR_Msk     /**< Arbiter interrupt */
#define CY_USBFS_DEV_DRV_EP0_INTR        USBFS_BCD_INTR_CAUSE_HI_EP0_INTR_Msk        /**< Endpoint 0 interrupt */
#define CY_USBFS_DEV_DRV_SOF_INTR        USBFS_BCD_INTR_CAUSE_HI_SOF_INTR_Msk        /**< SOF interrupt */
#define CY_USBFS_DEV_DRV_BUS_RESET_INTR  USBFS_BCD_INTR_CAUSE_HI_BUS_RESET_INTR_Msk  /**< Bus Reset interrupt */
#define CY_USBFS_DEV_DRV_EP1_INTR        USBFS_BCD_INTR_CAUSE_HI_EP1_INTR_Msk        /**< Data endpoint 1 interrupt */
#define CY_USBFS_DEV_DRV_EP2_INTR        USBFS_BCD_INTR_CAUSE_HI_EP2_INTR_Msk        /**< Data endpoint 2 interrupt */
#define CY_USBFS_DEV_DRV_EP3_INTR        USBFS_BCD_INTR_CAUSE_HI_EP3_INTR_Msk        /**< Data endpoint 3 interrupt */
#define CY_USBFS_DEV_DRV_EP4_INTR        USBFS_BCD_INTR_CAUSE_HI_EP4_INTR_Msk        /**< Data endpoint 4 interrupt */
#define CY_USBFS_DEV_DRV_EP5_INTR        USBFS_BCD_INTR_CAUSE_HI_EP5_INTR_Msk        /**< Data endpoint 5 interrupt */
#define CY_USBFS_DEV_DRV_EP6_INTR        USBFS_BCD_INTR_CAUSE_HI_EP6_INTR_Msk        /**< Data endpoint 6 interrupt */
#define CY_USBFS_DEV_DRV_EP7_INTR        USBFS_BCD_INTR_CAUSE_HI_EP7_INTR_Msk        /**< Data endpoint 7 interrupt */
#define CY_USBFS_DEV_DRV_EP8_INTR        USBFS_BCD_INTR_CAUSE_HI_EP8_INTR_Msk        /**< Data endpoint 8 interrupt */
...
#define USBFS_USB_INTR_CAUSE_LPM_INTR_Msk        USBFS_BCD_INTR_CAUSE_HI_LPM_INTR_Msk
#define USBFS_USB_INTR_CAUSE_ARB_EP_INTR_Msk     USBFS_BCD_INTR_CAUSE_HI_ARB_EP_INTR_Msk
#define USBFS_USB_INTR_CAUSE_EP0_INTR_Msk        USBFS_BCD_INTR_CAUSE_HI_EP0_INTR_Msk
#define USBFS_USB_INTR_CAUSE_SOF_INTR_Msk        USBFS_BCD_INTR_CAUSE_HI_SOF_INTR_Msk
#define USBFS_USB_INTR_CAUSE_BUS_RESET_INTR_Msk  USBFS_BCD_INTR_CAUSE_HI_BUS_RESET_INTR_Msk
#define USBFS_USB_INTR_CAUSE_EP1_INTR_Pos        USBFS_BCD_INTR_CAUSE_HI_EP1_INTR_Pos
...
__STATIC_INLINE void Cy_USBFS_Dev_Drv_SetDeviceAddress(USBFS_Type *base, uint8_t address)
{
    base->CR0 = _CLR_SET_FLD32U(base->CR0, USBFS_CR0_DEVICE_ADDRESS, address);
}
...
__STATIC_INLINE uint32_t Cy_USBFS_Dev_Drv_GetDeviceAddress(USBFS_Type const *base)
{
    return _FLD2VAL(USBFS_CR0_DEVICE_ADDRESS, base->CR0);
}
...
__STATIC_INLINE uint32_t Cy_USBFS_Dev_Drv_GetInterruptCauseHi(USBFS_Type const *base)
{
    return USBFS_DEV_INTR_CAUSE_HI(base);
}
...
__STATIC_INLINE uint32_t Cy_USBFS_Dev_Drv_GetInterruptCauseMed(USBFS_Type const *base)
{
    return USBFS_DEV_INTR_CAUSE_MED(base);
}
...
__STATIC_INLINE uint32_t Cy_USBFS_Dev_Drv_GetInterruptCauseLo(USBFS_Type const *base)
{
    return USBFS_DEV_INTR_CAUSE_LO(base);
}
...
__STATIC_INLINE void Cy_USBFS_Dev_Drv_SetInterruptsLevel(USBFS_Type *base, uint32_t intrLevel)
{
    USBFS_DEV_INTR_LVL_SEL(base) = intrLevel;
}
...
__STATIC_INLINE bool Cy_USBFS_Dev_Drv_CheckActivity(USBFS_Type *base)
{
    uint32_t tmpReg = base->CR1;

    /* Clear hardware status */
    base->CR1 &= (tmpReg & ~USBFS_CR1_BUS_ACTIVITY_Msk);
    (void) base->CR1;

    return (0U != (tmpReg & USBFS_CR1_BUS_ACTIVITY_Msk));
}
...
__STATIC_INLINE bool Cy_USBFS_Dev_Drv_GetEndpointAckState(USBFS_Type const *base, uint32_t endpoint)
{
    ...
    endpoint = CY_USBFS_DEV_DRV_EP2PHY(endpoint);
    return _FLD2BOOL(USBFS_SIE_EP1_CR0_ACKED_TXN, USBFS_DEV_SIE_EP_CR0(base, endpoint));
}

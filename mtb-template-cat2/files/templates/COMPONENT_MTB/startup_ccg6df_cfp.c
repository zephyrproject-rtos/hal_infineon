...
void cpuss_interrupt_fpu_IRQHandler     (void) __attribute__ ((weak, alias("Default_Handler"))); /* FPU Interrupt */
...
extern const cy_israddress __VECTOR_TABLE[CY_VECTOR_TABLE_SIZE];
    ...
    usbpd_0_interrupt_wakeup_IRQHandler,      /*   6 Ganged USBPD[0] Interrupt */
    usbpd_1_interrupt_wakeup_IRQHandler,      /*   7 Ganged USBPD[1] Interrupt */
    ...
    cpuss_interrupt_dma_IRQHandler,           /*  18 DMA Interrupt */
    cpuss_interrupt_fpu_IRQHandler            /*  19 FPU Interrupt */
};

...
extern const cy_israddress __VECTOR_TABLE[CY_VECTOR_TABLE_SIZE];
    ...
    srss_interrupt_wdt_IRQHandler,            /*   6 WDT or Temp (WDT only in DeepSleep) */
    scb_0_interrupt_IRQHandler,               /*   7 SCB[0] */
    scb_1_interrupt_IRQHandler,               /*   8 SCB[1] */
    scb_2_interrupt_IRQHandler,               /*   9 SCB[2] */
    cpuss_interrupt_spcif_IRQHandler,         /*  10 SPC */
    usbpd_0_interrupt_IRQHandler,             /*  11 Synchronous USBPD Interrupts */
    tcpwm_interrupts_0_IRQHandler,            /*  12 TCPWM counter #0 */
    tcpwm_interrupts_1_IRQHandler,            /*  13 TCPWM counter #1 */
    tcpwm_interrupts_2_IRQHandler,            /*  14 TCPWM counter #2 */
    tcpwm_interrupts_3_IRQHandler,            /*  15 TCPWM counter #3 */
    tcpwm_interrupts_4_IRQHandler,            /*  16 TCPWM counter #4 */
    tcpwm_interrupts_5_IRQHandler,            /*  17 TCPWM counter #5 */
    tcpwm_interrupts_6_IRQHandler,            /*  18 TCPWM counter #6 */
    tcpwm_interrupts_7_IRQHandler,            /*  19 TCPWM counter #7 */
    crypto_interrupt_IRQHandler,              /*  20 Crypto block */
    pass_0_interrupt_sar_IRQHandler           /*  21 SAR */
};

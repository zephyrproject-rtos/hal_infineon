...
extern const cy_israddress __VECTOR_TABLE[CY_VECTOR_TABLE_SIZE];
    ...
    cpuss_interrupt_spcif_IRQHandler,         /*   9 SPC */
    usbpd_0_interrupt_IRQHandler,             /*  10 Synchronous USBPD Interrupts */
    tcpwm_interrupts_0_IRQHandler,            /*  11 TCPWM counter #0 */
    tcpwm_interrupts_1_IRQHandler,            /*  12 TCPWM counter #1 */
    tcpwm_interrupts_2_IRQHandler,            /*  13 TCPWM counter #2 */
    tcpwm_interrupts_3_IRQHandler             /*  14 TCPWM counter #3 */
};

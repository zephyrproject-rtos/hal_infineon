...
extern const cy_israddress __VECTOR_TABLE[CY_VECTOR_TABLE_SIZE];
    ...
    pass_0_interrupt_ctbs_IRQHandler,         /*  10 CTBm Interrupt (all CTBms) */
    wco_interrupt_IRQHandler,                 /*  11 WCO WDT Interrupt */
    cpuss_interrupt_spcif_IRQHandler,         /*  12 SPCIF interrupt */
    csd_interrupt_IRQHandler,                 /*  13 CSD #0 (Primarily Capsense) */
    tcpwm_interrupts_0_IRQHandler,            /*  14 TCPWM #0, Counter #0 */
    tcpwm_interrupts_1_IRQHandler,            /*  15 TCPWM #0, Counter #1 */
    tcpwm_interrupts_2_IRQHandler,            /*  16 TCPWM #0, Counter #2 */
    tcpwm_interrupts_3_IRQHandler,            /*  17 TCPWM #0, Counter #3 */
    tcpwm_interrupts_4_IRQHandler,            /*  18 TCPWM #0, Counter #4 */
    pass_0_interrupt_sar_IRQHandler           /*  19 SAR */
};

...
void msc_0_interrupt_IRQHandler         (void) __attribute__ ((weak, alias("Default_Handler"))); /* CSD #0 (Primarily Capsense) */
...
void canfd_interrupts0_0_IRQHandler     (void) __attribute__ ((weak, alias("Default_Handler"))); /* CAN Interrupt */
void canfd_interrupts1_0_IRQHandler     (void) __attribute__ ((weak, alias("Default_Handler"))); /* CAN Interrupt */
void crypto_interrupt_IRQHandler        (void) __attribute__ ((weak, alias("Default_Handler"))); /* Crypto Interrupt */
void msc_1_interrupt_IRQHandler         (void) __attribute__ ((weak, alias("Default_Handler"))); /* CSD #0 (Primarily Capsense) */
void exco_interrupt_IRQHandler          (void) __attribute__ ((weak, alias("Default_Handler"))); /* EXCO */
void audioss_interrupt_i2s_IRQHandler   (void) __attribute__ ((weak, alias("Default_Handler"))); /* I2S Interrupt */
...
extern const cy_israddress __VECTOR_TABLE[CY_VECTOR_TABLE_SIZE];
    ...
    msc_0_interrupt_IRQHandler,               /*  16 CSD #0 (Primarily Capsense) */
    ...
    canfd_interrupts0_0_IRQHandler,           /*  26 CAN Interrupt */
    canfd_interrupts1_0_IRQHandler,           /*  27 CAN Interrupt */
    crypto_interrupt_IRQHandler,              /*  28 Crypto Interrupt */
    msc_1_interrupt_IRQHandler,               /*  29 CSD #0 (Primarily Capsense) */
    exco_interrupt_IRQHandler,                /*  30 EXCO */
    audioss_interrupt_i2s_IRQHandler          /*  31 I2S Interrupt */
};

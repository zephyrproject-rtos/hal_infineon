...
extern const cy_israddress __VECTOR_TABLE[CY_VECTOR_TABLE_SIZE];
    ...
    scb_2_interrupt_IRQHandler,               /*   8 SCB #2 */
    scb_3_interrupt_IRQHandler,               /*   9 SCB #3 */
    scb_4_interrupt_IRQHandler,               /*  10 SCB #4 */
    wco_interrupt_IRQHandler,                 /*  11 WCO WDT Interrupt */
    msclp_interrupt_lp_IRQHandler,            /*  12 MSCv3LP interrupt */
    msclp_interrupt_IRQHandler,               /*  13 MSCv3 Interrupt */
    cpuss_interrupt_dma_IRQHandler,           /*  14 DMA Interrupt */
    cpuss_interrupt_spcif_IRQHandler,         /*  15 SPCIF interrupt */
    tcpwm_interrupts_0_IRQHandler,            /*  16 TCPWM #0, Counter #0 */
    tcpwm_interrupts_1_IRQHandler,            /*  17 TCPWM #0, Counter #1 */
    tcpwm_interrupts_2_IRQHandler,            /*  18 TCPWM #0, Counter #2 */
    tcpwm_interrupts_3_IRQHandler,            /*  19 TCPWM #0, Counter #3 */
    tcpwm_interrupts_4_IRQHandler,            /*  20 TCPWM #0, Counter #4 */
    tcpwm_interrupts_5_IRQHandler,            /*  21 TCPWM #0, Counter #5 */
    pass_0_interrupt_sar_IRQHandler           /*  22 SAR */
};

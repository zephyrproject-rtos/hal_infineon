...
/* The file "crypto-pqc.h" contains definitions for PQC functionality. */
#include "ifx_se_psacrypto_pqc.h"
 ...
 *                              (encoded pointer to input data).
 * \param[in]  input_length     Size of the \p input buffer with CRC included
 *                              in bytes (size_t).
 * \param[out] signature        Buffer where the signature is to be written
 *                              (encoded pointer to output buffer).
 * \param[in]  signature_size   Size of the \p signature buffer in bytes (size_t).

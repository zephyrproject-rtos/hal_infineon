 ...
 */
static inline int ifx_se_svc_key_id_equal(ifx_se_svc_key_id_t id1,
                                          ifx_se_svc_key_id_t id2)
{
    return ((id1.key_id == id2.key_id) && (id1.owner == id2.owner)) ? 1 : 0;
}
 ...
 */
static inline int ifx_se_svc_key_id_is_null(ifx_se_svc_key_id_t key)
{
    return (key.key_id == 0u) ? 1 : 0;
}
 ...
 * | ^          | \ref IFX_SE_KEY_ID_BUILTIN_TEST_ECC384_SHA384_PRIV  | ECC Private key | ECDSA-384R1 (SHA_384) | \ref IFX_SE_KEY_USAGE_SIGN_HASH \ref IFX_SE_KEY_USAGE_SIGN_MESSAGE \ref IFX_SE_KEY_USAGE_VERIFY_HASH \ref IFX_SE_KEY_USAGE_VERIFY_MESSAGE \ref IFX_SE_KEY_USAGE_EXPORT |
 * | ^          | \ref IFX_SE_KEY_ID_BUILTIN_TEST_ECC521_SHA512_PRIV  | ECC Private key | ECDSA-521R1 (SHA_512) | \ref IFX_SE_KEY_USAGE_SIGN_HASH \ref IFX_SE_KEY_USAGE_SIGN_MESSAGE \ref IFX_SE_KEY_USAGE_VERIFY_HASH \ref IFX_SE_KEY_USAGE_VERIFY_MESSAGE \ref IFX_SE_KEY_USAGE_EXPORT |
 * | ^          | \ref IFX_SE_KEY_ID_BUILTIN_TEST_ECC384_SHA384       | ECC Public key  | ECDSA-384R1 (SHA_384) | \ref IFX_SE_KEY_USAGE_VERIFY_HASH \ref IFX_SE_KEY_USAGE_VERIFY_MESSAGE \ref IFX_SE_KEY_USAGE_EXPORT                                                                    |
 * | ^          | \ref IFX_SE_KEY_ID_BUILTIN_TEST_ECC521_SHA512       | ECC Public key  | ECDSA-521R1 (SHA_512) | \ref IFX_SE_KEY_USAGE_VERIFY_HASH \ref IFX_SE_KEY_USAGE_VERIFY_MESSAGE \ref IFX_SE_KEY_USAGE_EXPORT                                                                    |
 *
...
/* Keys for external subsystens */
#define IFX_SE_KEY_ID_SS1_INTEGRITY         (IFX_SE_KEY_ID_BUILTIN_MIN + 7u)
#define IFX_SE_KEY_ID_SS1_ENC               (IFX_SE_KEY_ID_BUILTIN_MIN + 8u)
#define IFX_SE_KEY_ID_SS2_INTEGRITY         (IFX_SE_KEY_ID_BUILTIN_MIN + 9u)
#define IFX_SE_KEY_ID_SS2_ENC               (IFX_SE_KEY_ID_BUILTIN_MIN + 10u)
...
/** ECC P384 private key for sign / verify NIST tests
 * @verbatim
 *
 * csrc.nist.gov/CSRC/media/Projects/Cryptographic-Algorithm-Validation-Program/documents/dss/186-4ecdsatestvectors.zip
 *
 * SigVer.rsp [P-2384, SHA-384]
 ...
 * @endverbatim
 */
#define IFX_SE_KEY_ID_BUILTIN_TEST_ECC384_SHA384_PRIV   (IFX_SE_KEY_ID_BUILTIN_MIN + 39u)
/** ECC P521 private key for sign / verify NIST tests
 * @verbatim
 *
 * csrc.nist.gov/CSRC/media/Projects/Cryptographic-Algorithm-Validation-Program/documents/dss/186-4ecdsatestvectors.zip
 *
 * SigVer.rsp [P-521,SHA-512]
 ...
 * @endverbatim
 */
#define IFX_SE_KEY_ID_BUILTIN_TEST_ECC521_SHA512_PRIV   (IFX_SE_KEY_ID_BUILTIN_MIN + 40u)
/** ECC P384 public key for signature verify NIST test
 * @verbatim
 *
 *  csrc.nist.gov/CSRC/media/Projects/Cryptographic-Algorithm-Validation-Program/documents/dss/186-4ecdsatestvectors.zip
 *
 *  SigVer.rsp [P-384, SHA-384]
 *     Qx = c2b47944fb5de342d03285880177ca5f7d0f2fcad7678cce4229d6e1932fcac11bfc3c3e97d942a3c56bf34123013dbf
 *     Qy = 37257906a8223866eda0743c519616a76a758ae58aee81c5fd35fbf3a855b7754a36d4a0672df95d6c44a81cf7620c2d
 * @endverbatim
*/
#define IFX_SE_KEY_ID_BUILTIN_TEST_ECC384_SHA384   (IFX_SE_KEY_ID_BUILTIN_MIN + 41u)
/** ECC P521 public key for signature verify NIST test
 * @verbatim
 *
 *  csrc.nist.gov/CSRC/media/Projects/Cryptographic-Algorithm-Validation-Program/documents/dss/186-4ecdsatestvectors.zip
 *
 ...
 * @endverbatim
*/
#define IFX_SE_KEY_ID_BUILTIN_TEST_ECC521_SHA512   (IFX_SE_KEY_ID_BUILTIN_MIN + 42u)
/**@}*/

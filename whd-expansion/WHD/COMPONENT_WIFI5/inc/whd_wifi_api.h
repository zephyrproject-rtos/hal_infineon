 ...
 *  @return WHD_SUCCESS or Error code
 */
extern whd_result_t whd_wifi_icmp_echo_req_add(whd_interface_t ifp, whd_ip_ver_t ip_ver, uint8_t *peer_ip,
                                                whd_mac_t *peer_mac, uint32_t periodicity, uint32_t duration);

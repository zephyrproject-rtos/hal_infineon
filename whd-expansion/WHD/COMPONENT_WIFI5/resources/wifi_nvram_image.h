...
#endif
#else
uint32_t  wifi_nvram_image_size = (uint32_t)NVRAM_IMAGE_SIZE;
#endif

const resource_hnd_t wifi_nvram_image = { RESOURCE_IN_MEMORY, (unsigned long)NVRAM_IMAGE_SIZE, {.mem = { (char *) wifi_nvram_image_data }}};

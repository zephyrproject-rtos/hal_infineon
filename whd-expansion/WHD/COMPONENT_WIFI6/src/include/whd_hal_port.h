...
// sdio
#ifdef WHD_CUSTOM_HAL
#define whd_hal_sdio_host_bulk_transfer whd_custom_hal_sdio_bulk_transfer
#define whd_hal_sdio_host_send_cmd whd_custom_hal_sdio_send_cmd
#define whd_hal_sdio_register_callback whd_custom_hal_sdio_register_irq
#else
#define whd_hal_sdio_host_bulk_transfer cyhal_sdio_bulk_transfer
#define whd_hal_sdio_host_send_cmd cyhal_sdio_send_cmd

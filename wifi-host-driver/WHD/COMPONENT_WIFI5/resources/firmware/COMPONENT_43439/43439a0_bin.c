...
#endif
const unsigned char wifi_firmware_image_data[249066] = {
    #include <cyw43xx_fw_blob.inc>
};
const resource_hnd_t wifi_firmware_image = { RESOURCE_IN_MEMORY, 249066, {.mem = { (const char *) wifi_firmware_image_data }}};

...
#endif
const unsigned char wifi_firmware_image_data[229074] = {
        #include <cyw43xx_fw_blob.inc>
};
const resource_hnd_t wifi_firmware_image = { RESOURCE_IN_MEMORY, 229074, {.mem = { (const char *) wifi_firmware_image_data }}};

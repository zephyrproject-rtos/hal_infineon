...
#endif
const unsigned char wifi_firmware_image_data[421421] = {
        #include <cyw43xx_fw_blob.inc>
};
const resource_hnd_t wifi_firmware_image = { RESOURCE_IN_MEMORY, 421421, {.mem = { (const char *) wifi_firmware_image_data }}};

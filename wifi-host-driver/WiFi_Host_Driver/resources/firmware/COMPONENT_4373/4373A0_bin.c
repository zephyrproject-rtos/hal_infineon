...
#endif
const unsigned char wifi_firmware_image_data[589547] = {
        #include <cyw43xx_fw_blob.inc>
};
const resource_hnd_t wifi_firmware_image = { RESOURCE_IN_MEMORY, 589547, {.mem = { (const char *) wifi_firmware_image_data }}};

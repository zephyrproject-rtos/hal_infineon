...
/*
 * Minimal definitions consumed by the Zephyr build.
 *
 * The full configurator-generated content below is intended for the TF-M
 * secure firmware build only. When this header is consumed by Zephyr (either
 * the secure m33 build or the non-secure m33/ns app), the PDL drivers, MPC,
 * PPC and SAU configuration are managed by Zephyr/TF-M directly and the
 * full content pulls in headers (e.g. armv8m_mpu.h via cy_cmsis_utils.h)
 * that are not available in the Zephyr include path.
 *
 * __ZEPHYR__ is defined automatically by the Zephyr toolchain and is never
 * defined when this header is compiled as part of the TF-M build, making it
 * a reliable discriminator between the two consumers.
 */
...
#else /* !defined(__ZEPHYR__) -- TF-M build */
...
#define vres_0_protection_0_domain_6_ENABLED 1U
#define vres_0_protection_0_domain_7_ENABLED 1U
#define vres_0_protection_0_domain_8_ENABLED 1U
#define vres_0_protection_0_domain_9_ENABLED 1U
#define vres_0_protection_0_domain_10_ENABLED 1U
...
#define M33S_CODE_UNIFIED_MPC_DOMAIN_IDX 5U
#define TFM_SP_INITIAL_ATTESTATION_UNIFIED_MPC_DOMAIN_IDX 6U
#define TFM_SP_CRYPTO_UNIFIED_MPC_DOMAIN_IDX 7U
...
extern const cy_stc_mpc_rot_cfg_t M33S_CODE_mpc_cfg[];
extern const cy_stc_mpc_rot_cfg_t TFM_SP_INITIAL_ATTESTATION_mpc_cfg[];
...
extern const cy_stc_mpc_regions_t M33S_CODE_mpc_regions[];
extern const cy_stc_mpc_regions_t TFM_SP_INITIAL_ATTESTATION_mpc_regions[];
...
extern const cy_en_prot_region_t TFM_SP_CRYPTO_ppc_0_regions[];
extern const cy_stc_ppc_attribute_t M33S_ppc_0_cfg;
extern const cy_stc_ppc_attribute_t M33_M55_ppc_0_cfg;
extern const cy_stc_ppc_attribute_t TFM_SP_INITIAL_ATTESTATION_ppc_0_cfg;
extern const cy_stc_ppc_attribute_t TFM_SP_CRYPTO_ppc_0_cfg;
extern const cy_stc_ppc_cfg_t cycfg_ppc_0_domains_config[];
extern const size_t cycfg_ppc_0_domains_count;
extern const cy_en_prot_region_t M33S_ppc_1_regions[];
extern const cy_en_prot_region_t M33_M55_ppc_1_regions[];
extern const cy_stc_ppc_attribute_t M33S_ppc_1_cfg;
